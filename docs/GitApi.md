...
# **gitListMatchingRefs**
> List&lt;GitRef&gt; gitListMatchingRefs(owner, repo, ref)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ref = "ref_example"; // String | ref parameter
    try {
      List<GitRef> result = apiInstance.gitListMatchingRefs(owner, repo, ref);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
    String repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
    String ref = "refs/head/master"; // String | The name of the fully qualified reference to update. For example, `refs/heads/master`. If the value doesn't start with `refs` and have at least two slashes, it will be rejected.
