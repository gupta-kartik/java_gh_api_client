...
import org.openapitools.client.model.WebhookCheckSuiteRequestedCheckSuite;
...
public class WebhookCheckSuiteRequested {
  ...
  **/
  ...
  public WebhookCheckSuiteRequested actionsMeta(Object actionsMeta) {
  ...
  **/
  ...
  public WebhookCheckSuiteRequested enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookCheckSuiteRequested organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookCheckSuiteRequested repository(Repository repository) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, webhookCheckSuiteRequested.action) &&
        Objects.equals(this.actionsMeta, webhookCheckSuiteRequested.actionsMeta) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCheckSuiteRequested
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCheckSuiteRequested.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCheckSuiteRequested is not found in the empty JSON string", WebhookCheckSuiteRequested.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCheckSuiteRequested.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCheckSuiteRequested` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCheckSuiteRequested.openapiRequiredFields) {
      ...
      WebhookCheckSuiteRequestedCheckSuite.validateJsonObject(jsonObj.getAsJsonObject("check_suite"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCheckSuiteRequested.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCheckSuiteRequested' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCheckSuiteRequested> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCheckSuiteRequested.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCheckSuiteRequested>() {
           @Override
           public void write(JsonWriter out, WebhookCheckSuiteRequested value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCheckSuiteRequested read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCheckSuiteRequested given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCheckSuiteRequested
  * @throws IOException if the JSON string is invalid with respect to WebhookCheckSuiteRequested
  */
  public static WebhookCheckSuiteRequested fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCheckSuiteRequested.class);
  }

 /**
  * Convert an instance of WebhookCheckSuiteRequested to an JSON string
  *
  * @return JSON string
  */
