...
import org.openapitools.client.model.WebhookWorkflowRunCompletedWorkflowRun;
...
public class WebhookWorkflowRunCompleted {
  ...
  private WebhookWorkflowRunCompletedWorkflowRun workflowRun;
  ...
  **/
  ...
  public WebhookWorkflowRunCompleted enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookWorkflowRunCompleted organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookWorkflowRunCompleted repository(Repository repository) {
  ...
  **/
  ...
  public WebhookWorkflowRunCompleted workflow(Workflow workflow) {
  ...
  **/
  ...
  public WebhookWorkflowRunCompleted workflowRun(WebhookWorkflowRunCompletedWorkflowRun workflowRun) {
  ...
  **/
  ...
  public WebhookWorkflowRunCompletedWorkflowRun getWorkflowRun() {
    return workflowRun;
  }


  public void setWorkflowRun(WebhookWorkflowRunCompletedWorkflowRun workflowRun) {
    this.workflowRun = workflowRun;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookWorkflowRunCompleted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookWorkflowRunCompleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookWorkflowRunCompleted is not found in the empty JSON string", WebhookWorkflowRunCompleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookWorkflowRunCompleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookWorkflowRunCompleted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookWorkflowRunCompleted.openapiRequiredFields) {
      ...
      WebhookWorkflowRunCompletedWorkflowRun.validateJsonObject(jsonObj.getAsJsonObject("workflow_run"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookWorkflowRunCompleted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookWorkflowRunCompleted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookWorkflowRunCompleted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookWorkflowRunCompleted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookWorkflowRunCompleted>() {
           @Override
           public void write(JsonWriter out, WebhookWorkflowRunCompleted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookWorkflowRunCompleted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookWorkflowRunCompleted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookWorkflowRunCompleted
  * @throws IOException if the JSON string is invalid with respect to WebhookWorkflowRunCompleted
  */
  public static WebhookWorkflowRunCompleted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookWorkflowRunCompleted.class);
  }

 /**
  * Convert an instance of WebhookWorkflowRunCompleted to an JSON string
  *
  * @return JSON string
  */
