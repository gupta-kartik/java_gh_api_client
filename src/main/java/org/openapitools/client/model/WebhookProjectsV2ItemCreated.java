...
public class WebhookProjectsV2ItemCreated {
  ...
  **/
  ...
  public WebhookProjectsV2ItemCreated organization(OrganizationSimple organization) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectsV2ItemCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectsV2ItemCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectsV2ItemCreated is not found in the empty JSON string", WebhookProjectsV2ItemCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectsV2ItemCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectsV2ItemCreated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookProjectsV2ItemCreated.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectsV2ItemCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectsV2ItemCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectsV2ItemCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectsV2ItemCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectsV2ItemCreated>() {
           @Override
           public void write(JsonWriter out, WebhookProjectsV2ItemCreated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectsV2ItemCreated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectsV2ItemCreated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectsV2ItemCreated
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectsV2ItemCreated
  */
  public static WebhookProjectsV2ItemCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectsV2ItemCreated.class);
  }

 /**
  * Convert an instance of WebhookProjectsV2ItemCreated to an JSON string
  *
  * @return JSON string
  */
