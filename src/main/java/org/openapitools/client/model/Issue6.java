...
public class Issue6 {
  ...
  **/
  ...
  public Issue6 assignee(User1 assignee) {
  ...
  **/
  ...
  public Issue6 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue6 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public Issue6 comments(Integer comments) {
  ...
  **/
  ...
  public Issue6 labels(List<Label> labels) {
  ...
  **/
  ...
  public Issue6 milestone(Milestone milestone) {
  ...
  **/
  ...
  public Issue6 number(Integer number) {
  ...
  **/
  ...
  public Issue6 performedViaGithubApp(App12 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue6 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue6 is not found in the empty JSON string", Issue6.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue6` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue6.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue6>() {
           @Override
           public void write(JsonWriter out, Issue6 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue6 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue6
  * @throws IOException if the JSON string is invalid with respect to Issue6
  */
  public static Issue6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue6.class);
  }

 /**
  * Convert an instance of Issue6 to an JSON string
  *
  * @return JSON string
  */
