...
public class SimplePullRequest {
  ...
  public SimplePullRequest links(PullRequestLinks links) {
  ...
  **/
  ...
  public SimplePullRequest assignee(User1 assignee) {
  ...
  **/
  ...
  public SimplePullRequest assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public SimplePullRequest addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public SimplePullRequest id(Integer id) {
  ...
  **/
  ...
  public SimplePullRequest labels(List<Label> labels) {
  ...
  **/
  ...
  public SimplePullRequest mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public SimplePullRequest number(Integer number) {
  ...
  **/
  ...
  public SimplePullRequest requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public SimplePullRequest addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  **/
  ...
  public SimplePullRequest user(User1 user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, simplePullRequest.links) &&
        ...
        Objects.equals(this.mergeCommitSha, simplePullRequest.mergeCommitSha) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimplePullRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimplePullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimplePullRequest is not found in the empty JSON string", SimplePullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SimplePullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplePullRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimplePullRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimplePullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimplePullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimplePullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimplePullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SimplePullRequest>() {
           @Override
           public void write(JsonWriter out, SimplePullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimplePullRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SimplePullRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SimplePullRequest
  * @throws IOException if the JSON string is invalid with respect to SimplePullRequest
  */
  public static SimplePullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimplePullRequest.class);
  }

 /**
  * Convert an instance of SimplePullRequest to an JSON string
  *
  * @return JSON string
  */
