...
public class WorkflowJob1 {
  ...
  private List<WorkflowStep1> steps = new ArrayList<>();
  ...
  public WorkflowJob1 checkRunUrl(URI checkRunUrl) {
  ...
  **/
  ...
  public WorkflowJob1 completedAt(String completedAt) {
  ...
  **/
  ...
  public WorkflowJob1 conclusion(ConclusionEnum conclusion) {
  ...
  **/
  ...
  public WorkflowJob1 createdAt(String createdAt) {
  ...
  **/
  ...
  public WorkflowJob1 headSha(String headSha) {
  ...
  **/
  ...
  public WorkflowJob1 htmlUrl(URI htmlUrl) {
  ...
  **/
  ...
  public WorkflowJob1 id(Integer id) {
  ...
  **/
  ...
  public WorkflowJob1 labels(List<String> labels) {
    
    this.labels = labels;
    return this;
  }

  public WorkflowJob1 addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WorkflowJob1 name(String name) {
  ...
  **/
  ...
  public WorkflowJob1 nodeId(String nodeId) {
  ...
  **/
  ...
  public WorkflowJob1 runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public WorkflowJob1 runId(BigDecimal runId) {
  ...
  **/
  ...
  public WorkflowJob1 runUrl(URI runUrl) {
  ...
  **/
  ...
  public WorkflowJob1 runnerGroupId(Integer runnerGroupId) {
  ...
  **/
  ...
  public WorkflowJob1 runnerGroupName(String runnerGroupName) {
  ...
  **/
  ...
  public WorkflowJob1 runnerId(Integer runnerId) {
  ...
  **/
  ...
  public WorkflowJob1 runnerName(String runnerName) {
  ...
  **/
  ...
  public WorkflowJob1 startedAt(String startedAt) {
  ...
  **/
  ...
  public WorkflowJob1 status(StatusEnum status) {
  ...
  **/
  ...
  public WorkflowJob1 headBranch(String headBranch) {
  ...
  **/
  ...
  public WorkflowJob1 workflowName(String workflowName) {
  ...
  **/
  ...
  public WorkflowJob1 steps(List<WorkflowStep1> steps) {
    
    this.steps = steps;
    return this;
  }

  public WorkflowJob1 addStepsItem(WorkflowStep1 stepsItem) {
    if (this.steps == null) {
  ...
  **/
  ...
  public WorkflowJob1 url(URI url) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WorkflowJob1 workflowJob1 = (WorkflowJob1) o;
    return Objects.equals(this.checkRunUrl, workflowJob1.checkRunUrl) &&
        Objects.equals(this.completedAt, workflowJob1.completedAt) &&
        Objects.equals(this.conclusion, workflowJob1.conclusion) &&
        Objects.equals(this.createdAt, workflowJob1.createdAt) &&
        Objects.equals(this.headSha, workflowJob1.headSha) &&
        Objects.equals(this.htmlUrl, workflowJob1.htmlUrl) &&
        Objects.equals(this.id, workflowJob1.id) &&
        Objects.equals(this.labels, workflowJob1.labels) &&
        Objects.equals(this.name, workflowJob1.name) &&
        Objects.equals(this.nodeId, workflowJob1.nodeId) &&
        Objects.equals(this.runAttempt, workflowJob1.runAttempt) &&
        Objects.equals(this.runId, workflowJob1.runId) &&
        Objects.equals(this.runUrl, workflowJob1.runUrl) &&
        Objects.equals(this.runnerGroupId, workflowJob1.runnerGroupId) &&
        Objects.equals(this.runnerGroupName, workflowJob1.runnerGroupName) &&
        Objects.equals(this.runnerId, workflowJob1.runnerId) &&
        Objects.equals(this.runnerName, workflowJob1.runnerName) &&
        Objects.equals(this.startedAt, workflowJob1.startedAt) &&
        Objects.equals(this.status, workflowJob1.status) &&
        Objects.equals(this.headBranch, workflowJob1.headBranch) &&
        Objects.equals(this.workflowName, workflowJob1.workflowName) &&
        Objects.equals(this.steps, workflowJob1.steps) &&
        Objects.equals(this.url, workflowJob1.url);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowJob1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowJob1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowJob1 is not found in the empty JSON string", WorkflowJob1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowJob1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowJob1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowJob1.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraysteps.size(); i++) {
        WorkflowStep1.validateJsonObject(jsonArraysteps.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowJob1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowJob1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowJob1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowJob1.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowJob1>() {
           @Override
           public void write(JsonWriter out, WorkflowJob1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowJob1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowJob1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowJob1
  * @throws IOException if the JSON string is invalid with respect to WorkflowJob1
  */
  public static WorkflowJob1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowJob1.class);
  }

 /**
  * Convert an instance of WorkflowJob1 to an JSON string
  *
  * @return JSON string
  */
