...
public class DependabotAlertWithRepository {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(number, state, dependency, securityAdvisory, securityVulnerability, url, htmlUrl, createdAt, updatedAt, dismissedAt, dismissedBy, dismissedReason, dismissedComment, fixedAt, autoDismissedAt, repository);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DependabotAlertWithRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DependabotAlertWithRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DependabotAlertWithRepository is not found in the empty JSON string", DependabotAlertWithRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DependabotAlertWithRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependabotAlertWithRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DependabotAlertWithRepository.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DependabotAlertWithRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DependabotAlertWithRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DependabotAlertWithRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DependabotAlertWithRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<DependabotAlertWithRepository>() {
           @Override
           public void write(JsonWriter out, DependabotAlertWithRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DependabotAlertWithRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DependabotAlertWithRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DependabotAlertWithRepository
  * @throws IOException if the JSON string is invalid with respect to DependabotAlertWithRepository
  */
  public static DependabotAlertWithRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DependabotAlertWithRepository.class);
  }

 /**
  * Convert an instance of DependabotAlertWithRepository to an JSON string
  *
  * @return JSON string
  */
