...
import org.openapitools.client.model.WebhookIssuesMilestonedIssue;
...
public class WebhookIssuesMilestoned {
  ...
  private WebhookIssuesMilestonedIssue issue;
  ...
  **/
  ...
  public WebhookIssuesMilestoned enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookIssuesMilestoned issue(WebhookIssuesMilestonedIssue issue) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue getIssue() {
    return issue;
  }


  public void setIssue(WebhookIssuesMilestonedIssue issue) {
    this.issue = issue;
  }


  public WebhookIssuesMilestoned milestone(Milestone2 milestone) {
  ...
  **/
  ...
  public WebhookIssuesMilestoned organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookIssuesMilestoned repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesMilestoned
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesMilestoned.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesMilestoned is not found in the empty JSON string", WebhookIssuesMilestoned.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesMilestoned.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesMilestoned` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesMilestoned.openapiRequiredFields) {
      ...
      WebhookIssuesMilestonedIssue.validateJsonObject(jsonObj.getAsJsonObject("issue"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesMilestoned.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesMilestoned' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesMilestoned> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesMilestoned.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesMilestoned>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesMilestoned value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesMilestoned read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesMilestoned given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesMilestoned
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesMilestoned
  */
  public static WebhookIssuesMilestoned fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesMilestoned.class);
  }

 /**
  * Convert an instance of WebhookIssuesMilestoned to an JSON string
  *
  * @return JSON string
  */
