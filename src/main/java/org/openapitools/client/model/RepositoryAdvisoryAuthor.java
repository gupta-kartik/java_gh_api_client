...
public class RepositoryAdvisoryAuthor {
  ...
  public RepositoryAdvisoryAuthor() {
  }

  public RepositoryAdvisoryAuthor name(String name) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor email(String email) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor login(String login) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor id(Integer id) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor nodeId(String nodeId) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor avatarUrl(URI avatarUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor gravatarId(String gravatarId) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor url(URI url) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor htmlUrl(URI htmlUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor followersUrl(URI followersUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor followingUrl(String followingUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor gistsUrl(String gistsUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor starredUrl(String starredUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor subscriptionsUrl(URI subscriptionsUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor organizationsUrl(URI organizationsUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor reposUrl(URI reposUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor receivedEventsUrl(URI receivedEventsUrl) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor type(String type) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor siteAdmin(Boolean siteAdmin) {
  ...
  **/
  ...
  public RepositoryAdvisoryAuthor starredAt(String starredAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RepositoryAdvisoryAuthor repositoryAdvisoryAuthor = (RepositoryAdvisoryAuthor) o;
    return Objects.equals(this.name, repositoryAdvisoryAuthor.name) &&
        Objects.equals(this.email, repositoryAdvisoryAuthor.email) &&
        Objects.equals(this.login, repositoryAdvisoryAuthor.login) &&
        Objects.equals(this.id, repositoryAdvisoryAuthor.id) &&
        Objects.equals(this.nodeId, repositoryAdvisoryAuthor.nodeId) &&
        Objects.equals(this.avatarUrl, repositoryAdvisoryAuthor.avatarUrl) &&
        Objects.equals(this.gravatarId, repositoryAdvisoryAuthor.gravatarId) &&
        Objects.equals(this.url, repositoryAdvisoryAuthor.url) &&
        Objects.equals(this.htmlUrl, repositoryAdvisoryAuthor.htmlUrl) &&
        Objects.equals(this.followersUrl, repositoryAdvisoryAuthor.followersUrl) &&
        Objects.equals(this.followingUrl, repositoryAdvisoryAuthor.followingUrl) &&
        Objects.equals(this.gistsUrl, repositoryAdvisoryAuthor.gistsUrl) &&
        Objects.equals(this.starredUrl, repositoryAdvisoryAuthor.starredUrl) &&
        Objects.equals(this.subscriptionsUrl, repositoryAdvisoryAuthor.subscriptionsUrl) &&
        Objects.equals(this.organizationsUrl, repositoryAdvisoryAuthor.organizationsUrl) &&
        Objects.equals(this.reposUrl, repositoryAdvisoryAuthor.reposUrl) &&
        Objects.equals(this.eventsUrl, repositoryAdvisoryAuthor.eventsUrl) &&
        Objects.equals(this.receivedEventsUrl, repositoryAdvisoryAuthor.receivedEventsUrl) &&
        Objects.equals(this.type, repositoryAdvisoryAuthor.type) &&
        Objects.equals(this.siteAdmin, repositoryAdvisoryAuthor.siteAdmin) &&
        Objects.equals(this.starredAt, repositoryAdvisoryAuthor.starredAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryAdvisoryAuthor {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryAdvisoryAuthor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryAdvisoryAuthor.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryAdvisoryAuthor is not found in the empty JSON string", RepositoryAdvisoryAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RepositoryAdvisoryAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryAdvisoryAuthor` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepositoryAdvisoryAuthor.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryAdvisoryAuthor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryAdvisoryAuthor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryAdvisoryAuthor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryAdvisoryAuthor.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryAdvisoryAuthor>() {
           @Override
           public void write(JsonWriter out, RepositoryAdvisoryAuthor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryAdvisoryAuthor read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RepositoryAdvisoryAuthor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryAdvisoryAuthor
  * @throws IOException if the JSON string is invalid with respect to RepositoryAdvisoryAuthor
  */
  public static RepositoryAdvisoryAuthor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryAdvisoryAuthor.class);
  }

 /**
  * Convert an instance of RepositoryAdvisoryAuthor to an JSON string
  *
  * @return JSON string
  */
