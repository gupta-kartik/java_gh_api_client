...
public class WebhookTeamDeleted {
  ...
  **/
  ...
  public WebhookTeamDeleted team(Team3 team) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookTeamDeleted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookTeamDeleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookTeamDeleted is not found in the empty JSON string", WebhookTeamDeleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookTeamDeleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookTeamDeleted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookTeamDeleted.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookTeamDeleted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookTeamDeleted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookTeamDeleted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookTeamDeleted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookTeamDeleted>() {
           @Override
           public void write(JsonWriter out, WebhookTeamDeleted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookTeamDeleted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookTeamDeleted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookTeamDeleted
  * @throws IOException if the JSON string is invalid with respect to WebhookTeamDeleted
  */
  public static WebhookTeamDeleted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookTeamDeleted.class);
  }

 /**
  * Convert an instance of WebhookTeamDeleted to an JSON string
  *
  * @return JSON string
  */
