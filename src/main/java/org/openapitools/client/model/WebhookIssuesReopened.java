...
import org.openapitools.client.model.WebhookIssuesReopenedIssue;
...
public class WebhookIssuesReopened {
  ...
  private WebhookIssuesReopenedIssue issue;
  ...
  **/
  ...
  public WebhookIssuesReopened enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookIssuesReopened issue(WebhookIssuesReopenedIssue issue) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue getIssue() {
    return issue;
  }


  public void setIssue(WebhookIssuesReopenedIssue issue) {
    this.issue = issue;
  }


  public WebhookIssuesReopened organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookIssuesReopened repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesReopened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesReopened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesReopened is not found in the empty JSON string", WebhookIssuesReopened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesReopened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesReopened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesReopened.openapiRequiredFields) {
      ...
      WebhookIssuesReopenedIssue.validateJsonObject(jsonObj.getAsJsonObject("issue"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesReopened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesReopened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesReopened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesReopened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesReopened>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesReopened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesReopened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesReopened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesReopened
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesReopened
  */
  public static WebhookIssuesReopened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesReopened.class);
  }

 /**
  * Convert an instance of WebhookIssuesReopened to an JSON string
  *
  * @return JSON string
  */
