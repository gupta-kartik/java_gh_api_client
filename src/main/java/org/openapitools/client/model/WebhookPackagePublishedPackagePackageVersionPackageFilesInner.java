...
public class WebhookPackagePublishedPackagePackageVersionPackageFilesInner {
  ...
  **/
  ...
  public WebhookPackagePublishedPackagePackageVersionPackageFilesInner id(Integer id) {
  ...
  **/
  ...
  public WebhookPackagePublishedPackagePackageVersionPackageFilesInner size(Integer size) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPackagePublishedPackagePackageVersionPackageFilesInner webhookPackagePublishedPackagePackageVersionPackageFilesInner = (WebhookPackagePublishedPackagePackageVersionPackageFilesInner) o;
    return Objects.equals(this.contentType, webhookPackagePublishedPackagePackageVersionPackageFilesInner.contentType) &&
        Objects.equals(this.createdAt, webhookPackagePublishedPackagePackageVersionPackageFilesInner.createdAt) &&
        Objects.equals(this.downloadUrl, webhookPackagePublishedPackagePackageVersionPackageFilesInner.downloadUrl) &&
        ...
        Objects.equals(this.updatedAt, webhookPackagePublishedPackagePackageVersionPackageFilesInner.updatedAt);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPackagePublishedPackagePackageVersionPackageFilesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPackagePublishedPackagePackageVersionPackageFilesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPackagePublishedPackagePackageVersionPackageFilesInner is not found in the empty JSON string", WebhookPackagePublishedPackagePackageVersionPackageFilesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPackagePublishedPackagePackageVersionPackageFilesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPackagePublishedPackagePackageVersionPackageFilesInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPackagePublishedPackagePackageVersionPackageFilesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPackagePublishedPackagePackageVersionPackageFilesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPackagePublishedPackagePackageVersionPackageFilesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPackagePublishedPackagePackageVersionPackageFilesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPackagePublishedPackagePackageVersionPackageFilesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPackagePublishedPackagePackageVersionPackageFilesInner>() {
           @Override
           public void write(JsonWriter out, WebhookPackagePublishedPackagePackageVersionPackageFilesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPackagePublishedPackagePackageVersionPackageFilesInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPackagePublishedPackagePackageVersionPackageFilesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPackagePublishedPackagePackageVersionPackageFilesInner
  * @throws IOException if the JSON string is invalid with respect to WebhookPackagePublishedPackagePackageVersionPackageFilesInner
  */
  public static WebhookPackagePublishedPackagePackageVersionPackageFilesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPackagePublishedPackagePackageVersionPackageFilesInner.class);
  }

 /**
  * Convert an instance of WebhookPackagePublishedPackagePackageVersionPackageFilesInner to an JSON string
  *
  * @return JSON string
  */
