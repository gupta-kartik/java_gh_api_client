...
public class ReactionRollup {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReactionRollup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReactionRollup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReactionRollup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReactionRollup` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
