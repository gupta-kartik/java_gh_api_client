...
public class Reactions {
  ...
  public Reactions plus1(Integer plus1) {
  ...
  **/
  ...
  public Reactions _1(Integer _1) {
  ...
  **/
  ...
  public Reactions confused(Integer confused) {
  ...
  **/
  ...
  public Reactions eyes(Integer eyes) {
  ...
  **/
  ...
  public Reactions heart(Integer heart) {
  ...
  **/
  ...
  public Reactions hooray(Integer hooray) {
  ...
  **/
  ...
  public Reactions laugh(Integer laugh) {
  ...
  **/
  ...
  public Reactions rocket(Integer rocket) {
  ...
  **/
  ...
  public Reactions totalCount(Integer totalCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Reactions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Reactions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Reactions is not found in the empty JSON string", Reactions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Reactions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Reactions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Reactions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reactions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reactions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reactions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reactions.class));

       return (TypeAdapter<T>) new TypeAdapter<Reactions>() {
           @Override
           public void write(JsonWriter out, Reactions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reactions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Reactions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Reactions
  * @throws IOException if the JSON string is invalid with respect to Reactions
  */
  public static Reactions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Reactions.class);
  }

 /**
  * Convert an instance of Reactions to an JSON string
  *
  * @return JSON string
  */
