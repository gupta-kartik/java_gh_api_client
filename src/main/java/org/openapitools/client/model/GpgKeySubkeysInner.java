...
public class GpgKeySubkeysInner {
  ...
  private List<GpgKeyEmailsInner> emails;
  ...
  **/
  ...
  public GpgKeySubkeysInner emails(List<GpgKeyEmailsInner> emails) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, primaryKeyId, keyId, publicKey, emails, subkeys, canSign, canEncryptComms, canEncryptStorage, canCertify, createdAt, expiresAt, rawKey, revoked);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GpgKeySubkeysInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GpgKeySubkeysInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GpgKeySubkeysInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GpgKeySubkeysInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("subkeys") != null && !jsonObj.get("subkeys").isJsonArray()) {
