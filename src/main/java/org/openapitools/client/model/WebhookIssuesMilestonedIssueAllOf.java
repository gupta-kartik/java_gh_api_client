...
/**
 * WebhookIssuesMilestonedIssueAllOf
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-05-09T20:37:23.111113500+10:00[Australia/Brisbane]")
public class WebhookIssuesMilestonedIssueAllOf {
  ...
  public WebhookIssuesMilestonedIssueAllOf() {
  }

  public WebhookIssuesMilestonedIssueAllOf activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesMilestonedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesMilestonedIssueAllOf addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf milestone(Milestone2 milestone) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf state(String state) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesMilestonedIssueAllOf webhookIssuesMilestonedIssueAllOf = (WebhookIssuesMilestonedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssuesMilestonedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesMilestonedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssuesMilestonedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesMilestonedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesMilestonedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssuesMilestonedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssuesMilestonedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesMilestonedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesMilestonedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssuesMilestonedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesMilestonedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesMilestonedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssuesMilestonedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesMilestonedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesMilestonedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssuesMilestonedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesMilestonedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssuesMilestonedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesMilestonedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssuesMilestonedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesMilestonedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesMilestonedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssuesMilestonedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesMilestonedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssuesMilestonedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssuesMilestonedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssuesMilestonedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesMilestonedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesMilestonedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesMilestonedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesMilestonedIssueAllOf is not found in the empty JSON string", WebhookIssuesMilestonedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesMilestonedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesMilestonedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesMilestonedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesMilestonedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesMilestonedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesMilestonedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesMilestonedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesMilestonedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesMilestonedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesMilestonedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesMilestonedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesMilestonedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesMilestonedIssueAllOf
  */
  public static WebhookIssuesMilestonedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesMilestonedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssuesMilestonedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
