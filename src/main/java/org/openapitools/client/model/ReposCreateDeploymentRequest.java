...
public class ReposCreateDeploymentRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposCreateDeploymentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposCreateDeploymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposCreateDeploymentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposCreateDeploymentRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("required_contexts") != null && !jsonObj.get("required_contexts").isJsonArray()) {
      ...
      if (jsonObj.get("payload") != null && !jsonObj.get("payload").isJsonNull()) {
        ReposCreateDeploymentRequestPayload.validateJsonObject(jsonObj.getAsJsonObject("payload"));
      }
