...
import org.openapitools.client.model.WebhookCodeScanningAlertAppearedInBranchAlertRule;
import org.openapitools.client.model.WebhookCodeScanningAlertAppearedInBranchAlertTool;
...
public class WebhookCodeScanningAlertReopenedByUserAlert {
  ...
  **/
  ...
  public WebhookCodeScanningAlertReopenedByUserAlert number(Integer number) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookCodeScanningAlertReopenedByUserAlert webhookCodeScanningAlertReopenedByUserAlert = (WebhookCodeScanningAlertReopenedByUserAlert) o;
    return Objects.equals(this.createdAt, webhookCodeScanningAlertReopenedByUserAlert.createdAt) &&
        ...
        Objects.equals(this.mostRecentInstance, webhookCodeScanningAlertReopenedByUserAlert.mostRecentInstance) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertReopenedByUserAlert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertReopenedByUserAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertReopenedByUserAlert is not found in the empty JSON string", WebhookCodeScanningAlertReopenedByUserAlert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertReopenedByUserAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertReopenedByUserAlert` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertReopenedByUserAlert.openapiRequiredFields) {
      ...
      WebhookCodeScanningAlertAppearedInBranchAlertRule.validateJsonObject(jsonObj.getAsJsonObject("rule"));
      if (!jsonObj.get("state").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `state` to be a primitive type in the JSON string but got `%s`", jsonObj.get("state").toString()));
      }
      // validate the required field `tool`
      WebhookCodeScanningAlertAppearedInBranchAlertTool.validateJsonObject(jsonObj.getAsJsonObject("tool"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertReopenedByUserAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertReopenedByUserAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertReopenedByUserAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertReopenedByUserAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertReopenedByUserAlert>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertReopenedByUserAlert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertReopenedByUserAlert read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertReopenedByUserAlert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertReopenedByUserAlert
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertReopenedByUserAlert
  */
  public static WebhookCodeScanningAlertReopenedByUserAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertReopenedByUserAlert.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertReopenedByUserAlert to an JSON string
  *
  * @return JSON string
  */
