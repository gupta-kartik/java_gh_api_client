...
public class MarketplacePurchase {
  ...
  **/
  ...
  public MarketplacePurchase unitCount(Integer unitCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MarketplacePurchase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MarketplacePurchase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarketplacePurchase is not found in the empty JSON string", MarketplacePurchase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MarketplacePurchase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarketplacePurchase` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MarketplacePurchase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarketplacePurchase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarketplacePurchase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarketplacePurchase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarketplacePurchase.class));

       return (TypeAdapter<T>) new TypeAdapter<MarketplacePurchase>() {
           @Override
           public void write(JsonWriter out, MarketplacePurchase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarketplacePurchase read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MarketplacePurchase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MarketplacePurchase
  * @throws IOException if the JSON string is invalid with respect to MarketplacePurchase
  */
  public static MarketplacePurchase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarketplacePurchase.class);
  }

 /**
  * Convert an instance of MarketplacePurchase to an JSON string
  *
  * @return JSON string
  */
