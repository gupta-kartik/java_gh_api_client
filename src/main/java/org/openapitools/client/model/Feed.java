...
public class Feed {
  ...
  public static final String SERIALIZED_NAME_REPOSITORY_DISCUSSIONS_URL = "repository_discussions_url";
  @SerializedName(SERIALIZED_NAME_REPOSITORY_DISCUSSIONS_URL)
  private String repositoryDiscussionsUrl;

  public static final String SERIALIZED_NAME_REPOSITORY_DISCUSSIONS_CATEGORY_URL = "repository_discussions_category_url";
  @SerializedName(SERIALIZED_NAME_REPOSITORY_DISCUSSIONS_CATEGORY_URL)
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timelineUrl, userUrl, currentUserPublicUrl, currentUserUrl, currentUserActorUrl, currentUserOrganizationUrl, currentUserOrganizationUrls, securityAdvisoriesUrl, repositoryDiscussionsUrl, repositoryDiscussionsCategoryUrl, links);
  }
  ...
  public String toString() {
    ...
    sb.append("    repositoryDiscussionsUrl: ").append(toIndentedString(repositoryDiscussionsUrl)).append("\n");
    sb.append("    repositoryDiscussionsCategoryUrl: ").append(toIndentedString(repositoryDiscussionsCategoryUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("repository_discussions_url");
    openapiFields.add("repository_discussions_category_url");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Feed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Feed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Feed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Feed` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("current_user_organization_urls") != null && !jsonObj.get("current_user_organization_urls").isJsonArray()) {
      ...
      if ((jsonObj.get("repository_discussions_url") != null && !jsonObj.get("repository_discussions_url").isJsonNull()) && !jsonObj.get("repository_discussions_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `repository_discussions_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("repository_discussions_url").toString()));
      }
      if ((jsonObj.get("repository_discussions_category_url") != null && !jsonObj.get("repository_discussions_category_url").isJsonNull()) && !jsonObj.get("repository_discussions_category_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `repository_discussions_category_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("repository_discussions_category_url").toString()));
      }
      // validate the required field `_links`
      FeedLinks.validateJsonObject(jsonObj.getAsJsonObject("_links"));
  }
