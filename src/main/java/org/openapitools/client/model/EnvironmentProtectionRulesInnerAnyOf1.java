...
public class EnvironmentProtectionRulesInnerAnyOf1 {
  ...
  private List<PendingDeploymentReviewersInner> reviewers;
  ...
  **/
  ...
  public EnvironmentProtectionRulesInnerAnyOf1 reviewers(List<PendingDeploymentReviewersInner> reviewers) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, nodeId, type, reviewers);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EnvironmentProtectionRulesInnerAnyOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EnvironmentProtectionRulesInnerAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EnvironmentProtectionRulesInnerAnyOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvironmentProtectionRulesInnerAnyOf1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
