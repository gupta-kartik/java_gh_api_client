...
public class WebhookInstallationSuspend {
  ...
  **/
  ...
  public WebhookInstallationSuspend enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookInstallationSuspend organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookInstallationSuspend repositories(List<PersonalAccessTokenRequestRepositoriesInner> repositories) {
    
    this.repositories = repositories;
    return this;
  }

  public WebhookInstallationSuspend addRepositoriesItem(PersonalAccessTokenRequestRepositoriesInner repositoriesItem) {
  ...
  **/
  ...
  public WebhookInstallationSuspend repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookInstallationSuspend
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookInstallationSuspend.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookInstallationSuspend is not found in the empty JSON string", WebhookInstallationSuspend.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookInstallationSuspend.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookInstallationSuspend` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookInstallationSuspend.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookInstallationSuspend.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookInstallationSuspend' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookInstallationSuspend> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookInstallationSuspend.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookInstallationSuspend>() {
           @Override
           public void write(JsonWriter out, WebhookInstallationSuspend value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookInstallationSuspend read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookInstallationSuspend given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookInstallationSuspend
  * @throws IOException if the JSON string is invalid with respect to WebhookInstallationSuspend
  */
  public static WebhookInstallationSuspend fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookInstallationSuspend.class);
  }

 /**
  * Convert an instance of WebhookInstallationSuspend to an JSON string
  *
  * @return JSON string
  */
