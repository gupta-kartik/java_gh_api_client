...
import org.openapitools.client.model.SimplePullRequest;
import org.openapitools.client.model.SimpleUser;
import org.openapitools.client.model.WebhookPullRequestReviewDismissedReview;
...
public class WebhookPullRequestReviewDismissed {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestReviewDismissed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestReviewDismissed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestReviewDismissed is not found in the empty JSON string", WebhookPullRequestReviewDismissed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestReviewDismissed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestReviewDismissed` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestReviewDismissed.openapiRequiredFields) {
      ...
      SimplePullRequest.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
      ...
      WebhookPullRequestReviewDismissedReview.validateJsonObject(jsonObj.getAsJsonObject("review"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestReviewDismissed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestReviewDismissed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestReviewDismissed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestReviewDismissed.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestReviewDismissed>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestReviewDismissed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestReviewDismissed read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestReviewDismissed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestReviewDismissed
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestReviewDismissed
  */
  public static WebhookPullRequestReviewDismissed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestReviewDismissed.class);
  }

 /**
  * Convert an instance of WebhookPullRequestReviewDismissed to an JSON string
  *
  * @return JSON string
  */
