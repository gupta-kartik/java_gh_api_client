...
public class Issue10 {
  ...
  **/
  ...
  public Issue10 assignees(List<User> assignees) {
  ...
  **/
  ...
  public Issue10 comments(Integer comments) {
  ...
  **/
  ...
  public Issue10 labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public Issue10 addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public Issue10 number(Integer number) {
  ...
  **/
  ...
  public Issue10 performedViaGithubApp(App7 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue10 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue10 is not found in the empty JSON string", Issue10.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue10` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue10.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue10.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue10>() {
           @Override
           public void write(JsonWriter out, Issue10 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue10 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue10
  * @throws IOException if the JSON string is invalid with respect to Issue10
  */
  public static Issue10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue10.class);
  }

 /**
  * Convert an instance of Issue10 to an JSON string
  *
  * @return JSON string
  */
