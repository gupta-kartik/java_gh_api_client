...
import org.openapitools.client.model.WebhookProjectCardConvertedChanges;
...
public class WebhookProjectCardConverted {
  ...
  **/
  ...
  public WebhookProjectCardConverted enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookProjectCardConverted organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookProjectCardConverted projectCard(ProjectCard projectCard) {
  ...
  **/
  ...
  public WebhookProjectCardConverted repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectCardConverted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectCardConverted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectCardConverted is not found in the empty JSON string", WebhookProjectCardConverted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectCardConverted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectCardConverted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookProjectCardConverted.openapiRequiredFields) {
      ...
      WebhookProjectCardConvertedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectCardConverted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectCardConverted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectCardConverted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectCardConverted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectCardConverted>() {
           @Override
           public void write(JsonWriter out, WebhookProjectCardConverted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectCardConverted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectCardConverted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectCardConverted
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectCardConverted
  */
  public static WebhookProjectCardConverted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectCardConverted.class);
  }

 /**
  * Convert an instance of WebhookProjectCardConverted to an JSON string
  *
  * @return JSON string
  */
