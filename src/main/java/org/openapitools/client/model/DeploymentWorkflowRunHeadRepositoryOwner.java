...
public class DeploymentWorkflowRunHeadRepositoryOwner {
  ...
  public DeploymentWorkflowRunHeadRepositoryOwner() {
  }
  ...
  **/
  ...
  public DeploymentWorkflowRunHeadRepositoryOwner id(Integer id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeploymentWorkflowRunHeadRepositoryOwner deploymentWorkflowRunHeadRepositoryOwner = (DeploymentWorkflowRunHeadRepositoryOwner) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeploymentWorkflowRunHeadRepositoryOwner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeploymentWorkflowRunHeadRepositoryOwner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeploymentWorkflowRunHeadRepositoryOwner is not found in the empty JSON string", DeploymentWorkflowRunHeadRepositoryOwner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeploymentWorkflowRunHeadRepositoryOwner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeploymentWorkflowRunHeadRepositoryOwner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentWorkflowRunHeadRepositoryOwner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentWorkflowRunHeadRepositoryOwner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentWorkflowRunHeadRepositoryOwner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentWorkflowRunHeadRepositoryOwner.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentWorkflowRunHeadRepositoryOwner>() {
           @Override
           public void write(JsonWriter out, DeploymentWorkflowRunHeadRepositoryOwner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeploymentWorkflowRunHeadRepositoryOwner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DeploymentWorkflowRunHeadRepositoryOwner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeploymentWorkflowRunHeadRepositoryOwner
  * @throws IOException if the JSON string is invalid with respect to DeploymentWorkflowRunHeadRepositoryOwner
  */
  public static DeploymentWorkflowRunHeadRepositoryOwner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeploymentWorkflowRunHeadRepositoryOwner.class);
  }

 /**
  * Convert an instance of DeploymentWorkflowRunHeadRepositoryOwner to an JSON string
  *
  * @return JSON string
  */
