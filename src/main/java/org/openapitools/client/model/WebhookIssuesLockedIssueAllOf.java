...
public class WebhookIssuesLockedIssueAllOf {
  /**
  ...
  public WebhookIssuesLockedIssueAllOf() {
  }

  public WebhookIssuesLockedIssueAllOf activeLockReason(ActiveLockReasonEnum activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesLockedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesLockedIssueAllOf addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf locked(LockedEnum locked) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf state(String state) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesLockedIssueAllOf webhookIssuesLockedIssueAllOf = (WebhookIssuesLockedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssuesLockedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesLockedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssuesLockedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesLockedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesLockedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssuesLockedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssuesLockedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesLockedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesLockedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssuesLockedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesLockedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesLockedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssuesLockedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesLockedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesLockedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssuesLockedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesLockedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssuesLockedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesLockedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssuesLockedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesLockedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesLockedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssuesLockedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesLockedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssuesLockedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssuesLockedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssuesLockedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesLockedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesLockedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesLockedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesLockedIssueAllOf is not found in the empty JSON string", WebhookIssuesLockedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesLockedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesLockedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesLockedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesLockedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesLockedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesLockedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesLockedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesLockedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesLockedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesLockedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesLockedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesLockedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesLockedIssueAllOf
  */
  public static WebhookIssuesLockedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesLockedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssuesLockedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
