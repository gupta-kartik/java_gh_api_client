...
public class Repository11 {
  ...
  **/
  ...
  public Repository11 forks(Integer forks) {
  ...
  **/
  ...
  public Repository11 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository11 id(Integer id) {
  ...
  **/
  ...
  public Repository11 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository11 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository11 size(Integer size) {
  ...
  **/
  ...
  public Repository11 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository11 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository11 useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public Repository11 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository11 watchersCount(Integer watchersCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowAutoMerge, repository11.allowAutoMerge) &&
        ...
        Objects.equals(this.useSquashPrTitleAsDefault, repository11.useSquashPrTitleAsDefault) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository11 is not found in the empty JSON string", Repository11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository11` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository11.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository11.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository11>() {
           @Override
           public void write(JsonWriter out, Repository11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository11 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository11
  * @throws IOException if the JSON string is invalid with respect to Repository11
  */
  public static Repository11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository11.class);
  }

 /**
  * Convert an instance of Repository11 to an JSON string
  *
  * @return JSON string
  */
