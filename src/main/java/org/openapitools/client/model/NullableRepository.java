...
import org.openapitools.client.model.RepositoryTemplateRepository;
...
public class NullableRepository {
  ...
  **/
  ...
  public NullableRepository templateRepository(RepositoryTemplateRepository templateRepository) {
  ...
  **/
  ...
  public void setTemplateRepository(RepositoryTemplateRepository templateRepository) {
    this.templateRepository = templateRepository;
  }
  ...
  **/
  ...
  public NullableRepository useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, nullableRepository.id) &&
        ...
        Objects.equals(this.useSquashPrTitleAsDefault, nullableRepository.useSquashPrTitleAsDefault) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to NullableRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NullableRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NullableRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NullableRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("template_repository") != null && !jsonObj.get("template_repository").isJsonNull()) {
        RepositoryTemplateRepository.validateJsonObject(jsonObj.getAsJsonObject("template_repository"));
      }
