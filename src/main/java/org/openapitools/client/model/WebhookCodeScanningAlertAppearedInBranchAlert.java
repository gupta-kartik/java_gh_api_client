...
public class WebhookCodeScanningAlertAppearedInBranchAlert {
  ...
  **/
  ...
  public WebhookCodeScanningAlertAppearedInBranchAlert number(Integer number) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertAppearedInBranchAlert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertAppearedInBranchAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertAppearedInBranchAlert is not found in the empty JSON string", WebhookCodeScanningAlertAppearedInBranchAlert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertAppearedInBranchAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertAppearedInBranchAlert` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertAppearedInBranchAlert.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertAppearedInBranchAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertAppearedInBranchAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertAppearedInBranchAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertAppearedInBranchAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertAppearedInBranchAlert>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertAppearedInBranchAlert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertAppearedInBranchAlert read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertAppearedInBranchAlert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertAppearedInBranchAlert
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertAppearedInBranchAlert
  */
  public static WebhookCodeScanningAlertAppearedInBranchAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertAppearedInBranchAlert.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertAppearedInBranchAlert to an JSON string
  *
  * @return JSON string
  */
