...
public class TeamRepository {
  ...
  public TeamRepository id(Integer id) {
  ...
  **/
  ...
  public TeamRepository forks(Integer forks) {
  ...
  **/
  ...
  public TeamRepository forksCount(Integer forksCount) {
  ...
  **/
  ...
  public TeamRepository stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public TeamRepository watchersCount(Integer watchersCount) {
  ...
  **/
  ...
  public TeamRepository size(Integer size) {
  ...
  **/
  ...
  public TeamRepository openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public TeamRepository hasDownloads(Boolean hasDownloads) {
  ...
  **/
  ...
  public TeamRepository templateRepository(NullableRepository templateRepository) {
  ...
  **/
  ...
  public TeamRepository subscribersCount(Integer subscribersCount) {
  ...
  **/
  ...
  public TeamRepository networkCount(Integer networkCount) {
  ...
  **/
  ...
  public TeamRepository openIssues(Integer openIssues) {
  ...
  **/
  ...
  public TeamRepository watchers(Integer watchers) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamRepository is not found in the empty JSON string", TeamRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TeamRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamRepository.openapiRequiredFields) {
      ...
      if (jsonObj.get("template_repository") != null && !jsonObj.get("template_repository").isJsonNull()) {
        NullableRepository.validateJsonObject(jsonObj.getAsJsonObject("template_repository"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamRepository>() {
           @Override
           public void write(JsonWriter out, TeamRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TeamRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TeamRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamRepository
  * @throws IOException if the JSON string is invalid with respect to TeamRepository
  */
  public static TeamRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamRepository.class);
  }

 /**
  * Convert an instance of TeamRepository to an JSON string
  *
  * @return JSON string
  */
