...
import org.openapitools.client.model.PullRequest1Base;
...
public class PullRequest1 {
  ...
  public PullRequest1 links(PullRequestLinks links) {
  ...
  **/
  ...
  public PullRequest1 additions(Integer additions) {
  ...
  **/
  ...
  public PullRequest1 assignees(List<User> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public PullRequest1 addAssigneesItem(User assigneesItem) {
  ...
  **/
  ...
  public PullRequest1 changedFiles(Integer changedFiles) {
  ...
  **/
  ...
  public PullRequest1 comments(Integer comments) {
  ...
  **/
  ...
  public PullRequest1 commits(Integer commits) {
  ...
  **/
  ...
  public PullRequest1 deletions(Integer deletions) {
  ...
  **/
  ...
  public PullRequest1 id(Integer id) {
  ...
  **/
  ...
  public PullRequest1 labels(List<Label> labels) {
  ...
  **/
  ...
  public PullRequest1 mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public PullRequest1 number(Integer number) {
  ...
  **/
  ...
  public PullRequest1 requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public PullRequest1 addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  **/
  ...
  public PullRequest1 reviewComments(Integer reviewComments) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PullRequest1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequest1 is not found in the empty JSON string", PullRequest1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequest1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequest1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequest1.openapiRequiredFields) {
      ...
      PullRequest1Base.validateJsonObject(jsonObj.getAsJsonObject("base"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequest1>() {
           @Override
           public void write(JsonWriter out, PullRequest1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequest1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PullRequest1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PullRequest1
  * @throws IOException if the JSON string is invalid with respect to PullRequest1
  */
  public static PullRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequest1.class);
  }

 /**
  * Convert an instance of PullRequest1 to an JSON string
  *
  * @return JSON string
  */
