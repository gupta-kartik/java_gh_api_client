...
public class WebhookIssueCommentCreatedIssueAllOf {
  ...
  public WebhookIssueCommentCreatedIssueAllOf() {
  }

  public WebhookIssueCommentCreatedIssueAllOf activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf assignee(User1 assignee) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssueCommentCreatedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssueCommentCreatedIssueAllOf addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf state(StateEnum state) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssueCommentCreatedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssueCommentCreatedIssueAllOf webhookIssueCommentCreatedIssueAllOf = (WebhookIssueCommentCreatedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssueCommentCreatedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssueCommentCreatedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssueCommentCreatedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssueCommentCreatedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssueCommentCreatedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssueCommentCreatedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssueCommentCreatedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssueCommentCreatedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssueCommentCreatedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssueCommentCreatedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssueCommentCreatedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssueCommentCreatedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssueCommentCreatedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssueCommentCreatedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssueCommentCreatedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssueCommentCreatedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssueCommentCreatedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssueCommentCreatedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssueCommentCreatedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssueCommentCreatedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssueCommentCreatedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssueCommentCreatedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssueCommentCreatedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssueCommentCreatedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssueCommentCreatedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssueCommentCreatedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssueCommentCreatedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssueCommentCreatedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssueCommentCreatedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssueCommentCreatedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssueCommentCreatedIssueAllOf is not found in the empty JSON string", WebhookIssueCommentCreatedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssueCommentCreatedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssueCommentCreatedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssueCommentCreatedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssueCommentCreatedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssueCommentCreatedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssueCommentCreatedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssueCommentCreatedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssueCommentCreatedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssueCommentCreatedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssueCommentCreatedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssueCommentCreatedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssueCommentCreatedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssueCommentCreatedIssueAllOf
  */
  public static WebhookIssueCommentCreatedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssueCommentCreatedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssueCommentCreatedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
