...
public class CodespacesCreateForAuthenticatedUserRequestOneOf {
  ...
  public CodespacesCreateForAuthenticatedUserRequestOneOf repositoryId(Integer repositoryId) {
  ...
  **/
  ...
  public CodespacesCreateForAuthenticatedUserRequestOneOf multiRepoPermissionsOptOut(Boolean multiRepoPermissionsOptOut) {
  ...
  **/
  ...
  public CodespacesCreateForAuthenticatedUserRequestOneOf idleTimeoutMinutes(Integer idleTimeoutMinutes) {
  ...
  **/
  ...
  public CodespacesCreateForAuthenticatedUserRequestOneOf retentionPeriodMinutes(Integer retentionPeriodMinutes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CodespacesCreateForAuthenticatedUserRequestOneOf codespacesCreateForAuthenticatedUserRequestOneOf = (CodespacesCreateForAuthenticatedUserRequestOneOf) o;
    return Objects.equals(this.repositoryId, codespacesCreateForAuthenticatedUserRequestOneOf.repositoryId) &&
        ...
        Objects.equals(this.devcontainerPath, codespacesCreateForAuthenticatedUserRequestOneOf.devcontainerPath) &&
        Objects.equals(this.multiRepoPermissionsOptOut, codespacesCreateForAuthenticatedUserRequestOneOf.multiRepoPermissionsOptOut) &&
        Objects.equals(this.workingDirectory, codespacesCreateForAuthenticatedUserRequestOneOf.workingDirectory) &&
        Objects.equals(this.idleTimeoutMinutes, codespacesCreateForAuthenticatedUserRequestOneOf.idleTimeoutMinutes) &&
        Objects.equals(this.displayName, codespacesCreateForAuthenticatedUserRequestOneOf.displayName) &&
        Objects.equals(this.retentionPeriodMinutes, codespacesCreateForAuthenticatedUserRequestOneOf.retentionPeriodMinutes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryId, ref, location, geo, clientIp, machine, devcontainerPath, multiRepoPermissionsOptOut, workingDirectory, idleTimeoutMinutes, displayName, retentionPeriodMinutes);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CodespacesCreateForAuthenticatedUserRequestOneOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CodespacesCreateForAuthenticatedUserRequestOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodespacesCreateForAuthenticatedUserRequestOneOf is not found in the empty JSON string", CodespacesCreateForAuthenticatedUserRequestOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CodespacesCreateForAuthenticatedUserRequestOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodespacesCreateForAuthenticatedUserRequestOneOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodespacesCreateForAuthenticatedUserRequestOneOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodespacesCreateForAuthenticatedUserRequestOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodespacesCreateForAuthenticatedUserRequestOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodespacesCreateForAuthenticatedUserRequestOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodespacesCreateForAuthenticatedUserRequestOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CodespacesCreateForAuthenticatedUserRequestOneOf>() {
           @Override
           public void write(JsonWriter out, CodespacesCreateForAuthenticatedUserRequestOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodespacesCreateForAuthenticatedUserRequestOneOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CodespacesCreateForAuthenticatedUserRequestOneOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CodespacesCreateForAuthenticatedUserRequestOneOf
  * @throws IOException if the JSON string is invalid with respect to CodespacesCreateForAuthenticatedUserRequestOneOf
  */
  public static CodespacesCreateForAuthenticatedUserRequestOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodespacesCreateForAuthenticatedUserRequestOneOf.class);
  }

 /**
  * Convert an instance of CodespacesCreateForAuthenticatedUserRequestOneOf to an JSON string
  *
  * @return JSON string
  */
