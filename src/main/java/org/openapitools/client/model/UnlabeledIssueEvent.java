...
public class UnlabeledIssueEvent {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UnlabeledIssueEvent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnlabeledIssueEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UnlabeledIssueEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnlabeledIssueEvent` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      LabeledIssueEventLabel.validateJsonObject(jsonObj.getAsJsonObject("label"));
  }
