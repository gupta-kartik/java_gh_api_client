...
import java.net.URI;
import org.openapitools.client.model.App3;
...
public class Deployment {
  ...
  private App3 performedViaGithubApp;
  ...
  **/
  ...
  public Deployment performedViaGithubApp(App3 performedViaGithubApp) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      DeploymentPayload.validateJsonObject(jsonObj.getAsJsonObject("payload"));
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App3.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
