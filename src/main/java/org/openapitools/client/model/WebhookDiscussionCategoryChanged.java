...
import org.openapitools.client.model.WebhookDiscussionCategoryChangedChanges;
...
public class WebhookDiscussionCategoryChanged {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDiscussionCategoryChanged
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDiscussionCategoryChanged.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDiscussionCategoryChanged is not found in the empty JSON string", WebhookDiscussionCategoryChanged.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDiscussionCategoryChanged.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDiscussionCategoryChanged` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDiscussionCategoryChanged.openapiRequiredFields) {
      ...
      WebhookDiscussionCategoryChangedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDiscussionCategoryChanged.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDiscussionCategoryChanged' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDiscussionCategoryChanged> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDiscussionCategoryChanged.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDiscussionCategoryChanged>() {
           @Override
           public void write(JsonWriter out, WebhookDiscussionCategoryChanged value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDiscussionCategoryChanged read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDiscussionCategoryChanged given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDiscussionCategoryChanged
  * @throws IOException if the JSON string is invalid with respect to WebhookDiscussionCategoryChanged
  */
  public static WebhookDiscussionCategoryChanged fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDiscussionCategoryChanged.class);
  }

 /**
  * Convert an instance of WebhookDiscussionCategoryChanged to an JSON string
  *
  * @return JSON string
  */
