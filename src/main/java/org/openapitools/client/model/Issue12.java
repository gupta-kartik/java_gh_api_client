...
import org.openapitools.client.model.App7;
...
public class Issue12 {
  ...
  private App7 performedViaGithubApp;
  ...
  public Issue12 activeLockReason(ActiveLockReasonEnum activeLockReason) {
  ...
  **/
  ...
  public Issue12 assignee(User assignee) {
  ...
  **/
  ...
  public Issue12 assignees(List<User> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue12 addAssigneesItem(User assigneesItem) {
  ...
  **/
  ...
  public Issue12 authorAssociation(AuthorAssociationEnum authorAssociation) {
  ...
  **/
  ...
  public Issue12 body(String body) {
  ...
  **/
  ...
  public Issue12 closedAt(OffsetDateTime closedAt) {
  ...
  **/
  ...
  public Issue12 comments(Integer comments) {
  ...
  **/
  ...
  public Issue12 commentsUrl(URI commentsUrl) {
  ...
  **/
  ...
  public Issue12 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Issue12 draft(Boolean draft) {
  ...
  **/
  ...
  public Issue12 eventsUrl(URI eventsUrl) {
  ...
  **/
  ...
  public Issue12 htmlUrl(URI htmlUrl) {
  ...
  **/
  ...
  public Issue12 labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public Issue12 addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public Issue12 labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public Issue12 locked(Boolean locked) {
  ...
  **/
  ...
  public Issue12 milestone(Milestone1 milestone) {
  ...
  **/
  ...
  public Issue12 nodeId(String nodeId) {
  ...
  **/
  ...
  public Issue12 number(Integer number) {
  ...
  **/
  ...
  public Issue12 performedViaGithubApp(App7 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue12 pullRequest(IssuePullRequest pullRequest) {
  ...
  **/
  ...
  public Issue12 reactions(Reactions reactions) {
  ...
  **/
  ...
  public Issue12 repositoryUrl(URI repositoryUrl) {
  ...
  **/
  ...
  public Issue12 state(StateEnum state) {
  ...
  **/
  ...
  public Issue12 stateReason(String stateReason) {
  ...
  **/
  ...
  public Issue12 timelineUrl(URI timelineUrl) {
  ...
  **/
  ...
  public Issue12 title(String title) {
  ...
  **/
  ...
  public Issue12 updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Issue12 issue12 = (Issue12) o;
    return Objects.equals(this.activeLockReason, issue12.activeLockReason) &&
        Objects.equals(this.assignee, issue12.assignee) &&
        Objects.equals(this.assignees, issue12.assignees) &&
        Objects.equals(this.authorAssociation, issue12.authorAssociation) &&
        Objects.equals(this.body, issue12.body) &&
        Objects.equals(this.closedAt, issue12.closedAt) &&
        Objects.equals(this.comments, issue12.comments) &&
        Objects.equals(this.commentsUrl, issue12.commentsUrl) &&
        Objects.equals(this.createdAt, issue12.createdAt) &&
        Objects.equals(this.draft, issue12.draft) &&
        Objects.equals(this.eventsUrl, issue12.eventsUrl) &&
        Objects.equals(this.htmlUrl, issue12.htmlUrl) &&
        Objects.equals(this.id, issue12.id) &&
        Objects.equals(this.labels, issue12.labels) &&
        Objects.equals(this.labelsUrl, issue12.labelsUrl) &&
        Objects.equals(this.locked, issue12.locked) &&
        Objects.equals(this.milestone, issue12.milestone) &&
        Objects.equals(this.nodeId, issue12.nodeId) &&
        Objects.equals(this.number, issue12.number) &&
        Objects.equals(this.performedViaGithubApp, issue12.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, issue12.pullRequest) &&
        Objects.equals(this.reactions, issue12.reactions) &&
        Objects.equals(this.repositoryUrl, issue12.repositoryUrl) &&
        Objects.equals(this.state, issue12.state) &&
        Objects.equals(this.stateReason, issue12.stateReason) &&
        Objects.equals(this.timelineUrl, issue12.timelineUrl) &&
        Objects.equals(this.title, issue12.title) &&
        Objects.equals(this.updatedAt, issue12.updatedAt) &&
        Objects.equals(this.url, issue12.url) &&
        Objects.equals(this.user, issue12.user);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue12 is not found in the empty JSON string", Issue12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue12` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue12.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App7.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue12.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue12>() {
           @Override
           public void write(JsonWriter out, Issue12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue12 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue12
  * @throws IOException if the JSON string is invalid with respect to Issue12
  */
  public static Issue12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue12.class);
  }

 /**
  * Convert an instance of Issue12 to an JSON string
  *
  * @return JSON string
  */
