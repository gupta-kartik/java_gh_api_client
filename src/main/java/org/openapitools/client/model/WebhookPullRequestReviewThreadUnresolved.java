...
import org.openapitools.client.model.SimplePullRequest4;
import org.openapitools.client.model.SimpleUser;
import org.openapitools.client.model.WebhookPullRequestReviewThreadUnresolvedThread;
...
public class WebhookPullRequestReviewThreadUnresolved {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestReviewThreadUnresolved
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestReviewThreadUnresolved.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestReviewThreadUnresolved is not found in the empty JSON string", WebhookPullRequestReviewThreadUnresolved.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestReviewThreadUnresolved.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestReviewThreadUnresolved` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestReviewThreadUnresolved.openapiRequiredFields) {
      ...
      SimplePullRequest4.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
      ...
      WebhookPullRequestReviewThreadUnresolvedThread.validateJsonObject(jsonObj.getAsJsonObject("thread"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestReviewThreadUnresolved.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestReviewThreadUnresolved' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestReviewThreadUnresolved> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestReviewThreadUnresolved.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestReviewThreadUnresolved>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestReviewThreadUnresolved value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestReviewThreadUnresolved read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestReviewThreadUnresolved given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestReviewThreadUnresolved
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestReviewThreadUnresolved
  */
  public static WebhookPullRequestReviewThreadUnresolved fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestReviewThreadUnresolved.class);
  }

 /**
  * Convert an instance of WebhookPullRequestReviewThreadUnresolved to an JSON string
  *
  * @return JSON string
  */
