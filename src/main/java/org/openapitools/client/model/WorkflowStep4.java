...
public class WorkflowStep4 {
  ...
  **/
  ...
  public WorkflowStep4 number(Integer number) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowStep4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowStep4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowStep4 is not found in the empty JSON string", WorkflowStep4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowStep4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowStep4` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowStep4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowStep4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowStep4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowStep4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowStep4.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowStep4>() {
           @Override
           public void write(JsonWriter out, WorkflowStep4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowStep4 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowStep4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowStep4
  * @throws IOException if the JSON string is invalid with respect to WorkflowStep4
  */
  public static WorkflowStep4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowStep4.class);
  }

 /**
  * Convert an instance of WorkflowStep4 to an JSON string
  *
  * @return JSON string
  */
