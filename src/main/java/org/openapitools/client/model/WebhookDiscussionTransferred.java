...
import org.openapitools.client.model.WebhookDiscussionTransferredChanges;
...
public class WebhookDiscussionTransferred {
  ...
  **/
  ...
  public WebhookDiscussionTransferred enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookDiscussionTransferred organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookDiscussionTransferred repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDiscussionTransferred
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDiscussionTransferred.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDiscussionTransferred is not found in the empty JSON string", WebhookDiscussionTransferred.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDiscussionTransferred.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDiscussionTransferred` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDiscussionTransferred.openapiRequiredFields) {
      ...
      WebhookDiscussionTransferredChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDiscussionTransferred.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDiscussionTransferred' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDiscussionTransferred> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDiscussionTransferred.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDiscussionTransferred>() {
           @Override
           public void write(JsonWriter out, WebhookDiscussionTransferred value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDiscussionTransferred read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDiscussionTransferred given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDiscussionTransferred
  * @throws IOException if the JSON string is invalid with respect to WebhookDiscussionTransferred
  */
  public static WebhookDiscussionTransferred fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDiscussionTransferred.class);
  }

 /**
  * Convert an instance of WebhookDiscussionTransferred to an JSON string
  *
  * @return JSON string
  */
