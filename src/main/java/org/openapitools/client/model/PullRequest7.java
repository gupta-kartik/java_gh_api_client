...
import org.openapitools.client.model.PullRequest7Base;
import org.openapitools.client.model.PullRequest7RequestedReviewersInner;
...
public class PullRequest7 {
  ...
  private List<PullRequest7RequestedReviewersInner> requestedReviewers = new ArrayList<>();

  public static final String SERIALIZED_NAME_REQUESTED_TEAMS = "requested_teams";
  @SerializedName(SERIALIZED_NAME_REQUESTED_TEAMS)
  private List<Team1> requestedTeams = new ArrayList<>();
  ...
  public PullRequest7 links(PullRequestLinks links) {
  ...
  **/
  ...
  public PullRequest7 additions(Integer additions) {
  ...
  **/
  ...
  public PullRequest7 assignees(List<User> assignees) {
  ...
  **/
  ...
  public PullRequest7 base(PullRequest7Base base) {
  ...
  **/
  ...
  public PullRequest7Base getBase() {
    return base;
  }


  public void setBase(PullRequest7Base base) {
    this.base = base;
  }
  ...
  **/
  ...
  public PullRequest7 changedFiles(Integer changedFiles) {
  ...
  **/
  ...
  public PullRequest7 comments(Integer comments) {
  ...
  **/
  ...
  public PullRequest7 commits(Integer commits) {
  ...
  **/
  ...
  public PullRequest7 deletions(Integer deletions) {
  ...
  **/
  ...
  public PullRequest7 id(Integer id) {
  ...
  **/
  ...
  public PullRequest7 labels(List<Label> labels) {
  ...
  **/
  ...
  public PullRequest7 mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public PullRequest7 number(Integer number) {
  ...
  **/
  ...
  public PullRequest7 requestedReviewers(List<PullRequest7RequestedReviewersInner> requestedReviewers) {
    
    this.requestedReviewers = requestedReviewers;
    return this;
  }

  public PullRequest7 addRequestedReviewersItem(PullRequest7RequestedReviewersInner requestedReviewersItem) {
  ...
  **/
  ...
  public List<PullRequest7RequestedReviewersInner> getRequestedReviewers() {
    return requestedReviewers;
  }


  public void setRequestedReviewers(List<PullRequest7RequestedReviewersInner> requestedReviewers) {
    this.requestedReviewers = requestedReviewers;
  }


  public PullRequest7 requestedTeams(List<Team1> requestedTeams) {
  ...
  **/
  ...
  public List<Team1> getRequestedTeams() {
    return requestedTeams;
  }


  public void setRequestedTeams(List<Team1> requestedTeams) {
    this.requestedTeams = requestedTeams;
  }
  ...
  **/
  ...
  public PullRequest7 reviewComments(Integer reviewComments) {
  ...
  **/
  ...
  public PullRequest7 user(User user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, pullRequest7.links) &&
        ...
        Objects.equals(this.mergeCommitSha, pullRequest7.mergeCommitSha) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to PullRequest7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequest7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequest7 is not found in the empty JSON string", PullRequest7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequest7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequest7` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequest7.openapiRequiredFields) {
      ...
      PullRequest7Base.validateJsonObject(jsonObj.getAsJsonObject("base"));
      ...
      PullRequestBase.validateJsonObject(jsonObj.getAsJsonObject("head"));
      ...
      for (int i = 0; i < jsonArrayrequestedReviewers.size(); i++) {
        PullRequest7RequestedReviewersInner.validateJsonObject(jsonArrayrequestedReviewers.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayrequestedTeams.size(); i++) {
        Team1.validateJsonObject(jsonArrayrequestedTeams.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequest7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequest7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequest7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequest7.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequest7>() {
           @Override
           public void write(JsonWriter out, PullRequest7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequest7 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PullRequest7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PullRequest7
  * @throws IOException if the JSON string is invalid with respect to PullRequest7
  */
  public static PullRequest7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequest7.class);
  }

 /**
  * Convert an instance of PullRequest7 to an JSON string
  *
  * @return JSON string
  */
