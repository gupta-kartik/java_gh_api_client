...
public class ReposUpdateRequest {
  ...
  private ReposUpdateRequestSecurityAndAnalysis securityAndAnalysis;
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposUpdateRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("security_and_analysis") != null && !jsonObj.get("security_and_analysis").isJsonNull()) {
        ReposUpdateRequestSecurityAndAnalysis.validateJsonObject(jsonObj.getAsJsonObject("security_and_analysis"));
      }
