...
import org.openapitools.client.model.FullRepositoryPermissions;
...
public class FullRepository {
  ...
  **/
  ...
  public FullRepository useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FullRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FullRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FullRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FullRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("permissions") != null && !jsonObj.get("permissions").isJsonNull()) {
        FullRepositoryPermissions.validateJsonObject(jsonObj.getAsJsonObject("permissions"));
      }
      ...
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        NullableSimpleUser.validateJsonObject(jsonObj.getAsJsonObject("organization"));
      }
      // validate the optional field `parent`
      if (jsonObj.get("parent") != null && !jsonObj.get("parent").isJsonNull()) {
        Repository.validateJsonObject(jsonObj.getAsJsonObject("parent"));
      }
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        Repository.validateJsonObject(jsonObj.getAsJsonObject("source"));
      }
      ...
      if (jsonObj.get("code_of_conduct") != null && !jsonObj.get("code_of_conduct").isJsonNull()) {
        CodeOfConductSimple.validateJsonObject(jsonObj.getAsJsonObject("code_of_conduct"));
      }
