...
public class Repository2 {
  ...
  **/
  ...
  public Repository2 forks(Integer forks) {
  ...
  **/
  ...
  public Repository2 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository2 id(Integer id) {
  ...
  **/
  ...
  public Repository2 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository2 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository2 size(Integer size) {
  ...
  **/
  ...
  public Repository2 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository2 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository2 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository2 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository2 is not found in the empty JSON string", Repository2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository2.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository2>() {
           @Override
           public void write(JsonWriter out, Repository2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository2
  * @throws IOException if the JSON string is invalid with respect to Repository2
  */
  public static Repository2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository2.class);
  }

 /**
  * Convert an instance of Repository2 to an JSON string
  *
  * @return JSON string
  */
