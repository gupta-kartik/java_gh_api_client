...
import org.openapitools.client.model.Issue7;
...
public class WebhookIssuesLabeled {
  ...
  **/
  ...
  public WebhookIssuesLabeled issue(Issue7 issue) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesLabeled
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesLabeled.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesLabeled is not found in the empty JSON string", WebhookIssuesLabeled.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesLabeled.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesLabeled` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesLabeled.openapiRequiredFields) {
      ...
      Issue7.validateJsonObject(jsonObj.getAsJsonObject("issue"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesLabeled.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesLabeled' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesLabeled> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesLabeled.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesLabeled>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesLabeled value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesLabeled read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesLabeled given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesLabeled
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesLabeled
  */
  public static WebhookIssuesLabeled fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesLabeled.class);
  }

 /**
  * Convert an instance of WebhookIssuesLabeled to an JSON string
  *
  * @return JSON string
  */
