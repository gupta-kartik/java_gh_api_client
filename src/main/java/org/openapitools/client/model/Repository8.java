...
public class Repository8 {
  ...
  **/
  ...
  public Repository8 forks(Integer forks) {
  ...
  **/
  ...
  public Repository8 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository8 id(Integer id) {
  ...
  **/
  ...
  public Repository8 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository8 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository8 size(Integer size) {
  ...
  **/
  ...
  public Repository8 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository8 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository8 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository8 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository8 is not found in the empty JSON string", Repository8.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository8.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository8` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository8.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository8.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository8>() {
           @Override
           public void write(JsonWriter out, Repository8 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository8 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository8
  * @throws IOException if the JSON string is invalid with respect to Repository8
  */
  public static Repository8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository8.class);
  }

 /**
  * Convert an instance of Repository8 to an JSON string
  *
  * @return JSON string
  */
