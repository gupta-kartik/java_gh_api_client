...
public class Repository7 {
  ...
  **/
  ...
  public Repository7 forks(Integer forks) {
  ...
  **/
  ...
  public Repository7 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository7 id(Integer id) {
  ...
  **/
  ...
  public Repository7 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository7 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository7 size(Integer size) {
  ...
  **/
  ...
  public Repository7 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository7 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository7 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository7 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository7 is not found in the empty JSON string", Repository7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository7` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository7.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository7>() {
           @Override
           public void write(JsonWriter out, Repository7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository7 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository7
  * @throws IOException if the JSON string is invalid with respect to Repository7
  */
  public static Repository7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository7.class);
  }

 /**
  * Convert an instance of Repository7 to an JSON string
  *
  * @return JSON string
  */
