...
public class WebhookDependabotAlertAutoReopened {
  ...
  **/
  ...
  public WebhookDependabotAlertAutoReopened organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookDependabotAlertAutoReopened enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookDependabotAlertAutoReopened repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDependabotAlertAutoReopened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDependabotAlertAutoReopened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDependabotAlertAutoReopened is not found in the empty JSON string", WebhookDependabotAlertAutoReopened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDependabotAlertAutoReopened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDependabotAlertAutoReopened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDependabotAlertAutoReopened.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDependabotAlertAutoReopened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDependabotAlertAutoReopened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDependabotAlertAutoReopened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDependabotAlertAutoReopened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDependabotAlertAutoReopened>() {
           @Override
           public void write(JsonWriter out, WebhookDependabotAlertAutoReopened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDependabotAlertAutoReopened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDependabotAlertAutoReopened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDependabotAlertAutoReopened
  * @throws IOException if the JSON string is invalid with respect to WebhookDependabotAlertAutoReopened
  */
  public static WebhookDependabotAlertAutoReopened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDependabotAlertAutoReopened.class);
  }

 /**
  * Convert an instance of WebhookDependabotAlertAutoReopened to an JSON string
  *
  * @return JSON string
  */
