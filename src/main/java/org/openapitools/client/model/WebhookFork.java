...
import org.openapitools.client.model.WebhookForkForkee;
...
public class WebhookFork {
  ...
  public static final String SERIALIZED_NAME_FORKEE = "forkee";
  @SerializedName(SERIALIZED_NAME_FORKEE)
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("forkee");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookFork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookFork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookFork is not found in the empty JSON string", WebhookFork.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookFork.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookFork` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookFork.openapiRequiredFields) {
      ...
      // validate the required field `forkee`
      WebhookForkForkee.validateJsonObject(jsonObj.getAsJsonObject("forkee"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookFork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookFork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookFork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookFork.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookFork>() {
           @Override
           public void write(JsonWriter out, WebhookFork value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookFork read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookFork given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookFork
  * @throws IOException if the JSON string is invalid with respect to WebhookFork
  */
  public static WebhookFork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookFork.class);
  }

 /**
  * Convert an instance of WebhookFork to an JSON string
  *
  * @return JSON string
  */
