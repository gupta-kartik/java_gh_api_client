...
public class DeploymentWorkflowRunHeadRepository {
  ...
  public DeploymentWorkflowRunHeadRepository() {
  }
  ...
  **/
  ...
  public DeploymentWorkflowRunHeadRepository id(Integer id) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeploymentWorkflowRunHeadRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeploymentWorkflowRunHeadRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeploymentWorkflowRunHeadRepository is not found in the empty JSON string", DeploymentWorkflowRunHeadRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeploymentWorkflowRunHeadRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeploymentWorkflowRunHeadRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentWorkflowRunHeadRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentWorkflowRunHeadRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentWorkflowRunHeadRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentWorkflowRunHeadRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentWorkflowRunHeadRepository>() {
           @Override
           public void write(JsonWriter out, DeploymentWorkflowRunHeadRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeploymentWorkflowRunHeadRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DeploymentWorkflowRunHeadRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeploymentWorkflowRunHeadRepository
  * @throws IOException if the JSON string is invalid with respect to DeploymentWorkflowRunHeadRepository
  */
  public static DeploymentWorkflowRunHeadRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeploymentWorkflowRunHeadRepository.class);
  }

 /**
  * Convert an instance of DeploymentWorkflowRunHeadRepository to an JSON string
  *
  * @return JSON string
  */
