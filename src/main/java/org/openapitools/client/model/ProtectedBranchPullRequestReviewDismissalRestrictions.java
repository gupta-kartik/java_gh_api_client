...
public class ProtectedBranchPullRequestReviewDismissalRestrictions {
  ...
  **/
  ...
  public ProtectedBranchPullRequestReviewDismissalRestrictions apps(List<Integration> apps) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProtectedBranchPullRequestReviewDismissalRestrictions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProtectedBranchPullRequestReviewDismissalRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProtectedBranchPullRequestReviewDismissalRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectedBranchPullRequestReviewDismissalRestrictions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
