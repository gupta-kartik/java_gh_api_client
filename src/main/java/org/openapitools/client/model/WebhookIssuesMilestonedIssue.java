...
public class WebhookIssuesMilestonedIssue {
  ...
  public WebhookIssuesMilestonedIssue activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesMilestonedIssue addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue body(String body) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue draft(Boolean draft) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesMilestonedIssue addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue milestone(Milestone2 milestone) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue pullRequest(IssuePullRequest pullRequest) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue state(String state) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue stateReason(String stateReason) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue title(String title) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue url(String url) {
  ...
  **/
  ...
  public WebhookIssuesMilestonedIssue user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesMilestonedIssue webhookIssuesMilestonedIssue = (WebhookIssuesMilestonedIssue) o;
    return Objects.equals(this.activeLockReason, webhookIssuesMilestonedIssue.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesMilestonedIssue.assignee) &&
        Objects.equals(this.assignees, webhookIssuesMilestonedIssue.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesMilestonedIssue.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesMilestonedIssue.body) &&
        Objects.equals(this.closedAt, webhookIssuesMilestonedIssue.closedAt) &&
        Objects.equals(this.comments, webhookIssuesMilestonedIssue.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesMilestonedIssue.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesMilestonedIssue.createdAt) &&
        Objects.equals(this.draft, webhookIssuesMilestonedIssue.draft) &&
        Objects.equals(this.eventsUrl, webhookIssuesMilestonedIssue.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesMilestonedIssue.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesMilestonedIssue.id) &&
        Objects.equals(this.labels, webhookIssuesMilestonedIssue.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesMilestonedIssue.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesMilestonedIssue.locked) &&
        Objects.equals(this.milestone, webhookIssuesMilestonedIssue.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesMilestonedIssue.nodeId) &&
        Objects.equals(this.number, webhookIssuesMilestonedIssue.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesMilestonedIssue.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, webhookIssuesMilestonedIssue.pullRequest) &&
        Objects.equals(this.reactions, webhookIssuesMilestonedIssue.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesMilestonedIssue.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesMilestonedIssue.state) &&
        Objects.equals(this.stateReason, webhookIssuesMilestonedIssue.stateReason) &&
        Objects.equals(this.timelineUrl, webhookIssuesMilestonedIssue.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesMilestonedIssue.title) &&
        Objects.equals(this.updatedAt, webhookIssuesMilestonedIssue.updatedAt) &&
        Objects.equals(this.url, webhookIssuesMilestonedIssue.url) &&
        Objects.equals(this.user, webhookIssuesMilestonedIssue.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesMilestonedIssue {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesMilestonedIssue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesMilestonedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesMilestonedIssue is not found in the empty JSON string", WebhookIssuesMilestonedIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesMilestonedIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesMilestonedIssue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesMilestonedIssue.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesMilestonedIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesMilestonedIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesMilestonedIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesMilestonedIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesMilestonedIssue>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesMilestonedIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesMilestonedIssue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesMilestonedIssue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesMilestonedIssue
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesMilestonedIssue
  */
  public static WebhookIssuesMilestonedIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesMilestonedIssue.class);
  }

 /**
  * Convert an instance of WebhookIssuesMilestonedIssue to an JSON string
  *
  * @return JSON string
  */
