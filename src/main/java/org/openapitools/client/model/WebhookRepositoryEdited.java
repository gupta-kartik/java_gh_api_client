...
import org.openapitools.client.model.WebhookRepositoryEditedChanges;
...
public class WebhookRepositoryEdited {
  ...
  **/
  ...
  public WebhookRepositoryEdited enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookRepositoryEdited organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookRepositoryEdited repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookRepositoryEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookRepositoryEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookRepositoryEdited is not found in the empty JSON string", WebhookRepositoryEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookRepositoryEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookRepositoryEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookRepositoryEdited.openapiRequiredFields) {
      ...
      WebhookRepositoryEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookRepositoryEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookRepositoryEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookRepositoryEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookRepositoryEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookRepositoryEdited>() {
           @Override
           public void write(JsonWriter out, WebhookRepositoryEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookRepositoryEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookRepositoryEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookRepositoryEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookRepositoryEdited
  */
  public static WebhookRepositoryEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookRepositoryEdited.class);
  }

 /**
  * Convert an instance of WebhookRepositoryEdited to an JSON string
  *
  * @return JSON string
  */
