...
public class App3 {
  ...
  * @throws IOException if the JSON Object is invalid with respect to App3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!App3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in App3 is not found in the empty JSON string", App3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!App3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `App3` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : App3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!App3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'App3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<App3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(App3.class));

       return (TypeAdapter<T>) new TypeAdapter<App3>() {
           @Override
           public void write(JsonWriter out, App3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public App3 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of App3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of App3
  * @throws IOException if the JSON string is invalid with respect to App3
  */
  public static App3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, App3.class);
  }

 /**
  * Convert an instance of App3 to an JSON string
  *
  * @return JSON string
  */
