...
import org.openapitools.client.model.WebhookCodeScanningAlertAppearedInBranchAlert;
...
public class WebhookCodeScanningAlertAppearedInBranch {
  ...
  **/
  ...
  public WebhookCodeScanningAlertAppearedInBranch enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookCodeScanningAlertAppearedInBranch organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookCodeScanningAlertAppearedInBranch repository(Repository repository) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookCodeScanningAlertAppearedInBranch webhookCodeScanningAlertAppearedInBranch = (WebhookCodeScanningAlertAppearedInBranch) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertAppearedInBranch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertAppearedInBranch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertAppearedInBranch is not found in the empty JSON string", WebhookCodeScanningAlertAppearedInBranch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertAppearedInBranch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertAppearedInBranch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertAppearedInBranch.openapiRequiredFields) {
      ...
      WebhookCodeScanningAlertAppearedInBranchAlert.validateJsonObject(jsonObj.getAsJsonObject("alert"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertAppearedInBranch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertAppearedInBranch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertAppearedInBranch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertAppearedInBranch.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertAppearedInBranch>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertAppearedInBranch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertAppearedInBranch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertAppearedInBranch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertAppearedInBranch
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertAppearedInBranch
  */
  public static WebhookCodeScanningAlertAppearedInBranch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertAppearedInBranch.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertAppearedInBranch to an JSON string
  *
  * @return JSON string
  */
