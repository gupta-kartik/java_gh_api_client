...
public class PullRequest {
  ...
  **/
  ...
  public PullRequest assignee(User1 assignee) {
  ...
  **/
  ...
  public PullRequest assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public PullRequest addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public PullRequest requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public PullRequest addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  **/
  ...
  public PullRequest user(User1 user) {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
