...
public class WebhookProjectCardMovedProjectCardAllOfCreator {
  ...
  public WebhookProjectCardMovedProjectCardAllOfCreator() {
  }
  ...
  **/
  ...
  public WebhookProjectCardMovedProjectCardAllOfCreator id(Integer id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookProjectCardMovedProjectCardAllOfCreator webhookProjectCardMovedProjectCardAllOfCreator = (WebhookProjectCardMovedProjectCardAllOfCreator) o;
    return Objects.equals(this.avatarUrl, webhookProjectCardMovedProjectCardAllOfCreator.avatarUrl) &&
        ...
        Objects.equals(this.organizationsUrl, webhookProjectCardMovedProjectCardAllOfCreator.organizationsUrl) &&
        Objects.equals(this.receivedEventsUrl, webhookProjectCardMovedProjectCardAllOfCreator.receivedEventsUrl) &&
        ...
        Objects.equals(this.subscriptionsUrl, webhookProjectCardMovedProjectCardAllOfCreator.subscriptionsUrl) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectCardMovedProjectCardAllOfCreator
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectCardMovedProjectCardAllOfCreator.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectCardMovedProjectCardAllOfCreator is not found in the empty JSON string", WebhookProjectCardMovedProjectCardAllOfCreator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectCardMovedProjectCardAllOfCreator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectCardMovedProjectCardAllOfCreator` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectCardMovedProjectCardAllOfCreator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectCardMovedProjectCardAllOfCreator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectCardMovedProjectCardAllOfCreator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectCardMovedProjectCardAllOfCreator.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectCardMovedProjectCardAllOfCreator>() {
           @Override
           public void write(JsonWriter out, WebhookProjectCardMovedProjectCardAllOfCreator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectCardMovedProjectCardAllOfCreator read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectCardMovedProjectCardAllOfCreator given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectCardMovedProjectCardAllOfCreator
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectCardMovedProjectCardAllOfCreator
  */
  public static WebhookProjectCardMovedProjectCardAllOfCreator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectCardMovedProjectCardAllOfCreator.class);
  }

 /**
  * Convert an instance of WebhookProjectCardMovedProjectCardAllOfCreator to an JSON string
  *
  * @return JSON string
  */
