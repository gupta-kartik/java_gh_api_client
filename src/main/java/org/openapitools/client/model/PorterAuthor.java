...
public class PorterAuthor {
  ...
  public PorterAuthor id(Integer id) {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("remote_name");
    openapiRequiredFields.add("email");
    openapiRequiredFields.add("name");
    openapiRequiredFields.add("url");
    openapiRequiredFields.add("import_url");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PorterAuthor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PorterAuthor.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PorterAuthor is not found in the empty JSON string", PorterAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PorterAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PorterAuthor` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PorterAuthor.openapiRequiredFields) {
      ...
      if (!jsonObj.get("remote_name").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("import_url").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PorterAuthor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PorterAuthor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PorterAuthor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PorterAuthor.class));

       return (TypeAdapter<T>) new TypeAdapter<PorterAuthor>() {
           @Override
           public void write(JsonWriter out, PorterAuthor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PorterAuthor read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PorterAuthor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PorterAuthor
  * @throws IOException if the JSON string is invalid with respect to PorterAuthor
  */
  public static PorterAuthor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PorterAuthor.class);
  }

 /**
  * Convert an instance of PorterAuthor to an JSON string
  *
  * @return JSON string
  */
