...
import org.openapitools.client.model.WebhookMemberAddedChanges;
...
public class WebhookMemberAdded {
  ...
  **/
  ...
  public WebhookMemberAdded enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookMemberAdded member(User member) {
  ...
  **/
  ...
  public WebhookMemberAdded organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookMemberAdded repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMemberAdded
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMemberAdded.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMemberAdded is not found in the empty JSON string", WebhookMemberAdded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMemberAdded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMemberAdded` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMemberAdded.openapiRequiredFields) {
      ...
      if (jsonObj.get("changes") != null && !jsonObj.get("changes").isJsonNull()) {
        WebhookMemberAddedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
      }
      ...
      User.validateJsonObject(jsonObj.getAsJsonObject("member"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMemberAdded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMemberAdded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMemberAdded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMemberAdded.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMemberAdded>() {
           @Override
           public void write(JsonWriter out, WebhookMemberAdded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMemberAdded read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMemberAdded given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMemberAdded
  * @throws IOException if the JSON string is invalid with respect to WebhookMemberAdded
  */
  public static WebhookMemberAdded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMemberAdded.class);
  }

 /**
  * Convert an instance of WebhookMemberAdded to an JSON string
  *
  * @return JSON string
  */
