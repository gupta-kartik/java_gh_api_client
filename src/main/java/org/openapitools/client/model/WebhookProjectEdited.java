...
import org.openapitools.client.model.WebhookProjectEditedChanges;
...
public class WebhookProjectEdited {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectEdited is not found in the empty JSON string", WebhookProjectEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookProjectEdited.openapiRequiredFields) {
      ...
      if (jsonObj.get("changes") != null && !jsonObj.get("changes").isJsonNull()) {
        WebhookProjectEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectEdited>() {
           @Override
           public void write(JsonWriter out, WebhookProjectEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectEdited
  */
  public static WebhookProjectEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectEdited.class);
  }

 /**
  * Convert an instance of WebhookProjectEdited to an JSON string
  *
  * @return JSON string
  */
