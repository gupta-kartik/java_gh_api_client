...
public class WebhookSecretScanningAlertResolvedAlert {
  ...
  public WebhookSecretScanningAlertResolvedAlert() {
  }
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert locationsUrl(URI locationsUrl) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert pushProtectionBypassed(Boolean pushProtectionBypassed) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert pushProtectionBypassedAt(OffsetDateTime pushProtectionBypassedAt) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert pushProtectionBypassedBy(NullableSimpleUser pushProtectionBypassedBy) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert resolution(ResolutionEnum resolution) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert resolvedAt(OffsetDateTime resolvedAt) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert resolvedBy(NullableSimpleUser resolvedBy) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert resolutionComment(String resolutionComment) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert secret(String secret) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert secretType(String secretType) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertResolvedAlert secretTypeDisplayName(String secretTypeDisplayName) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSecretScanningAlertResolvedAlert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSecretScanningAlertResolvedAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSecretScanningAlertResolvedAlert is not found in the empty JSON string", WebhookSecretScanningAlertResolvedAlert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookSecretScanningAlertResolvedAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSecretScanningAlertResolvedAlert` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSecretScanningAlertResolvedAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSecretScanningAlertResolvedAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSecretScanningAlertResolvedAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSecretScanningAlertResolvedAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSecretScanningAlertResolvedAlert>() {
           @Override
           public void write(JsonWriter out, WebhookSecretScanningAlertResolvedAlert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSecretScanningAlertResolvedAlert read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookSecretScanningAlertResolvedAlert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookSecretScanningAlertResolvedAlert
  * @throws IOException if the JSON string is invalid with respect to WebhookSecretScanningAlertResolvedAlert
  */
  public static WebhookSecretScanningAlertResolvedAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSecretScanningAlertResolvedAlert.class);
  }

 /**
  * Convert an instance of WebhookSecretScanningAlertResolvedAlert to an JSON string
  *
  * @return JSON string
  */
