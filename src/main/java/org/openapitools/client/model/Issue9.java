...
import org.openapitools.client.model.App15;
...
public class Issue9 {
  ...
  private App15 performedViaGithubApp;
  ...
  **/
  ...
  public Issue9 assignees(List<User> assignees) {
  ...
  **/
  ...
  public Issue9 comments(Integer comments) {
  ...
  **/
  ...
  public Issue9 labels(List<Label> labels) {
  ...
  **/
  ...
  public Issue9 milestone(Milestone milestone) {
  ...
  **/
  ...
  public Issue9 number(Integer number) {
  ...
  **/
  ...
  public Issue9 performedViaGithubApp(App15 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue9 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue9 is not found in the empty JSON string", Issue9.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue9.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue9` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue9.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App15.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue9.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue9>() {
           @Override
           public void write(JsonWriter out, Issue9 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue9 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue9
  * @throws IOException if the JSON string is invalid with respect to Issue9
  */
  public static Issue9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue9.class);
  }

 /**
  * Convert an instance of Issue9 to an JSON string
  *
  * @return JSON string
  */
