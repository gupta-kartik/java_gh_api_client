...
public class WebhookTeamAddedToRepository {
  ...
  **/
  ...
  public WebhookTeamAddedToRepository team(Team3 team) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookTeamAddedToRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookTeamAddedToRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookTeamAddedToRepository is not found in the empty JSON string", WebhookTeamAddedToRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookTeamAddedToRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookTeamAddedToRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookTeamAddedToRepository.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookTeamAddedToRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookTeamAddedToRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookTeamAddedToRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookTeamAddedToRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookTeamAddedToRepository>() {
           @Override
           public void write(JsonWriter out, WebhookTeamAddedToRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookTeamAddedToRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookTeamAddedToRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookTeamAddedToRepository
  * @throws IOException if the JSON string is invalid with respect to WebhookTeamAddedToRepository
  */
  public static WebhookTeamAddedToRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookTeamAddedToRepository.class);
  }

 /**
  * Convert an instance of WebhookTeamAddedToRepository to an JSON string
  *
  * @return JSON string
  */
