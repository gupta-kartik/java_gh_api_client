...
public class WebhookIssuesReopenedIssueAllOf {
  ...
  public WebhookIssuesReopenedIssueAllOf() {
  }

  public WebhookIssuesReopenedIssueAllOf activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesReopenedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesReopenedIssueAllOf addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf state(StateEnum state) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesReopenedIssueAllOf webhookIssuesReopenedIssueAllOf = (WebhookIssuesReopenedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssuesReopenedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesReopenedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssuesReopenedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesReopenedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesReopenedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssuesReopenedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssuesReopenedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesReopenedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesReopenedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssuesReopenedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesReopenedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesReopenedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssuesReopenedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesReopenedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesReopenedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssuesReopenedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesReopenedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssuesReopenedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesReopenedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssuesReopenedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesReopenedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesReopenedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssuesReopenedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesReopenedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssuesReopenedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssuesReopenedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssuesReopenedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesReopenedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesReopenedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesReopenedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesReopenedIssueAllOf is not found in the empty JSON string", WebhookIssuesReopenedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesReopenedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesReopenedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesReopenedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesReopenedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesReopenedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesReopenedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesReopenedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesReopenedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesReopenedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesReopenedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesReopenedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesReopenedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesReopenedIssueAllOf
  */
  public static WebhookIssuesReopenedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesReopenedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssuesReopenedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
