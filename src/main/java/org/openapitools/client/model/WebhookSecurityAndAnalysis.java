...
public class WebhookSecurityAndAnalysis {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSecurityAndAnalysis
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSecurityAndAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSecurityAndAnalysis is not found in the empty JSON string", WebhookSecurityAndAnalysis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookSecurityAndAnalysis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSecurityAndAnalysis` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookSecurityAndAnalysis.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `changes`
      WebhookSecurityAndAnalysisChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSecurityAndAnalysis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSecurityAndAnalysis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSecurityAndAnalysis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSecurityAndAnalysis.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSecurityAndAnalysis>() {
           @Override
           public void write(JsonWriter out, WebhookSecurityAndAnalysis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSecurityAndAnalysis read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookSecurityAndAnalysis given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookSecurityAndAnalysis
  * @throws IOException if the JSON string is invalid with respect to WebhookSecurityAndAnalysis
  */
  public static WebhookSecurityAndAnalysis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSecurityAndAnalysis.class);
  }

 /**
  * Convert an instance of WebhookSecurityAndAnalysis to an JSON string
  *
  * @return JSON string
  */
