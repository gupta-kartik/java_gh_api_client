...
import org.openapitools.client.model.WorkflowStep;
...
public class WorkflowJob {
  ...
  public WorkflowJob checkRunUrl(URI checkRunUrl) {
  ...
  **/
  ...
  public WorkflowJob completedAt(String completedAt) {
  ...
  **/
  ...
  public WorkflowJob conclusion(ConclusionEnum conclusion) {
  ...
  **/
  ...
  public WorkflowJob createdAt(String createdAt) {
  ...
  **/
  ...
  public WorkflowJob headSha(String headSha) {
  ...
  **/
  ...
  public WorkflowJob htmlUrl(URI htmlUrl) {
  ...
  **/
  ...
  public WorkflowJob id(Integer id) {
  ...
  **/
  ...
  public WorkflowJob labels(List<String> labels) {
    
    this.labels = labels;
    return this;
  }

  public WorkflowJob addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WorkflowJob nodeId(String nodeId) {
  ...
  **/
  ...
  public WorkflowJob runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public WorkflowJob runId(BigDecimal runId) {
  ...
  **/
  ...
  public WorkflowJob runUrl(URI runUrl) {
  ...
  **/
  ...
  public WorkflowJob runnerGroupId(Integer runnerGroupId) {
  ...
  **/
  ...
  public WorkflowJob runnerGroupName(String runnerGroupName) {
  ...
  **/
  ...
  public WorkflowJob runnerId(Integer runnerId) {
  ...
  **/
  ...
  public WorkflowJob runnerName(String runnerName) {
  ...
  **/
  ...
  public WorkflowJob startedAt(String startedAt) {
  ...
  **/
  ...
  public WorkflowJob status(StatusEnum status) {
  ...
  **/
  ...
  public WorkflowJob headBranch(String headBranch) {
  ...
  **/
  ...
  public WorkflowJob workflowName(String workflowName) {
  ...
  **/
  ...
  public WorkflowJob steps(List<WorkflowStep> steps) {
    
    this.steps = steps;
    return this;
  }

  public WorkflowJob addStepsItem(WorkflowStep stepsItem) {
    if (this.steps == null) {
  ...
  **/
  ...
  public WorkflowJob url(URI url) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkRunUrl, workflowJob.checkRunUrl) &&
        Objects.equals(this.completedAt, workflowJob.completedAt) &&
        Objects.equals(this.conclusion, workflowJob.conclusion) &&
        Objects.equals(this.createdAt, workflowJob.createdAt) &&
        Objects.equals(this.headSha, workflowJob.headSha) &&
        Objects.equals(this.htmlUrl, workflowJob.htmlUrl) &&
        Objects.equals(this.id, workflowJob.id) &&
        Objects.equals(this.labels, workflowJob.labels) &&
        Objects.equals(this.name, workflowJob.name) &&
        Objects.equals(this.nodeId, workflowJob.nodeId) &&
        Objects.equals(this.runAttempt, workflowJob.runAttempt) &&
        Objects.equals(this.runId, workflowJob.runId) &&
        Objects.equals(this.runUrl, workflowJob.runUrl) &&
        Objects.equals(this.runnerGroupId, workflowJob.runnerGroupId) &&
        Objects.equals(this.runnerGroupName, workflowJob.runnerGroupName) &&
        Objects.equals(this.runnerId, workflowJob.runnerId) &&
        Objects.equals(this.runnerName, workflowJob.runnerName) &&
        Objects.equals(this.startedAt, workflowJob.startedAt) &&
        Objects.equals(this.status, workflowJob.status) &&
        Objects.equals(this.headBranch, workflowJob.headBranch) &&
        Objects.equals(this.workflowName, workflowJob.workflowName) &&
        Objects.equals(this.steps, workflowJob.steps) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowJob is not found in the empty JSON string", WorkflowJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowJob` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowJob.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraysteps.size(); i++) {
        WorkflowStep.validateJsonObject(jsonArraysteps.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowJob.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowJob>() {
           @Override
           public void write(JsonWriter out, WorkflowJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowJob read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowJob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowJob
  * @throws IOException if the JSON string is invalid with respect to WorkflowJob
  */
  public static WorkflowJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowJob.class);
  }

 /**
  * Convert an instance of WorkflowJob to an JSON string
  *
  * @return JSON string
  */
