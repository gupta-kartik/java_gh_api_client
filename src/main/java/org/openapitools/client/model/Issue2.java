...
import org.openapitools.client.model.App8;
...
public class Issue2 {
  ...
  private App8 performedViaGithubApp;
  ...
  **/
  ...
  public Issue2 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue2 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public Issue2 comments(Integer comments) {
  ...
  **/
  ...
  public Issue2 labels(List<Label> labels) {
  ...
  **/
  ...
  public Issue2 number(Integer number) {
  ...
  **/
  ...
  public Issue2 performedViaGithubApp(App8 performedViaGithubApp) {
  ...
  **/
  ...
  public App8 getPerformedViaGithubApp() {
    return performedViaGithubApp;
  }


  public void setPerformedViaGithubApp(App8 performedViaGithubApp) {
    this.performedViaGithubApp = performedViaGithubApp;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue2 is not found in the empty JSON string", Issue2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue2.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App8.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue2.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue2>() {
           @Override
           public void write(JsonWriter out, Issue2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue2
  * @throws IOException if the JSON string is invalid with respect to Issue2
  */
  public static Issue2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue2.class);
  }

 /**
  * Convert an instance of Issue2 to an JSON string
  *
  * @return JSON string
  */
