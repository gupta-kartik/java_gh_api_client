...
import org.openapitools.client.model.WebhookMemberEditedChanges;
...
public class WebhookMemberEdited {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMemberEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMemberEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMemberEdited is not found in the empty JSON string", WebhookMemberEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMemberEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMemberEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMemberEdited.openapiRequiredFields) {
      ...
      WebhookMemberEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMemberEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMemberEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMemberEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMemberEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMemberEdited>() {
           @Override
           public void write(JsonWriter out, WebhookMemberEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMemberEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMemberEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMemberEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookMemberEdited
  */
  public static WebhookMemberEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMemberEdited.class);
  }

 /**
  * Convert an instance of WebhookMemberEdited to an JSON string
  *
  * @return JSON string
  */
