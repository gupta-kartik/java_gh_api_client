...
public class Repository3 {
  ...
  **/
  ...
  public Repository3 forks(Integer forks) {
  ...
  **/
  ...
  public Repository3 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository3 id(Integer id) {
  ...
  **/
  ...
  public Repository3 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository3 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository3 size(Integer size) {
  ...
  **/
  ...
  public Repository3 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository3 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository3 useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public Repository3 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository3 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository3 is not found in the empty JSON string", Repository3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository3` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository3.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository3>() {
           @Override
           public void write(JsonWriter out, Repository3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository3 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository3
  * @throws IOException if the JSON string is invalid with respect to Repository3
  */
  public static Repository3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository3.class);
  }

 /**
  * Convert an instance of Repository3 to an JSON string
  *
  * @return JSON string
  */
