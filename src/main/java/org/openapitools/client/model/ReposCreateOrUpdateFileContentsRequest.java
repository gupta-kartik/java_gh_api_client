...
public class ReposCreateOrUpdateFileContentsRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposCreateOrUpdateFileContentsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposCreateOrUpdateFileContentsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposCreateOrUpdateFileContentsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposCreateOrUpdateFileContentsRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("committer") != null && !jsonObj.get("committer").isJsonNull()) {
        ReposCreateOrUpdateFileContentsRequestCommitter.validateJsonObject(jsonObj.getAsJsonObject("committer"));
      }
      // validate the optional field `author`
      if (jsonObj.get("author") != null && !jsonObj.get("author").isJsonNull()) {
        ReposCreateOrUpdateFileContentsRequestAuthor.validateJsonObject(jsonObj.getAsJsonObject("author"));
      }
  }
