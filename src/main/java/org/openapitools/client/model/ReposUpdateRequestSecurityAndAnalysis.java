...
public class ReposUpdateRequestSecurityAndAnalysis {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposUpdateRequestSecurityAndAnalysis
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposUpdateRequestSecurityAndAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposUpdateRequestSecurityAndAnalysis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposUpdateRequestSecurityAndAnalysis` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("advanced_security") != null && !jsonObj.get("advanced_security").isJsonNull()) {
        ReposUpdateRequestSecurityAndAnalysisAdvancedSecurity.validateJsonObject(jsonObj.getAsJsonObject("advanced_security"));
      }
      // validate the optional field `secret_scanning`
      if (jsonObj.get("secret_scanning") != null && !jsonObj.get("secret_scanning").isJsonNull()) {
        ReposUpdateRequestSecurityAndAnalysisSecretScanning.validateJsonObject(jsonObj.getAsJsonObject("secret_scanning"));
      }
      ...
      if (jsonObj.get("secret_scanning_push_protection") != null && !jsonObj.get("secret_scanning_push_protection").isJsonNull()) {
        ReposUpdateRequestSecurityAndAnalysisSecretScanningPushProtection.validateJsonObject(jsonObj.getAsJsonObject("secret_scanning_push_protection"));
      }
  }
