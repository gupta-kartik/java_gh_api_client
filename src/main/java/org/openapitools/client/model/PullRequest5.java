...
public class PullRequest5 {
  ...
  public PullRequest5 links(PullRequestLinks links) {
  ...
  **/
  ...
  public PullRequest5 additions(Integer additions) {
  ...
  **/
  ...
  public PullRequest5 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public PullRequest5 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public PullRequest5 changedFiles(Integer changedFiles) {
  ...
  **/
  ...
  public PullRequest5 comments(Integer comments) {
  ...
  **/
  ...
  public PullRequest5 commits(Integer commits) {
  ...
  **/
  ...
  public PullRequest5 deletions(Integer deletions) {
  ...
  **/
  ...
  public PullRequest5 id(Integer id) {
  ...
  **/
  ...
  public PullRequest5 labels(List<Label> labels) {
  ...
  **/
  ...
  public PullRequest5 mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public PullRequest5 number(Integer number) {
  ...
  **/
  ...
  public PullRequest5 requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public PullRequest5 addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  **/
  ...
  public PullRequest5 reviewComments(Integer reviewComments) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PullRequest5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequest5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequest5 is not found in the empty JSON string", PullRequest5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequest5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequest5` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequest5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequest5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequest5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequest5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequest5.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequest5>() {
           @Override
           public void write(JsonWriter out, PullRequest5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequest5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PullRequest5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PullRequest5
  * @throws IOException if the JSON string is invalid with respect to PullRequest5
  */
  public static PullRequest5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequest5.class);
  }

 /**
  * Convert an instance of PullRequest5 to an JSON string
  *
  * @return JSON string
  */
