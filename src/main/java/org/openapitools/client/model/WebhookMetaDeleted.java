...
public class WebhookMetaDeleted {
  ...
  **/
  ...
  public WebhookMetaDeleted hookId(Integer hookId) {
  ...
  **/
  ...
  public WebhookMetaDeleted repository(NullableRepository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMetaDeleted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMetaDeleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMetaDeleted is not found in the empty JSON string", WebhookMetaDeleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMetaDeleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMetaDeleted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMetaDeleted.openapiRequiredFields) {
      ...
      WebhookMetaDeletedHook.validateJsonObject(jsonObj.getAsJsonObject("hook"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMetaDeleted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMetaDeleted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMetaDeleted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMetaDeleted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMetaDeleted>() {
           @Override
           public void write(JsonWriter out, WebhookMetaDeleted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMetaDeleted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMetaDeleted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMetaDeleted
  * @throws IOException if the JSON string is invalid with respect to WebhookMetaDeleted
  */
  public static WebhookMetaDeleted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMetaDeleted.class);
  }

 /**
  * Convert an instance of WebhookMetaDeleted to an JSON string
  *
  * @return JSON string
  */
