...
public class CodespacesCreateOrUpdateOrgSecretRequest {
  ...
  **/
  ...
  public CodespacesCreateOrUpdateOrgSecretRequest selectedRepositoryIds(List<Integer> selectedRepositoryIds) {
    
    this.selectedRepositoryIds = selectedRepositoryIds;
    return this;
  }

  public CodespacesCreateOrUpdateOrgSecretRequest addSelectedRepositoryIdsItem(Integer selectedRepositoryIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CodespacesCreateOrUpdateOrgSecretRequest codespacesCreateOrUpdateOrgSecretRequest = (CodespacesCreateOrUpdateOrgSecretRequest) o;
    return Objects.equals(this.encryptedValue, codespacesCreateOrUpdateOrgSecretRequest.encryptedValue) &&
        ...
        Objects.equals(this.selectedRepositoryIds, codespacesCreateOrUpdateOrgSecretRequest.selectedRepositoryIds);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CodespacesCreateOrUpdateOrgSecretRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CodespacesCreateOrUpdateOrgSecretRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodespacesCreateOrUpdateOrgSecretRequest is not found in the empty JSON string", CodespacesCreateOrUpdateOrgSecretRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CodespacesCreateOrUpdateOrgSecretRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodespacesCreateOrUpdateOrgSecretRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodespacesCreateOrUpdateOrgSecretRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodespacesCreateOrUpdateOrgSecretRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodespacesCreateOrUpdateOrgSecretRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodespacesCreateOrUpdateOrgSecretRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodespacesCreateOrUpdateOrgSecretRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CodespacesCreateOrUpdateOrgSecretRequest>() {
           @Override
           public void write(JsonWriter out, CodespacesCreateOrUpdateOrgSecretRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodespacesCreateOrUpdateOrgSecretRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CodespacesCreateOrUpdateOrgSecretRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CodespacesCreateOrUpdateOrgSecretRequest
  * @throws IOException if the JSON string is invalid with respect to CodespacesCreateOrUpdateOrgSecretRequest
  */
  public static CodespacesCreateOrUpdateOrgSecretRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodespacesCreateOrUpdateOrgSecretRequest.class);
  }

 /**
  * Convert an instance of CodespacesCreateOrUpdateOrgSecretRequest to an JSON string
  *
  * @return JSON string
  */
