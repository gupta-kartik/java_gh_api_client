...
public class WebhookDependabotAlertReopened {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDependabotAlertReopened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDependabotAlertReopened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDependabotAlertReopened is not found in the empty JSON string", WebhookDependabotAlertReopened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDependabotAlertReopened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDependabotAlertReopened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDependabotAlertReopened.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDependabotAlertReopened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDependabotAlertReopened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDependabotAlertReopened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDependabotAlertReopened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDependabotAlertReopened>() {
           @Override
           public void write(JsonWriter out, WebhookDependabotAlertReopened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDependabotAlertReopened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDependabotAlertReopened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDependabotAlertReopened
  * @throws IOException if the JSON string is invalid with respect to WebhookDependabotAlertReopened
  */
  public static WebhookDependabotAlertReopened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDependabotAlertReopened.class);
  }

 /**
  * Convert an instance of WebhookDependabotAlertReopened to an JSON string
  *
  * @return JSON string
  */
