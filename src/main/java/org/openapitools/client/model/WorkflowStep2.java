...
public class WorkflowStep2 {
  ...
  **/
  ...
  public WorkflowStep2 number(Integer number) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowStep2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowStep2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowStep2 is not found in the empty JSON string", WorkflowStep2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowStep2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowStep2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowStep2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowStep2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowStep2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowStep2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowStep2.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowStep2>() {
           @Override
           public void write(JsonWriter out, WorkflowStep2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowStep2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowStep2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowStep2
  * @throws IOException if the JSON string is invalid with respect to WorkflowStep2
  */
  public static WorkflowStep2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowStep2.class);
  }

 /**
  * Convert an instance of WorkflowStep2 to an JSON string
  *
  * @return JSON string
  */
