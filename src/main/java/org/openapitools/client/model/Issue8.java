...
import org.openapitools.client.model.App14;
...
public class Issue8 {
  ...
  private App14 performedViaGithubApp;
  ...
  **/
  ...
  public Issue8 assignee(User assignee) {
  ...
  **/
  ...
  public Issue8 assignees(List<User> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue8 addAssigneesItem(User assigneesItem) {
  ...
  **/
  ...
  public Issue8 comments(Integer comments) {
  ...
  **/
  ...
  public Issue8 labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public Issue8 addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public Issue8 milestone(Milestone1 milestone) {
  ...
  **/
  ...
  public Issue8 number(Integer number) {
  ...
  **/
  ...
  public Issue8 performedViaGithubApp(App14 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue8 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue8 is not found in the empty JSON string", Issue8.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue8.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue8` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue8.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App14.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue8.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue8>() {
           @Override
           public void write(JsonWriter out, Issue8 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue8 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue8
  * @throws IOException if the JSON string is invalid with respect to Issue8
  */
  public static Issue8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue8.class);
  }

 /**
  * Convert an instance of Issue8 to an JSON string
  *
  * @return JSON string
  */
