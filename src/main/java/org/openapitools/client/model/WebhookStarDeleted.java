...
public class WebhookStarDeleted {
  ...
  **/
  ...
  public WebhookStarDeleted enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookStarDeleted organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookStarDeleted repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookStarDeleted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookStarDeleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookStarDeleted is not found in the empty JSON string", WebhookStarDeleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookStarDeleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookStarDeleted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookStarDeleted.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookStarDeleted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookStarDeleted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookStarDeleted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookStarDeleted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookStarDeleted>() {
           @Override
           public void write(JsonWriter out, WebhookStarDeleted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookStarDeleted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookStarDeleted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookStarDeleted
  * @throws IOException if the JSON string is invalid with respect to WebhookStarDeleted
  */
  public static WebhookStarDeleted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookStarDeleted.class);
  }

 /**
  * Convert an instance of WebhookStarDeleted to an JSON string
  *
  * @return JSON string
  */
