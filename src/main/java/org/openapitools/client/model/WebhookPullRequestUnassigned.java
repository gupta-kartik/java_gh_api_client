...
import org.openapitools.client.model.PullRequest12;
...
public class WebhookPullRequestUnassigned {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned assignee(User1 assignee) {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned pullRequest(PullRequest12 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestUnassigned repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestUnassigned
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestUnassigned.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestUnassigned is not found in the empty JSON string", WebhookPullRequestUnassigned.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestUnassigned.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestUnassigned` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestUnassigned.openapiRequiredFields) {
      ...
      PullRequest12.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestUnassigned.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestUnassigned' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestUnassigned> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestUnassigned.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestUnassigned>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestUnassigned value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestUnassigned read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestUnassigned given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestUnassigned
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestUnassigned
  */
  public static WebhookPullRequestUnassigned fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestUnassigned.class);
  }

 /**
  * Convert an instance of WebhookPullRequestUnassigned to an JSON string
  *
  * @return JSON string
  */
