...
public class App3Permissions {
  ...
  **/
  ...
  public App3Permissions organizationSelfHostedRunners(OrganizationSelfHostedRunnersEnum organizationSelfHostedRunners) {
  ...
  **/
  ...
  public App3Permissions teamDiscussions(TeamDiscussionsEnum teamDiscussions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, app3Permissions.actions) &&
        ...
        Objects.equals(this.teamDiscussions, app3Permissions.teamDiscussions) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to App3Permissions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!App3Permissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in App3Permissions is not found in the empty JSON string", App3Permissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!App3Permissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `App3Permissions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!App3Permissions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'App3Permissions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<App3Permissions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(App3Permissions.class));

       return (TypeAdapter<T>) new TypeAdapter<App3Permissions>() {
           @Override
           public void write(JsonWriter out, App3Permissions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public App3Permissions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of App3Permissions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of App3Permissions
  * @throws IOException if the JSON string is invalid with respect to App3Permissions
  */
  public static App3Permissions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, App3Permissions.class);
  }

 /**
  * Convert an instance of App3Permissions to an JSON string
  *
  * @return JSON string
  */
