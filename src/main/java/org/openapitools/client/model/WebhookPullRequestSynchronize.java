...
import org.openapitools.client.model.PullRequest11;
...
public class WebhookPullRequestSynchronize {
  ...
  **/
  ...
  public WebhookPullRequestSynchronize enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestSynchronize number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestSynchronize organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestSynchronize pullRequest(PullRequest11 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestSynchronize repository(Repository repository) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, after, before, enterprise, installation, number, organization, pullRequest, repository, sender);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestSynchronize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestSynchronize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestSynchronize is not found in the empty JSON string", WebhookPullRequestSynchronize.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestSynchronize.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestSynchronize` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestSynchronize.openapiRequiredFields) {
      ...
      PullRequest11.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestSynchronize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestSynchronize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestSynchronize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestSynchronize.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestSynchronize>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestSynchronize value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestSynchronize read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestSynchronize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestSynchronize
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestSynchronize
  */
  public static WebhookPullRequestSynchronize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestSynchronize.class);
  }

 /**
  * Convert an instance of WebhookPullRequestSynchronize to an JSON string
  *
  * @return JSON string
  */
