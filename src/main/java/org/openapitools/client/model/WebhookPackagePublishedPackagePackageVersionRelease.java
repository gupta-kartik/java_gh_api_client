...
public class WebhookPackagePublishedPackagePackageVersionRelease {
  ...
  **/
  ...
  public WebhookPackagePublishedPackagePackageVersionRelease id(Integer id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPackagePublishedPackagePackageVersionRelease webhookPackagePublishedPackagePackageVersionRelease = (WebhookPackagePublishedPackagePackageVersionRelease) o;
    return Objects.equals(this.author, webhookPackagePublishedPackagePackageVersionRelease.author) &&
        ...
        Objects.equals(this.targetCommitish, webhookPackagePublishedPackagePackageVersionRelease.targetCommitish) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPackagePublishedPackagePackageVersionRelease
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPackagePublishedPackagePackageVersionRelease.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPackagePublishedPackagePackageVersionRelease is not found in the empty JSON string", WebhookPackagePublishedPackagePackageVersionRelease.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPackagePublishedPackagePackageVersionRelease.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPackagePublishedPackagePackageVersionRelease` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPackagePublishedPackagePackageVersionRelease.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPackagePublishedPackagePackageVersionRelease.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPackagePublishedPackagePackageVersionRelease' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPackagePublishedPackagePackageVersionRelease> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPackagePublishedPackagePackageVersionRelease.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPackagePublishedPackagePackageVersionRelease>() {
           @Override
           public void write(JsonWriter out, WebhookPackagePublishedPackagePackageVersionRelease value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPackagePublishedPackagePackageVersionRelease read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPackagePublishedPackagePackageVersionRelease given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPackagePublishedPackagePackageVersionRelease
  * @throws IOException if the JSON string is invalid with respect to WebhookPackagePublishedPackagePackageVersionRelease
  */
  public static WebhookPackagePublishedPackagePackageVersionRelease fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPackagePublishedPackagePackageVersionRelease.class);
  }

 /**
  * Convert an instance of WebhookPackagePublishedPackagePackageVersionRelease to an JSON string
  *
  * @return JSON string
  */
