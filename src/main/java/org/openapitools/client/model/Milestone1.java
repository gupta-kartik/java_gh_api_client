...
public class Milestone1 {
  ...
  **/
  ...
  public Milestone1 closedIssues(Integer closedIssues) {
  ...
  **/
  ...
  public Milestone1 id(Integer id) {
  ...
  **/
  ...
  public Milestone1 number(Integer number) {
  ...
  **/
  ...
  public Milestone1 openIssues(Integer openIssues) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Milestone1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Milestone1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Milestone1 is not found in the empty JSON string", Milestone1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Milestone1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Milestone1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Milestone1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Milestone1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Milestone1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Milestone1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Milestone1.class));

       return (TypeAdapter<T>) new TypeAdapter<Milestone1>() {
           @Override
           public void write(JsonWriter out, Milestone1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Milestone1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Milestone1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Milestone1
  * @throws IOException if the JSON string is invalid with respect to Milestone1
  */
  public static Milestone1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Milestone1.class);
  }

 /**
  * Convert an instance of Milestone1 to an JSON string
  *
  * @return JSON string
  */
