...
public class WebhookWorkflowJobCompletedWorkflowJob {
  ...
  **/
  ...
  public WebhookWorkflowJobCompletedWorkflowJob id(Integer id) {
  ...
  **/
  ...
  public WebhookWorkflowJobCompletedWorkflowJob runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public WebhookWorkflowJobCompletedWorkflowJob runId(Integer runId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookWorkflowJobCompletedWorkflowJob webhookWorkflowJobCompletedWorkflowJob = (WebhookWorkflowJobCompletedWorkflowJob) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookWorkflowJobCompletedWorkflowJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookWorkflowJobCompletedWorkflowJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookWorkflowJobCompletedWorkflowJob is not found in the empty JSON string", WebhookWorkflowJobCompletedWorkflowJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookWorkflowJobCompletedWorkflowJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookWorkflowJobCompletedWorkflowJob` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookWorkflowJobCompletedWorkflowJob.openapiRequiredFields) {
      ...
      if (jsonObj.get("steps") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("steps").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookWorkflowJobCompletedWorkflowJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookWorkflowJobCompletedWorkflowJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookWorkflowJobCompletedWorkflowJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookWorkflowJobCompletedWorkflowJob.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookWorkflowJobCompletedWorkflowJob>() {
           @Override
           public void write(JsonWriter out, WebhookWorkflowJobCompletedWorkflowJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookWorkflowJobCompletedWorkflowJob read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookWorkflowJobCompletedWorkflowJob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookWorkflowJobCompletedWorkflowJob
  * @throws IOException if the JSON string is invalid with respect to WebhookWorkflowJobCompletedWorkflowJob
  */
  public static WebhookWorkflowJobCompletedWorkflowJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookWorkflowJobCompletedWorkflowJob.class);
  }

 /**
  * Convert an instance of WebhookWorkflowJobCompletedWorkflowJob to an JSON string
  *
  * @return JSON string
  */
