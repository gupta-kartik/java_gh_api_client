...
public class WebhookIssuesClosedIssueAllOf {
  ...
  public WebhookIssuesClosedIssueAllOf() {
  }

  public WebhookIssuesClosedIssueAllOf activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesClosedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesClosedIssueAllOf addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf state(StateEnum state) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssuesClosedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesClosedIssueAllOf webhookIssuesClosedIssueAllOf = (WebhookIssuesClosedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssuesClosedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesClosedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssuesClosedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesClosedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesClosedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssuesClosedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssuesClosedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesClosedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesClosedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssuesClosedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesClosedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesClosedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssuesClosedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesClosedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesClosedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssuesClosedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesClosedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssuesClosedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesClosedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssuesClosedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesClosedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesClosedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssuesClosedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesClosedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssuesClosedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssuesClosedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssuesClosedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesClosedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesClosedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesClosedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesClosedIssueAllOf is not found in the empty JSON string", WebhookIssuesClosedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesClosedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesClosedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesClosedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesClosedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesClosedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesClosedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesClosedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesClosedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesClosedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesClosedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesClosedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesClosedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesClosedIssueAllOf
  */
  public static WebhookIssuesClosedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesClosedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssuesClosedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
