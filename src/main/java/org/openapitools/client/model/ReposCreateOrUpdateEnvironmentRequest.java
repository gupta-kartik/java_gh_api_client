...
public class ReposCreateOrUpdateEnvironmentRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.waitTimer, reposCreateOrUpdateEnvironmentRequest.waitTimer) &&
        ...
        Objects.equals(this.deploymentBranchPolicy, reposCreateOrUpdateEnvironmentRequest.deploymentBranchPolicy);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposCreateOrUpdateEnvironmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposCreateOrUpdateEnvironmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposCreateOrUpdateEnvironmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposCreateOrUpdateEnvironmentRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("reviewers") != null && !jsonObj.get("reviewers").isJsonNull()) {
        ...
        if (jsonArrayreviewers != null) {
          ...
          for (int i = 0; i < jsonArrayreviewers.size(); i++) {
            ReposCreateOrUpdateEnvironmentRequestReviewersInner.validateJsonObject(jsonArrayreviewers.get(i).getAsJsonObject());
          };
        }
      }
