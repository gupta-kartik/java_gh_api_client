...
public class WebhookCheckSuiteCompletedCheckSuite {
  ...
  **/
  ...
  public WebhookCheckSuiteCompletedCheckSuite id(Integer id) {
  ...
  **/
  ...
  public WebhookCheckSuiteCompletedCheckSuite latestCheckRunsCount(Integer latestCheckRunsCount) {
  ...
  **/
  ...
  public WebhookCheckSuiteCompletedCheckSuite pullRequests(List<CheckRunPullRequest> pullRequests) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCheckSuiteCompletedCheckSuite
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCheckSuiteCompletedCheckSuite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCheckSuiteCompletedCheckSuite is not found in the empty JSON string", WebhookCheckSuiteCompletedCheckSuite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCheckSuiteCompletedCheckSuite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCheckSuiteCompletedCheckSuite` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCheckSuiteCompletedCheckSuite.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCheckSuiteCompletedCheckSuite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCheckSuiteCompletedCheckSuite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCheckSuiteCompletedCheckSuite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCheckSuiteCompletedCheckSuite.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCheckSuiteCompletedCheckSuite>() {
           @Override
           public void write(JsonWriter out, WebhookCheckSuiteCompletedCheckSuite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCheckSuiteCompletedCheckSuite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCheckSuiteCompletedCheckSuite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCheckSuiteCompletedCheckSuite
  * @throws IOException if the JSON string is invalid with respect to WebhookCheckSuiteCompletedCheckSuite
  */
  public static WebhookCheckSuiteCompletedCheckSuite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCheckSuiteCompletedCheckSuite.class);
  }

 /**
  * Convert an instance of WebhookCheckSuiteCompletedCheckSuite to an JSON string
  *
  * @return JSON string
  */
