...
public class FileCommitCommit {
  ...
  private List<FileCommitCommitParentsInner> parents;
  ...
  **/
  ...
  public FileCommitCommit parents(List<FileCommitCommitParentsInner> parents) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileCommitCommit
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileCommitCommit.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FileCommitCommit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileCommitCommit` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("author") != null && !jsonObj.get("author").isJsonNull()) {
        FileCommitCommitAuthor.validateJsonObject(jsonObj.getAsJsonObject("author"));
      }
      // validate the optional field `committer`
      if (jsonObj.get("committer") != null && !jsonObj.get("committer").isJsonNull()) {
        FileCommitCommitAuthor.validateJsonObject(jsonObj.getAsJsonObject("committer"));
      }
      ...
      if (jsonObj.get("tree") != null && !jsonObj.get("tree").isJsonNull()) {
        FileCommitCommitTree.validateJsonObject(jsonObj.getAsJsonObject("tree"));
      }
      ...
      if (jsonObj.get("verification") != null && !jsonObj.get("verification").isJsonNull()) {
        FileCommitCommitVerification.validateJsonObject(jsonObj.getAsJsonObject("verification"));
      }
  }
