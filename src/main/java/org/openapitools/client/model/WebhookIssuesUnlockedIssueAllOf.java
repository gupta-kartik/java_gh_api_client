...
public class WebhookIssuesUnlockedIssueAllOf {
  ...
  public WebhookIssuesUnlockedIssueAllOf() {
  }

  public WebhookIssuesUnlockedIssueAllOf activeLockReason(Object activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesUnlockedIssueAllOf addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf body(String body) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesUnlockedIssueAllOf addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf locked(LockedEnum locked) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf state(String state) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf title(String title) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf url(String url) {
  ...
  **/
  ...
  public WebhookIssuesUnlockedIssueAllOf user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesUnlockedIssueAllOf webhookIssuesUnlockedIssueAllOf = (WebhookIssuesUnlockedIssueAllOf) o;
    return Objects.equals(this.activeLockReason, webhookIssuesUnlockedIssueAllOf.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesUnlockedIssueAllOf.assignee) &&
        Objects.equals(this.assignees, webhookIssuesUnlockedIssueAllOf.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesUnlockedIssueAllOf.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesUnlockedIssueAllOf.body) &&
        Objects.equals(this.closedAt, webhookIssuesUnlockedIssueAllOf.closedAt) &&
        Objects.equals(this.comments, webhookIssuesUnlockedIssueAllOf.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesUnlockedIssueAllOf.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesUnlockedIssueAllOf.createdAt) &&
        Objects.equals(this.eventsUrl, webhookIssuesUnlockedIssueAllOf.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesUnlockedIssueAllOf.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesUnlockedIssueAllOf.id) &&
        Objects.equals(this.labels, webhookIssuesUnlockedIssueAllOf.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesUnlockedIssueAllOf.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesUnlockedIssueAllOf.locked) &&
        Objects.equals(this.milestone, webhookIssuesUnlockedIssueAllOf.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesUnlockedIssueAllOf.nodeId) &&
        Objects.equals(this.number, webhookIssuesUnlockedIssueAllOf.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesUnlockedIssueAllOf.performedViaGithubApp) &&
        Objects.equals(this.reactions, webhookIssuesUnlockedIssueAllOf.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesUnlockedIssueAllOf.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesUnlockedIssueAllOf.state) &&
        Objects.equals(this.timelineUrl, webhookIssuesUnlockedIssueAllOf.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesUnlockedIssueAllOf.title) &&
        Objects.equals(this.updatedAt, webhookIssuesUnlockedIssueAllOf.updatedAt) &&
        Objects.equals(this.url, webhookIssuesUnlockedIssueAllOf.url) &&
        Objects.equals(this.user, webhookIssuesUnlockedIssueAllOf.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesUnlockedIssueAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesUnlockedIssueAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesUnlockedIssueAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesUnlockedIssueAllOf is not found in the empty JSON string", WebhookIssuesUnlockedIssueAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesUnlockedIssueAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesUnlockedIssueAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesUnlockedIssueAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesUnlockedIssueAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesUnlockedIssueAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesUnlockedIssueAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesUnlockedIssueAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesUnlockedIssueAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesUnlockedIssueAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesUnlockedIssueAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesUnlockedIssueAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesUnlockedIssueAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesUnlockedIssueAllOf
  */
  public static WebhookIssuesUnlockedIssueAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesUnlockedIssueAllOf.class);
  }

 /**
  * Convert an instance of WebhookIssuesUnlockedIssueAllOf to an JSON string
  *
  * @return JSON string
  */
