...
public class RepositoryTemplateRepositoryOwner {
  ...
  public RepositoryTemplateRepositoryOwner() {
  }

  public RepositoryTemplateRepositoryOwner login(String login) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner id(Integer id) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner nodeId(String nodeId) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner avatarUrl(String avatarUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner gravatarId(String gravatarId) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner url(String url) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner followersUrl(String followersUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner followingUrl(String followingUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner gistsUrl(String gistsUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner starredUrl(String starredUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner subscriptionsUrl(String subscriptionsUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner organizationsUrl(String organizationsUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner reposUrl(String reposUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner receivedEventsUrl(String receivedEventsUrl) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner type(String type) {
  ...
  **/
  ...
  public RepositoryTemplateRepositoryOwner siteAdmin(Boolean siteAdmin) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryTemplateRepositoryOwner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryTemplateRepositoryOwner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryTemplateRepositoryOwner is not found in the empty JSON string", RepositoryTemplateRepositoryOwner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RepositoryTemplateRepositoryOwner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryTemplateRepositoryOwner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryTemplateRepositoryOwner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryTemplateRepositoryOwner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryTemplateRepositoryOwner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryTemplateRepositoryOwner.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryTemplateRepositoryOwner>() {
           @Override
           public void write(JsonWriter out, RepositoryTemplateRepositoryOwner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryTemplateRepositoryOwner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RepositoryTemplateRepositoryOwner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryTemplateRepositoryOwner
  * @throws IOException if the JSON string is invalid with respect to RepositoryTemplateRepositoryOwner
  */
  public static RepositoryTemplateRepositoryOwner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryTemplateRepositoryOwner.class);
  }

 /**
  * Convert an instance of RepositoryTemplateRepositoryOwner to an JSON string
  *
  * @return JSON string
  */
