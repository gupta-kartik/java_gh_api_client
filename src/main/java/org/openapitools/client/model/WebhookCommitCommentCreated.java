...
import org.openapitools.client.model.WebhookCommitCommentCreatedComment;
...
public class WebhookCommitCommentCreated {
  ...
  **/
  ...
  public WebhookCommitCommentCreated enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookCommitCommentCreated organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookCommitCommentCreated repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCommitCommentCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCommitCommentCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCommitCommentCreated is not found in the empty JSON string", WebhookCommitCommentCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCommitCommentCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCommitCommentCreated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCommitCommentCreated.openapiRequiredFields) {
      ...
      WebhookCommitCommentCreatedComment.validateJsonObject(jsonObj.getAsJsonObject("comment"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCommitCommentCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCommitCommentCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCommitCommentCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCommitCommentCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCommitCommentCreated>() {
           @Override
           public void write(JsonWriter out, WebhookCommitCommentCreated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCommitCommentCreated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCommitCommentCreated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCommitCommentCreated
  * @throws IOException if the JSON string is invalid with respect to WebhookCommitCommentCreated
  */
  public static WebhookCommitCommentCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCommitCommentCreated.class);
  }

 /**
  * Convert an instance of WebhookCommitCommentCreated to an JSON string
  *
  * @return JSON string
  */
