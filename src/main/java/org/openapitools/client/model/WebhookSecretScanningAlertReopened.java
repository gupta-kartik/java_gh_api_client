...
public class WebhookSecretScanningAlertReopened {
  ...
  **/
  ...
  public WebhookSecretScanningAlertReopened alert(SecretScanningAlert alert) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertReopened enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertReopened organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookSecretScanningAlertReopened repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSecretScanningAlertReopened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSecretScanningAlertReopened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSecretScanningAlertReopened is not found in the empty JSON string", WebhookSecretScanningAlertReopened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookSecretScanningAlertReopened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSecretScanningAlertReopened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookSecretScanningAlertReopened.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSecretScanningAlertReopened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSecretScanningAlertReopened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSecretScanningAlertReopened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSecretScanningAlertReopened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSecretScanningAlertReopened>() {
           @Override
           public void write(JsonWriter out, WebhookSecretScanningAlertReopened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSecretScanningAlertReopened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookSecretScanningAlertReopened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookSecretScanningAlertReopened
  * @throws IOException if the JSON string is invalid with respect to WebhookSecretScanningAlertReopened
  */
  public static WebhookSecretScanningAlertReopened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSecretScanningAlertReopened.class);
  }

 /**
  * Convert an instance of WebhookSecretScanningAlertReopened to an JSON string
  *
  * @return JSON string
  */
