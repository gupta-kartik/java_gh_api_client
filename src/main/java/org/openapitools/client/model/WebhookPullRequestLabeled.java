...
import org.openapitools.client.model.PullRequest5;
...
public class WebhookPullRequestLabeled {
  ...
  **/
  ...
  public WebhookPullRequestLabeled enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestLabeled label(Label label) {
  ...
  **/
  ...
  public WebhookPullRequestLabeled number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestLabeled organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestLabeled pullRequest(PullRequest5 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestLabeled repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestLabeled
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestLabeled.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestLabeled is not found in the empty JSON string", WebhookPullRequestLabeled.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestLabeled.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestLabeled` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestLabeled.openapiRequiredFields) {
      ...
      PullRequest5.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestLabeled.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestLabeled' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestLabeled> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestLabeled.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestLabeled>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestLabeled value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestLabeled read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestLabeled given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestLabeled
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestLabeled
  */
  public static WebhookPullRequestLabeled fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestLabeled.class);
  }

 /**
  * Convert an instance of WebhookPullRequestLabeled to an JSON string
  *
  * @return JSON string
  */
