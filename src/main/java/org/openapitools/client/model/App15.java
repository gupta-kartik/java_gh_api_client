...
public class App15 {
  ...
  **/
  ...
  public App15 permissions(App8Permissions permissions) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to App15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!App15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in App15 is not found in the empty JSON string", App15.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!App15.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `App15` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : App15.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!App15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'App15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<App15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(App15.class));

       return (TypeAdapter<T>) new TypeAdapter<App15>() {
           @Override
           public void write(JsonWriter out, App15 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public App15 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of App15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of App15
  * @throws IOException if the JSON string is invalid with respect to App15
  */
  public static App15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, App15.class);
  }

 /**
  * Convert an instance of App15 to an JSON string
  *
  * @return JSON string
  */
