...
public class WebhookCodeScanningAlertFixedAlert {
  ...
  **/
  ...
  public WebhookCodeScanningAlertFixedAlert number(Integer number) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, webhookCodeScanningAlertFixedAlert.createdAt) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertFixedAlert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertFixedAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertFixedAlert is not found in the empty JSON string", WebhookCodeScanningAlertFixedAlert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertFixedAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertFixedAlert` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertFixedAlert.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertFixedAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertFixedAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertFixedAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertFixedAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertFixedAlert>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertFixedAlert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertFixedAlert read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertFixedAlert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertFixedAlert
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertFixedAlert
  */
  public static WebhookCodeScanningAlertFixedAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertFixedAlert.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertFixedAlert to an JSON string
  *
  * @return JSON string
  */
