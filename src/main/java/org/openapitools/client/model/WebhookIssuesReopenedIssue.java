...
public class WebhookIssuesReopenedIssue {
  ...
  public WebhookIssuesReopenedIssue activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesReopenedIssue addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue body(String body) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue draft(Boolean draft) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesReopenedIssue addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue pullRequest(IssuePullRequest pullRequest) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue state(StateEnum state) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue stateReason(String stateReason) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue title(String title) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue url(String url) {
  ...
  **/
  ...
  public WebhookIssuesReopenedIssue user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesReopenedIssue webhookIssuesReopenedIssue = (WebhookIssuesReopenedIssue) o;
    return Objects.equals(this.activeLockReason, webhookIssuesReopenedIssue.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesReopenedIssue.assignee) &&
        Objects.equals(this.assignees, webhookIssuesReopenedIssue.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesReopenedIssue.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesReopenedIssue.body) &&
        Objects.equals(this.closedAt, webhookIssuesReopenedIssue.closedAt) &&
        Objects.equals(this.comments, webhookIssuesReopenedIssue.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesReopenedIssue.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesReopenedIssue.createdAt) &&
        Objects.equals(this.draft, webhookIssuesReopenedIssue.draft) &&
        Objects.equals(this.eventsUrl, webhookIssuesReopenedIssue.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesReopenedIssue.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesReopenedIssue.id) &&
        Objects.equals(this.labels, webhookIssuesReopenedIssue.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesReopenedIssue.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesReopenedIssue.locked) &&
        Objects.equals(this.milestone, webhookIssuesReopenedIssue.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesReopenedIssue.nodeId) &&
        Objects.equals(this.number, webhookIssuesReopenedIssue.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesReopenedIssue.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, webhookIssuesReopenedIssue.pullRequest) &&
        Objects.equals(this.reactions, webhookIssuesReopenedIssue.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesReopenedIssue.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesReopenedIssue.state) &&
        Objects.equals(this.stateReason, webhookIssuesReopenedIssue.stateReason) &&
        Objects.equals(this.timelineUrl, webhookIssuesReopenedIssue.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesReopenedIssue.title) &&
        Objects.equals(this.updatedAt, webhookIssuesReopenedIssue.updatedAt) &&
        Objects.equals(this.url, webhookIssuesReopenedIssue.url) &&
        Objects.equals(this.user, webhookIssuesReopenedIssue.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesReopenedIssue {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesReopenedIssue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesReopenedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesReopenedIssue is not found in the empty JSON string", WebhookIssuesReopenedIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesReopenedIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesReopenedIssue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesReopenedIssue.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesReopenedIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesReopenedIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesReopenedIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesReopenedIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesReopenedIssue>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesReopenedIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesReopenedIssue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesReopenedIssue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesReopenedIssue
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesReopenedIssue
  */
  public static WebhookIssuesReopenedIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesReopenedIssue.class);
  }

 /**
  * Convert an instance of WebhookIssuesReopenedIssue to an JSON string
  *
  * @return JSON string
  */
