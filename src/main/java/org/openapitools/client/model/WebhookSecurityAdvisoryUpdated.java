...
public class WebhookSecurityAdvisoryUpdated {
  ...
  **/
  ...
  public WebhookSecurityAdvisoryUpdated enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookSecurityAdvisoryUpdated organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookSecurityAdvisoryUpdated repository(Repository repository) {
  ...
  **/
  ...
  public WebhookSecurityAdvisoryUpdated securityAdvisory(WebhookSecurityAdvisoryPublishedSecurityAdvisory securityAdvisory) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookSecurityAdvisoryUpdated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookSecurityAdvisoryUpdated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSecurityAdvisoryUpdated is not found in the empty JSON string", WebhookSecurityAdvisoryUpdated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookSecurityAdvisoryUpdated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSecurityAdvisoryUpdated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookSecurityAdvisoryUpdated.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSecurityAdvisoryUpdated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSecurityAdvisoryUpdated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSecurityAdvisoryUpdated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSecurityAdvisoryUpdated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSecurityAdvisoryUpdated>() {
           @Override
           public void write(JsonWriter out, WebhookSecurityAdvisoryUpdated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSecurityAdvisoryUpdated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookSecurityAdvisoryUpdated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookSecurityAdvisoryUpdated
  * @throws IOException if the JSON string is invalid with respect to WebhookSecurityAdvisoryUpdated
  */
  public static WebhookSecurityAdvisoryUpdated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookSecurityAdvisoryUpdated.class);
  }

 /**
  * Convert an instance of WebhookSecurityAdvisoryUpdated to an JSON string
  *
  * @return JSON string
  */
