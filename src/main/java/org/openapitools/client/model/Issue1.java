...
public class Issue1 {
  ...
  **/
  ...
  public Issue1 assignee(User1 assignee) {
  ...
  **/
  ...
  public Issue1 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue1 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public Issue1 comments(Integer comments) {
  ...
  **/
  ...
  public Issue1 labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public Issue1 addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public Issue1 number(Integer number) {
  ...
  **/
  ...
  public Issue1 performedViaGithubApp(App7 performedViaGithubApp) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue1 is not found in the empty JSON string", Issue1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue1.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue1>() {
           @Override
           public void write(JsonWriter out, Issue1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue1
  * @throws IOException if the JSON string is invalid with respect to Issue1
  */
  public static Issue1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue1.class);
  }

 /**
  * Convert an instance of Issue1 to an JSON string
  *
  * @return JSON string
  */
