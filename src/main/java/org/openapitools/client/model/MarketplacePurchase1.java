...
public class MarketplacePurchase1 {
  ...
  public MarketplacePurchase1 account(MarketplacePurchaseAccount account) {
  ...
  **/
  ...
  public MarketplacePurchase1 freeTrialEndsOn(Object freeTrialEndsOn) {
  ...
  **/
  ...
  public MarketplacePurchase1 plan(MarketplacePurchasePlan plan) {
  ...
  **/
  ...
  public MarketplacePurchase1 unitCount(Integer unitCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MarketplacePurchase1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MarketplacePurchase1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarketplacePurchase1 is not found in the empty JSON string", MarketplacePurchase1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MarketplacePurchase1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarketplacePurchase1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MarketplacePurchase1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarketplacePurchase1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarketplacePurchase1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarketplacePurchase1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarketplacePurchase1.class));

       return (TypeAdapter<T>) new TypeAdapter<MarketplacePurchase1>() {
           @Override
           public void write(JsonWriter out, MarketplacePurchase1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarketplacePurchase1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MarketplacePurchase1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MarketplacePurchase1
  * @throws IOException if the JSON string is invalid with respect to MarketplacePurchase1
  */
  public static MarketplacePurchase1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarketplacePurchase1.class);
  }

 /**
  * Convert an instance of MarketplacePurchase1 to an JSON string
  *
  * @return JSON string
  */
