...
import org.openapitools.client.model.WebhookGollumPagesInner;
...
public class WebhookGollum {
  ...
  private List<WebhookGollumPagesInner> pages = new ArrayList<>();
  ...
  public WebhookGollum enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookGollum organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookGollum pages(List<WebhookGollumPagesInner> pages) {
  ...
  **/
  ...
  public List<WebhookGollumPagesInner> getPages() {
    return pages;
  }


  public void setPages(List<WebhookGollumPagesInner> pages) {
    this.pages = pages;
  }


  public WebhookGollum repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookGollum
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookGollum.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookGollum is not found in the empty JSON string", WebhookGollum.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookGollum.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookGollum` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookGollum.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraypages.size(); i++) {
        WebhookGollumPagesInner.validateJsonObject(jsonArraypages.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookGollum.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookGollum' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookGollum> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookGollum.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookGollum>() {
           @Override
           public void write(JsonWriter out, WebhookGollum value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookGollum read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookGollum given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookGollum
  * @throws IOException if the JSON string is invalid with respect to WebhookGollum
  */
  public static WebhookGollum fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookGollum.class);
  }

 /**
  * Convert an instance of WebhookGollum to an JSON string
  *
  * @return JSON string
  */
