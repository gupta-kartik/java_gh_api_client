...
public class WebhookMembershipAdded {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMembershipAdded
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMembershipAdded.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMembershipAdded is not found in the empty JSON string", WebhookMembershipAdded.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMembershipAdded.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMembershipAdded` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMembershipAdded.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMembershipAdded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMembershipAdded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMembershipAdded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMembershipAdded.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMembershipAdded>() {
           @Override
           public void write(JsonWriter out, WebhookMembershipAdded value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMembershipAdded read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMembershipAdded given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMembershipAdded
  * @throws IOException if the JSON string is invalid with respect to WebhookMembershipAdded
  */
  public static WebhookMembershipAdded fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMembershipAdded.class);
  }

 /**
  * Convert an instance of WebhookMembershipAdded to an JSON string
  *
  * @return JSON string
  */
