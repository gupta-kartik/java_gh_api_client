...
import org.openapitools.client.model.Milestone3;
...
public class WebhookMilestoneCreated {
  ...
  **/
  ...
  public WebhookMilestoneCreated enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookMilestoneCreated milestone(Milestone3 milestone) {
  ...
  **/
  ...
  public Milestone3 getMilestone() {
    return milestone;
  }


  public void setMilestone(Milestone3 milestone) {
    this.milestone = milestone;
  }


  public WebhookMilestoneCreated organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookMilestoneCreated repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMilestoneCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMilestoneCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMilestoneCreated is not found in the empty JSON string", WebhookMilestoneCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMilestoneCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMilestoneCreated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMilestoneCreated.openapiRequiredFields) {
      ...
      Milestone3.validateJsonObject(jsonObj.getAsJsonObject("milestone"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMilestoneCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMilestoneCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMilestoneCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMilestoneCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMilestoneCreated>() {
           @Override
           public void write(JsonWriter out, WebhookMilestoneCreated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMilestoneCreated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMilestoneCreated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMilestoneCreated
  * @throws IOException if the JSON string is invalid with respect to WebhookMilestoneCreated
  */
  public static WebhookMilestoneCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMilestoneCreated.class);
  }

 /**
  * Convert an instance of WebhookMilestoneCreated to an JSON string
  *
  * @return JSON string
  */
