...
public class WebhookProjectColumnCreated {
  ...
  **/
  ...
  public WebhookProjectColumnCreated enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookProjectColumnCreated organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookProjectColumnCreated projectColumn(ProjectColumn projectColumn) {
  ...
  **/
  ...
  public WebhookProjectColumnCreated repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectColumnCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectColumnCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectColumnCreated is not found in the empty JSON string", WebhookProjectColumnCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectColumnCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectColumnCreated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookProjectColumnCreated.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectColumnCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectColumnCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectColumnCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectColumnCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectColumnCreated>() {
           @Override
           public void write(JsonWriter out, WebhookProjectColumnCreated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectColumnCreated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectColumnCreated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectColumnCreated
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectColumnCreated
  */
  public static WebhookProjectColumnCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectColumnCreated.class);
  }

 /**
  * Convert an instance of WebhookProjectColumnCreated to an JSON string
  *
  * @return JSON string
  */
