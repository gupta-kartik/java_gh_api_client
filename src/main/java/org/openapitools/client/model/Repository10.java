...
public class Repository10 {
  ...
  **/
  ...
  public Repository10 forks(Integer forks) {
  ...
  **/
  ...
  public Repository10 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository10 hasDiscussions(Boolean hasDiscussions) {
  ...
  **/
  ...
  public Repository10 id(Integer id) {
  ...
  **/
  ...
  public Repository10 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository10 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository10 size(Integer size) {
  ...
  **/
  ...
  public Repository10 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository10 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository10 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository10 watchersCount(Integer watchersCount) {
  ...
  **/
  ...
  public Repository10 webCommitSignoffRequired(Boolean webCommitSignoffRequired) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowAutoMerge, repository10.allowAutoMerge) &&
        ...
        Objects.equals(this.hasDiscussions, repository10.hasDiscussions) &&
        ...
        Objects.equals(this.webCommitSignoffRequired, repository10.webCommitSignoffRequired);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository10 is not found in the empty JSON string", Repository10.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository10` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository10.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository10.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository10>() {
           @Override
           public void write(JsonWriter out, Repository10 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository10 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository10
  * @throws IOException if the JSON string is invalid with respect to Repository10
  */
  public static Repository10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository10.class);
  }

 /**
  * Convert an instance of Repository10 to an JSON string
  *
  * @return JSON string
  */
