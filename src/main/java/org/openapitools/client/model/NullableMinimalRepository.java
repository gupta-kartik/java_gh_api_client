...
public class NullableMinimalRepository {
  ...
  public NullableMinimalRepository id(Integer id) {
  ...
  **/
  ...
  public NullableMinimalRepository forksCount(Integer forksCount) {
  ...
  **/
  ...
  public NullableMinimalRepository stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public NullableMinimalRepository watchersCount(Integer watchersCount) {
  ...
  **/
  ...
  public NullableMinimalRepository size(Integer size) {
  ...
  **/
  ...
  public NullableMinimalRepository openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public NullableMinimalRepository hasDownloads(Boolean hasDownloads) {
  ...
  **/
  ...
  public NullableMinimalRepository permissions(RepositoryTemplateRepositoryPermissions permissions) {
  ...
  **/
  ...
  public NullableMinimalRepository subscribersCount(Integer subscribersCount) {
  ...
  **/
  ...
  public NullableMinimalRepository networkCount(Integer networkCount) {
  ...
  **/
  ...
  public NullableMinimalRepository forks(Integer forks) {
  ...
  **/
  ...
  public NullableMinimalRepository openIssues(Integer openIssues) {
  ...
  **/
  ...
  public NullableMinimalRepository watchers(Integer watchers) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, nullableMinimalRepository.id) &&
        ...
        Objects.equals(this.hasDownloads, nullableMinimalRepository.hasDownloads) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to NullableMinimalRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NullableMinimalRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NullableMinimalRepository is not found in the empty JSON string", NullableMinimalRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NullableMinimalRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NullableMinimalRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NullableMinimalRepository.openapiRequiredFields) {
      ...
      if (jsonObj.get("code_of_conduct") != null && !jsonObj.get("code_of_conduct").isJsonNull()) {
        CodeOfConduct.validateJsonObject(jsonObj.getAsJsonObject("code_of_conduct"));
      }
      // validate the optional field `license`
      if (jsonObj.get("license") != null && !jsonObj.get("license").isJsonNull()) {
        MinimalRepositoryLicense.validateJsonObject(jsonObj.getAsJsonObject("license"));
      }
      ...
      if (jsonObj.get("security_and_analysis") != null && !jsonObj.get("security_and_analysis").isJsonNull()) {
        SecurityAndAnalysis.validateJsonObject(jsonObj.getAsJsonObject("security_and_analysis"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NullableMinimalRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NullableMinimalRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NullableMinimalRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NullableMinimalRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<NullableMinimalRepository>() {
           @Override
           public void write(JsonWriter out, NullableMinimalRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NullableMinimalRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of NullableMinimalRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NullableMinimalRepository
  * @throws IOException if the JSON string is invalid with respect to NullableMinimalRepository
  */
  public static NullableMinimalRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NullableMinimalRepository.class);
  }

 /**
  * Convert an instance of NullableMinimalRepository to an JSON string
  *
  * @return JSON string
  */
