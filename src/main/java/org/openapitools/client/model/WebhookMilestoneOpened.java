...
public class WebhookMilestoneOpened {
  ...
  **/
  ...
  public WebhookMilestoneOpened enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookMilestoneOpened milestone(Milestone3 milestone) {
  ...
  **/
  ...
  public WebhookMilestoneOpened organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookMilestoneOpened repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMilestoneOpened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMilestoneOpened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMilestoneOpened is not found in the empty JSON string", WebhookMilestoneOpened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMilestoneOpened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMilestoneOpened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMilestoneOpened.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMilestoneOpened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMilestoneOpened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMilestoneOpened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMilestoneOpened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMilestoneOpened>() {
           @Override
           public void write(JsonWriter out, WebhookMilestoneOpened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMilestoneOpened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMilestoneOpened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMilestoneOpened
  * @throws IOException if the JSON string is invalid with respect to WebhookMilestoneOpened
  */
  public static WebhookMilestoneOpened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMilestoneOpened.class);
  }

 /**
  * Convert an instance of WebhookMilestoneOpened to an JSON string
  *
  * @return JSON string
  */
