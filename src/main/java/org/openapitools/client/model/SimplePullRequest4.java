...
import org.openapitools.client.model.SimplePullRequest3Base;
...
public class SimplePullRequest4 {
  ...
  public SimplePullRequest4 links(PullRequestLinks links) {
  ...
  **/
  ...
  public SimplePullRequest4 assignees(List<User> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public SimplePullRequest4 addAssigneesItem(User assigneesItem) {
  ...
  **/
  ...
  public SimplePullRequest4 id(Integer id) {
  ...
  **/
  ...
  public SimplePullRequest4 labels(List<Label> labels) {
  ...
  **/
  ...
  public SimplePullRequest4 mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public SimplePullRequest4 number(Integer number) {
  ...
  **/
  ...
  public SimplePullRequest4 requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public SimplePullRequest4 addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  **/
  ...
  public SimplePullRequest4 user(User user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, simplePullRequest4.links) &&
        ...
        Objects.equals(this.mergeCommitSha, simplePullRequest4.mergeCommitSha) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimplePullRequest4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimplePullRequest4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimplePullRequest4 is not found in the empty JSON string", SimplePullRequest4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SimplePullRequest4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplePullRequest4` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimplePullRequest4.openapiRequiredFields) {
      ...
      SimplePullRequest3Base.validateJsonObject(jsonObj.getAsJsonObject("base"));
      ...
      SimplePullRequest3Base.validateJsonObject(jsonObj.getAsJsonObject("head"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimplePullRequest4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimplePullRequest4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimplePullRequest4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimplePullRequest4.class));

       return (TypeAdapter<T>) new TypeAdapter<SimplePullRequest4>() {
           @Override
           public void write(JsonWriter out, SimplePullRequest4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimplePullRequest4 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SimplePullRequest4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SimplePullRequest4
  * @throws IOException if the JSON string is invalid with respect to SimplePullRequest4
  */
  public static SimplePullRequest4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimplePullRequest4.class);
  }

 /**
  * Convert an instance of SimplePullRequest4 to an JSON string
  *
  * @return JSON string
  */
