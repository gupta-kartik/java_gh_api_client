...
public class CodespaceMachine {
  ...
  **/
  ...
  public CodespaceMachine storageInBytes(Integer storageInBytes) {
  ...
  **/
  ...
  public CodespaceMachine memoryInBytes(Integer memoryInBytes) {
  ...
  **/
  ...
  public CodespaceMachine cpus(Integer cpus) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CodespaceMachine
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CodespaceMachine.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodespaceMachine is not found in the empty JSON string", CodespaceMachine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CodespaceMachine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodespaceMachine` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodespaceMachine.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodespaceMachine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodespaceMachine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodespaceMachine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodespaceMachine.class));

       return (TypeAdapter<T>) new TypeAdapter<CodespaceMachine>() {
           @Override
           public void write(JsonWriter out, CodespaceMachine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodespaceMachine read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CodespaceMachine given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CodespaceMachine
  * @throws IOException if the JSON string is invalid with respect to CodespaceMachine
  */
  public static CodespaceMachine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodespaceMachine.class);
  }

 /**
  * Convert an instance of CodespaceMachine to an JSON string
  *
  * @return JSON string
  */
