...
public class PublicUser {
  ...
  **/
  ...
  public PublicUser id(Integer id) {
  ...
  **/
  ...
  public PublicUser publicRepos(Integer publicRepos) {
  ...
  **/
  ...
  public PublicUser publicGists(Integer publicGists) {
  ...
  **/
  ...
  public PublicUser followers(Integer followers) {
  ...
  **/
  ...
  public PublicUser following(Integer following) {
  ...
  **/
  ...
  public PublicUser suspendedAt(OffsetDateTime suspendedAt) {
  ...
  **/
  ...
  public PublicUser privateGists(Integer privateGists) {
  ...
  **/
  ...
  public PublicUser totalPrivateRepos(Integer totalPrivateRepos) {
  ...
  **/
  ...
  public PublicUser ownedPrivateRepos(Integer ownedPrivateRepos) {
  ...
  **/
  ...
  public PublicUser diskUsage(Integer diskUsage) {
  ...
  **/
  ...
  public PublicUser collaborators(Integer collaborators) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PublicUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PublicUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublicUser is not found in the empty JSON string", PublicUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PublicUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublicUser` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublicUser.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicUser.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicUser>() {
           @Override
           public void write(JsonWriter out, PublicUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublicUser read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PublicUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PublicUser
  * @throws IOException if the JSON string is invalid with respect to PublicUser
  */
  public static PublicUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicUser.class);
  }

 /**
  * Convert an instance of PublicUser to an JSON string
  *
  * @return JSON string
  */
