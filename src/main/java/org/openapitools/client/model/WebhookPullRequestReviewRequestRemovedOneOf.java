...
import org.openapitools.client.model.PullRequest7;
...
public class WebhookPullRequestReviewRequestRemovedOneOf {
  /**
   * Gets or Sets action
   */
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf pullRequest(PullRequest7 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf repository(Repository repository) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPullRequestReviewRequestRemovedOneOf webhookPullRequestReviewRequestRemovedOneOf = (WebhookPullRequestReviewRequestRemovedOneOf) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestReviewRequestRemovedOneOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestReviewRequestRemovedOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestReviewRequestRemovedOneOf is not found in the empty JSON string", WebhookPullRequestReviewRequestRemovedOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestReviewRequestRemovedOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestReviewRequestRemovedOneOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestReviewRequestRemovedOneOf.openapiRequiredFields) {
      ...
      PullRequest7.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
      ...
      User.validateJsonObject(jsonObj.getAsJsonObject("requested_reviewer"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestReviewRequestRemovedOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestReviewRequestRemovedOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestReviewRequestRemovedOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestReviewRequestRemovedOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestReviewRequestRemovedOneOf>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestReviewRequestRemovedOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestReviewRequestRemovedOneOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestReviewRequestRemovedOneOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestReviewRequestRemovedOneOf
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestReviewRequestRemovedOneOf
  */
  public static WebhookPullRequestReviewRequestRemovedOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestReviewRequestRemovedOneOf.class);
  }

 /**
  * Convert an instance of WebhookPullRequestReviewRequestRemovedOneOf to an JSON string
  *
  * @return JSON string
  */
