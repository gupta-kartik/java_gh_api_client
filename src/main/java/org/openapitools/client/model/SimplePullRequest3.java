...
import org.openapitools.client.model.SimplePullRequest3Head;
...
public class SimplePullRequest3 {
  ...
  public SimplePullRequest3 links(PullRequestLinks links) {
  ...
  **/
  ...
  public SimplePullRequest3 assignees(List<User> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public SimplePullRequest3 addAssigneesItem(User assigneesItem) {
  ...
  **/
  ...
  public SimplePullRequest3 id(Integer id) {
  ...
  **/
  ...
  public SimplePullRequest3 labels(List<Label> labels) {
  ...
  **/
  ...
  public SimplePullRequest3 mergeCommitSha(String mergeCommitSha) {
  ...
  **/
  ...
  public SimplePullRequest3 number(Integer number) {
  ...
  **/
  ...
  public SimplePullRequest3 requestedTeams(List<Team2> requestedTeams) {
    
    this.requestedTeams = requestedTeams;
    return this;
  }

  public SimplePullRequest3 addRequestedTeamsItem(Team2 requestedTeamsItem) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimplePullRequest3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimplePullRequest3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimplePullRequest3 is not found in the empty JSON string", SimplePullRequest3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SimplePullRequest3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplePullRequest3` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimplePullRequest3.openapiRequiredFields) {
      ...
      SimplePullRequest3Head.validateJsonObject(jsonObj.getAsJsonObject("head"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimplePullRequest3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimplePullRequest3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimplePullRequest3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimplePullRequest3.class));

       return (TypeAdapter<T>) new TypeAdapter<SimplePullRequest3>() {
           @Override
           public void write(JsonWriter out, SimplePullRequest3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimplePullRequest3 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SimplePullRequest3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SimplePullRequest3
  * @throws IOException if the JSON string is invalid with respect to SimplePullRequest3
  */
  public static SimplePullRequest3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimplePullRequest3.class);
  }

 /**
  * Convert an instance of SimplePullRequest3 to an JSON string
  *
  * @return JSON string
  */
