...
public class WebhookDiscussionCommentEdited {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDiscussionCommentEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDiscussionCommentEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDiscussionCommentEdited is not found in the empty JSON string", WebhookDiscussionCommentEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDiscussionCommentEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDiscussionCommentEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDiscussionCommentEdited.openapiRequiredFields) {
      ...
      WebhookDiscussionCommentEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDiscussionCommentEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDiscussionCommentEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDiscussionCommentEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDiscussionCommentEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDiscussionCommentEdited>() {
           @Override
           public void write(JsonWriter out, WebhookDiscussionCommentEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDiscussionCommentEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDiscussionCommentEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDiscussionCommentEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookDiscussionCommentEdited
  */
  public static WebhookDiscussionCommentEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDiscussionCommentEdited.class);
  }

 /**
  * Convert an instance of WebhookDiscussionCommentEdited to an JSON string
  *
  * @return JSON string
  */
