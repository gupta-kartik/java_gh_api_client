...
import org.openapitools.client.model.WebhookOrganizationRenamedChanges;
...
public class WebhookOrganizationRenamed {
  ...
  **/
  ...
  public WebhookOrganizationRenamed enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookOrganizationRenamed membership(Membership membership) {
  ...
  **/
  ...
  public WebhookOrganizationRenamed organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookOrganizationRenamed repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookOrganizationRenamed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookOrganizationRenamed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookOrganizationRenamed is not found in the empty JSON string", WebhookOrganizationRenamed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookOrganizationRenamed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookOrganizationRenamed` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookOrganizationRenamed.openapiRequiredFields) {
      ...
      if (jsonObj.get("changes") != null && !jsonObj.get("changes").isJsonNull()) {
        WebhookOrganizationRenamedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
      }
      ...
      if (jsonObj.get("membership") != null && !jsonObj.get("membership").isJsonNull()) {
        Membership.validateJsonObject(jsonObj.getAsJsonObject("membership"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookOrganizationRenamed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookOrganizationRenamed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookOrganizationRenamed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookOrganizationRenamed.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookOrganizationRenamed>() {
           @Override
           public void write(JsonWriter out, WebhookOrganizationRenamed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookOrganizationRenamed read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookOrganizationRenamed given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookOrganizationRenamed
  * @throws IOException if the JSON string is invalid with respect to WebhookOrganizationRenamed
  */
  public static WebhookOrganizationRenamed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookOrganizationRenamed.class);
  }

 /**
  * Convert an instance of WebhookOrganizationRenamed to an JSON string
  *
  * @return JSON string
  */
