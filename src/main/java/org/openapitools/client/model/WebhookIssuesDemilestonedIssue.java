...
public class WebhookIssuesDemilestonedIssue {
  ...
  public WebhookIssuesDemilestonedIssue activeLockReason(String activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesDemilestonedIssue addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue body(String body) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue draft(Boolean draft) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesDemilestonedIssue addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue locked(Boolean locked) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue milestone(Milestone milestone) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue pullRequest(IssuePullRequest pullRequest) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue state(String state) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue stateReason(String stateReason) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue title(String title) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue url(String url) {
  ...
  **/
  ...
  public WebhookIssuesDemilestonedIssue user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesDemilestonedIssue webhookIssuesDemilestonedIssue = (WebhookIssuesDemilestonedIssue) o;
    return Objects.equals(this.activeLockReason, webhookIssuesDemilestonedIssue.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesDemilestonedIssue.assignee) &&
        Objects.equals(this.assignees, webhookIssuesDemilestonedIssue.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesDemilestonedIssue.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesDemilestonedIssue.body) &&
        Objects.equals(this.closedAt, webhookIssuesDemilestonedIssue.closedAt) &&
        Objects.equals(this.comments, webhookIssuesDemilestonedIssue.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesDemilestonedIssue.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesDemilestonedIssue.createdAt) &&
        Objects.equals(this.draft, webhookIssuesDemilestonedIssue.draft) &&
        Objects.equals(this.eventsUrl, webhookIssuesDemilestonedIssue.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesDemilestonedIssue.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesDemilestonedIssue.id) &&
        Objects.equals(this.labels, webhookIssuesDemilestonedIssue.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesDemilestonedIssue.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesDemilestonedIssue.locked) &&
        Objects.equals(this.milestone, webhookIssuesDemilestonedIssue.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesDemilestonedIssue.nodeId) &&
        Objects.equals(this.number, webhookIssuesDemilestonedIssue.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesDemilestonedIssue.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, webhookIssuesDemilestonedIssue.pullRequest) &&
        Objects.equals(this.reactions, webhookIssuesDemilestonedIssue.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesDemilestonedIssue.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesDemilestonedIssue.state) &&
        Objects.equals(this.stateReason, webhookIssuesDemilestonedIssue.stateReason) &&
        Objects.equals(this.timelineUrl, webhookIssuesDemilestonedIssue.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesDemilestonedIssue.title) &&
        Objects.equals(this.updatedAt, webhookIssuesDemilestonedIssue.updatedAt) &&
        Objects.equals(this.url, webhookIssuesDemilestonedIssue.url) &&
        Objects.equals(this.user, webhookIssuesDemilestonedIssue.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesDemilestonedIssue {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesDemilestonedIssue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesDemilestonedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesDemilestonedIssue is not found in the empty JSON string", WebhookIssuesDemilestonedIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesDemilestonedIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesDemilestonedIssue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesDemilestonedIssue.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesDemilestonedIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesDemilestonedIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesDemilestonedIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesDemilestonedIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesDemilestonedIssue>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesDemilestonedIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesDemilestonedIssue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesDemilestonedIssue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesDemilestonedIssue
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesDemilestonedIssue
  */
  public static WebhookIssuesDemilestonedIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesDemilestonedIssue.class);
  }

 /**
  * Convert an instance of WebhookIssuesDemilestonedIssue to an JSON string
  *
  * @return JSON string
  */
