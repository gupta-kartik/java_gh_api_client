...
public class PullRequestReviewComment1 {
  ...
  public PullRequestReviewComment1 links(PullRequestReviewCommentLinks links) {
  ...
  **/
  ...
  public PullRequestReviewComment1 id(Integer id) {
  ...
  **/
  ...
  public PullRequestReviewComment1 inReplyToId(Integer inReplyToId) {
  ...
  **/
  ...
  public PullRequestReviewComment1 line(Integer line) {
  ...
  **/
  ...
  public PullRequestReviewComment1 originalLine(Integer originalLine) {
  ...
  **/
  ...
  public PullRequestReviewComment1 originalPosition(Integer originalPosition) {
  ...
  **/
  ...
  public PullRequestReviewComment1 originalStartLine(Integer originalStartLine) {
  ...
  **/
  ...
  public PullRequestReviewComment1 position(Integer position) {
  ...
  **/
  ...
  public PullRequestReviewComment1 pullRequestReviewId(Integer pullRequestReviewId) {
  ...
  **/
  ...
  public PullRequestReviewComment1 startLine(Integer startLine) {
  ...
  **/
  ...
  public PullRequestReviewComment1 user(User user) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PullRequestReviewComment1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequestReviewComment1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestReviewComment1 is not found in the empty JSON string", PullRequestReviewComment1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequestReviewComment1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestReviewComment1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequestReviewComment1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestReviewComment1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestReviewComment1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestReviewComment1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestReviewComment1.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestReviewComment1>() {
           @Override
           public void write(JsonWriter out, PullRequestReviewComment1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestReviewComment1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PullRequestReviewComment1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PullRequestReviewComment1
  * @throws IOException if the JSON string is invalid with respect to PullRequestReviewComment1
  */
  public static PullRequestReviewComment1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestReviewComment1.class);
  }

 /**
  * Convert an instance of PullRequestReviewComment1 to an JSON string
  *
  * @return JSON string
  */
