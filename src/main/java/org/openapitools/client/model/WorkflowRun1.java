...
public class WorkflowRun1 {
  ...
  public WorkflowRun1 actor(User actor) {
  ...
  **/
  ...
  public WorkflowRun1 checkSuiteId(Integer checkSuiteId) {
  ...
  **/
  ...
  public WorkflowRun1 headRepository(RepositoryLite headRepository) {
  ...
  **/
  ...
  public WorkflowRun1 id(Integer id) {
  ...
  **/
  ...
  public WorkflowRun1 pullRequests(List<WorkflowRunPullRequestsInner> pullRequests) {
  ...
  **/
  ...
  public WorkflowRun1 referencedWorkflows(List<DeploymentWorkflowRunReferencedWorkflowsInner> referencedWorkflows) {
    
    this.referencedWorkflows = referencedWorkflows;
    return this;
  }

  public WorkflowRun1 addReferencedWorkflowsItem(DeploymentWorkflowRunReferencedWorkflowsInner referencedWorkflowsItem) {
  ...
  **/
  ...
  public WorkflowRun1 repository(RepositoryLite repository) {
  ...
  **/
  ...
  public WorkflowRun1 runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public WorkflowRun1 runNumber(Integer runNumber) {
  ...
  **/
  ...
  public WorkflowRun1 triggeringActor(User triggeringActor) {
  ...
  **/
  ...
  public WorkflowRun1 workflowId(Integer workflowId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowRun1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowRun1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowRun1 is not found in the empty JSON string", WorkflowRun1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowRun1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowRun1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowRun1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowRun1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowRun1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowRun1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowRun1.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowRun1>() {
           @Override
           public void write(JsonWriter out, WorkflowRun1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowRun1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowRun1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowRun1
  * @throws IOException if the JSON string is invalid with respect to WorkflowRun1
  */
  public static WorkflowRun1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowRun1.class);
  }

 /**
  * Convert an instance of WorkflowRun1 to an JSON string
  *
  * @return JSON string
  */
