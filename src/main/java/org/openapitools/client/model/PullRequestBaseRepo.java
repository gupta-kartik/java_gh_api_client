...
import org.openapitools.client.model.PullRequestHeadRepoOwner;
...
public class PullRequestBaseRepo {
  ...
  **/
  ...
  public PullRequestBaseRepo owner(PullRequestHeadRepoOwner owner) {
  ...
  **/
  ...
  public PullRequestBaseRepo permissions(FullRepositoryPermissions permissions) {
  ...
  **/
  ...
  public PullRequestBaseRepo webCommitSignoffRequired(Boolean webCommitSignoffRequired) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archiveUrl, pullRequestBaseRepo.archiveUrl) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to PullRequestBaseRepo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PullRequestBaseRepo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PullRequestBaseRepo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestBaseRepo` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      PullRequestHeadRepoOwner.validateJsonObject(jsonObj.getAsJsonObject("owner"));
