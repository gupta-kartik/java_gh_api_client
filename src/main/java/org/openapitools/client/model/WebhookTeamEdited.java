...
import org.openapitools.client.model.WebhookTeamEditedChanges;
...
public class WebhookTeamEdited {
  ...
  **/
  ...
  public WebhookTeamEdited team(Team3 team) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookTeamEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookTeamEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookTeamEdited is not found in the empty JSON string", WebhookTeamEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookTeamEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookTeamEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookTeamEdited.openapiRequiredFields) {
      ...
      WebhookTeamEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookTeamEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookTeamEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookTeamEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookTeamEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookTeamEdited>() {
           @Override
           public void write(JsonWriter out, WebhookTeamEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookTeamEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookTeamEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookTeamEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookTeamEdited
  */
  public static WebhookTeamEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookTeamEdited.class);
  }

 /**
  * Convert an instance of WebhookTeamEdited to an JSON string
  *
  * @return JSON string
  */
