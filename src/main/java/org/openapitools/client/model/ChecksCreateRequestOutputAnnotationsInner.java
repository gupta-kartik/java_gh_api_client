...
public class ChecksCreateRequestOutputAnnotationsInner {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(path, startLine, endLine, startColumn, endColumn, annotationLevel, message, title, rawDetails);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChecksCreateRequestOutputAnnotationsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChecksCreateRequestOutputAnnotationsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ChecksCreateRequestOutputAnnotationsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChecksCreateRequestOutputAnnotationsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
