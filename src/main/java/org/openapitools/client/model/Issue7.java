...
import org.openapitools.client.model.App13;
...
public class Issue7 {
  ...
  private App13 performedViaGithubApp;
  ...
  **/
  ...
  public Issue7 assignee(User1 assignee) {
  ...
  **/
  ...
  public Issue7 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue7 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public Issue7 comments(Integer comments) {
  ...
  **/
  ...
  public Issue7 labels(List<Label> labels) {
  ...
  **/
  ...
  public Issue7 number(Integer number) {
  ...
  **/
  ...
  public Issue7 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue7 is not found in the empty JSON string", Issue7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue7` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue7.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App13.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue7.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue7>() {
           @Override
           public void write(JsonWriter out, Issue7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue7 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue7
  * @throws IOException if the JSON string is invalid with respect to Issue7
  */
  public static Issue7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue7.class);
  }

 /**
  * Convert an instance of Issue7 to an JSON string
  *
  * @return JSON string
  */
