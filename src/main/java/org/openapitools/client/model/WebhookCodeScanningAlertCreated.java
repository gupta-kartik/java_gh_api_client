...
import org.openapitools.client.model.WebhookCodeScanningAlertCreatedAlert;
...
public class WebhookCodeScanningAlertCreated {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertCreated is not found in the empty JSON string", WebhookCodeScanningAlertCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertCreated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertCreated.openapiRequiredFields) {
      ...
      WebhookCodeScanningAlertCreatedAlert.validateJsonObject(jsonObj.getAsJsonObject("alert"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertCreated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertCreated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertCreated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertCreated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertCreated>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertCreated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertCreated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertCreated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertCreated
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertCreated
  */
  public static WebhookCodeScanningAlertCreated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertCreated.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertCreated to an JSON string
  *
  * @return JSON string
  */
