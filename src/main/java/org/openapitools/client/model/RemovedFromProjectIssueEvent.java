...
public class RemovedFromProjectIssueEvent {
  ...
  public RemovedFromProjectIssueEvent id(Integer id) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RemovedFromProjectIssueEvent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RemovedFromProjectIssueEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemovedFromProjectIssueEvent is not found in the empty JSON string", RemovedFromProjectIssueEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RemovedFromProjectIssueEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemovedFromProjectIssueEvent` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemovedFromProjectIssueEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemovedFromProjectIssueEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemovedFromProjectIssueEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemovedFromProjectIssueEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemovedFromProjectIssueEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<RemovedFromProjectIssueEvent>() {
           @Override
           public void write(JsonWriter out, RemovedFromProjectIssueEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemovedFromProjectIssueEvent read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RemovedFromProjectIssueEvent given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RemovedFromProjectIssueEvent
  * @throws IOException if the JSON string is invalid with respect to RemovedFromProjectIssueEvent
  */
  public static RemovedFromProjectIssueEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemovedFromProjectIssueEvent.class);
  }

 /**
  * Convert an instance of RemovedFromProjectIssueEvent to an JSON string
  *
  * @return JSON string
  */
