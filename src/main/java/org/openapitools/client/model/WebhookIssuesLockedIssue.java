...
public class WebhookIssuesLockedIssue {
  /**
  ...
  public WebhookIssuesLockedIssue activeLockReason(ActiveLockReasonEnum activeLockReason) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue assignee(Object assignee) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue assignees(List<Object> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public WebhookIssuesLockedIssue addAssigneesItem(Object assigneesItem) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue authorAssociation(String authorAssociation) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue body(String body) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue closedAt(String closedAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue comments(Integer comments) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue commentsUrl(String commentsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue createdAt(String createdAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue draft(Boolean draft) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue eventsUrl(String eventsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue htmlUrl(String htmlUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue id(Integer id) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue labels(List<Object> labels) {
    
    this.labels = labels;
    return this;
  }

  public WebhookIssuesLockedIssue addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue labelsUrl(String labelsUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue locked(LockedEnum locked) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue milestone(Object milestone) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue nodeId(String nodeId) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue number(Integer number) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue performedViaGithubApp(Object performedViaGithubApp) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue pullRequest(IssuePullRequest pullRequest) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue reactions(WebhookDiscussionCreatedDiscussionAllOfReactions reactions) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue repositoryUrl(String repositoryUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue state(String state) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue stateReason(String stateReason) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue timelineUrl(String timelineUrl) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue title(String title) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue updatedAt(String updatedAt) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue url(String url) {
  ...
  **/
  ...
  public WebhookIssuesLockedIssue user(DeploymentWorkflowRunHeadRepositoryOwner user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookIssuesLockedIssue webhookIssuesLockedIssue = (WebhookIssuesLockedIssue) o;
    return Objects.equals(this.activeLockReason, webhookIssuesLockedIssue.activeLockReason) &&
        Objects.equals(this.assignee, webhookIssuesLockedIssue.assignee) &&
        Objects.equals(this.assignees, webhookIssuesLockedIssue.assignees) &&
        Objects.equals(this.authorAssociation, webhookIssuesLockedIssue.authorAssociation) &&
        Objects.equals(this.body, webhookIssuesLockedIssue.body) &&
        Objects.equals(this.closedAt, webhookIssuesLockedIssue.closedAt) &&
        Objects.equals(this.comments, webhookIssuesLockedIssue.comments) &&
        Objects.equals(this.commentsUrl, webhookIssuesLockedIssue.commentsUrl) &&
        Objects.equals(this.createdAt, webhookIssuesLockedIssue.createdAt) &&
        Objects.equals(this.draft, webhookIssuesLockedIssue.draft) &&
        Objects.equals(this.eventsUrl, webhookIssuesLockedIssue.eventsUrl) &&
        Objects.equals(this.htmlUrl, webhookIssuesLockedIssue.htmlUrl) &&
        Objects.equals(this.id, webhookIssuesLockedIssue.id) &&
        Objects.equals(this.labels, webhookIssuesLockedIssue.labels) &&
        Objects.equals(this.labelsUrl, webhookIssuesLockedIssue.labelsUrl) &&
        Objects.equals(this.locked, webhookIssuesLockedIssue.locked) &&
        Objects.equals(this.milestone, webhookIssuesLockedIssue.milestone) &&
        Objects.equals(this.nodeId, webhookIssuesLockedIssue.nodeId) &&
        Objects.equals(this.number, webhookIssuesLockedIssue.number) &&
        Objects.equals(this.performedViaGithubApp, webhookIssuesLockedIssue.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, webhookIssuesLockedIssue.pullRequest) &&
        Objects.equals(this.reactions, webhookIssuesLockedIssue.reactions) &&
        Objects.equals(this.repositoryUrl, webhookIssuesLockedIssue.repositoryUrl) &&
        Objects.equals(this.state, webhookIssuesLockedIssue.state) &&
        Objects.equals(this.stateReason, webhookIssuesLockedIssue.stateReason) &&
        Objects.equals(this.timelineUrl, webhookIssuesLockedIssue.timelineUrl) &&
        Objects.equals(this.title, webhookIssuesLockedIssue.title) &&
        Objects.equals(this.updatedAt, webhookIssuesLockedIssue.updatedAt) &&
        Objects.equals(this.url, webhookIssuesLockedIssue.url) &&
        Objects.equals(this.user, webhookIssuesLockedIssue.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookIssuesLockedIssue {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesLockedIssue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesLockedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesLockedIssue is not found in the empty JSON string", WebhookIssuesLockedIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesLockedIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesLockedIssue` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesLockedIssue.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesLockedIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesLockedIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesLockedIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesLockedIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesLockedIssue>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesLockedIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesLockedIssue read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesLockedIssue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesLockedIssue
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesLockedIssue
  */
  public static WebhookIssuesLockedIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesLockedIssue.class);
  }

 /**
  * Convert an instance of WebhookIssuesLockedIssue to an JSON string
  *
  * @return JSON string
  */
