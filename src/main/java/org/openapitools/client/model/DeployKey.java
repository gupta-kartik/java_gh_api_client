...
public class DeployKey {
  ...
  **/
  ...
  public DeployKey lastUsed(String lastUsed) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeployKey
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeployKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeployKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeployKey` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
