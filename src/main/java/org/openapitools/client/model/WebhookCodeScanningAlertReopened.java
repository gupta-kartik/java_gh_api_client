...
import org.openapitools.client.model.WebhookCodeScanningAlertReopenedAlert;
...
public class WebhookCodeScanningAlertReopened {
  ...
  **/
  ...
  public WebhookCodeScanningAlertReopened enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookCodeScanningAlertReopened organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookCodeScanningAlertReopened repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCodeScanningAlertReopened
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCodeScanningAlertReopened.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCodeScanningAlertReopened is not found in the empty JSON string", WebhookCodeScanningAlertReopened.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookCodeScanningAlertReopened.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookCodeScanningAlertReopened` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCodeScanningAlertReopened.openapiRequiredFields) {
      ...
      WebhookCodeScanningAlertReopenedAlert.validateJsonObject(jsonObj.getAsJsonObject("alert"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCodeScanningAlertReopened.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCodeScanningAlertReopened' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCodeScanningAlertReopened> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCodeScanningAlertReopened.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCodeScanningAlertReopened>() {
           @Override
           public void write(JsonWriter out, WebhookCodeScanningAlertReopened value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookCodeScanningAlertReopened read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookCodeScanningAlertReopened given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCodeScanningAlertReopened
  * @throws IOException if the JSON string is invalid with respect to WebhookCodeScanningAlertReopened
  */
  public static WebhookCodeScanningAlertReopened fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCodeScanningAlertReopened.class);
  }

 /**
  * Convert an instance of WebhookCodeScanningAlertReopened to an JSON string
  *
  * @return JSON string
  */
