...
public class Repository1 {
  ...
  **/
  ...
  public Repository1 forks(Integer forks) {
  ...
  **/
  ...
  public Repository1 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository1 id(Integer id) {
  ...
  **/
  ...
  public Repository1 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository1 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository1 size(Integer size) {
  ...
  **/
  ...
  public Repository1 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository1 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository1 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository1 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository1 is not found in the empty JSON string", Repository1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository1.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository1>() {
           @Override
           public void write(JsonWriter out, Repository1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository1
  * @throws IOException if the JSON string is invalid with respect to Repository1
  */
  public static Repository1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository1.class);
  }

 /**
  * Convert an instance of Repository1 to an JSON string
  *
  * @return JSON string
  */
