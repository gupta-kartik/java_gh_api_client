...
public class SocialAccount {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.provider, socialAccount.provider) &&
        Objects.equals(this.url, socialAccount.url);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SocialAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SocialAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SocialAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SocialAccount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
