...
public class RepositoryAdvisoryUpdate {
  ...
  private List<RepositoryAdvisoryCreateVulnerabilitiesInner> vulnerabilities;
  ...
  **/
  ...
  public RepositoryAdvisoryUpdate vulnerabilities(List<RepositoryAdvisoryCreateVulnerabilitiesInner> vulnerabilities) {
    
    this.vulnerabilities = vulnerabilities;
    return this;
  }

  public RepositoryAdvisoryUpdate addVulnerabilitiesItem(RepositoryAdvisoryCreateVulnerabilitiesInner vulnerabilitiesItem) {
  ...
  **/
  ...
  public RepositoryAdvisoryUpdate credits(List<RepositoryAdvisoryCreateCreditsInner> credits) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(summary, description, cveId, vulnerabilities, cweIds, credits, severity, cvssVectorString, state);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryAdvisoryUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryAdvisoryUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryAdvisoryUpdate is not found in the empty JSON string", RepositoryAdvisoryUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RepositoryAdvisoryUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryAdvisoryUpdate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryAdvisoryUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryAdvisoryUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryAdvisoryUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryAdvisoryUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryAdvisoryUpdate>() {
           @Override
           public void write(JsonWriter out, RepositoryAdvisoryUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryAdvisoryUpdate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RepositoryAdvisoryUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryAdvisoryUpdate
  * @throws IOException if the JSON string is invalid with respect to RepositoryAdvisoryUpdate
  */
  public static RepositoryAdvisoryUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryAdvisoryUpdate.class);
  }

 /**
  * Convert an instance of RepositoryAdvisoryUpdate to an JSON string
  *
  * @return JSON string
  */
