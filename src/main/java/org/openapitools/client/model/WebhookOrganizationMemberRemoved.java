...
public class WebhookOrganizationMemberRemoved {
  ...
  **/
  ...
  public WebhookOrganizationMemberRemoved enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookOrganizationMemberRemoved membership(Membership membership) {
  ...
  **/
  ...
  public WebhookOrganizationMemberRemoved organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookOrganizationMemberRemoved repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookOrganizationMemberRemoved
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookOrganizationMemberRemoved.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookOrganizationMemberRemoved is not found in the empty JSON string", WebhookOrganizationMemberRemoved.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookOrganizationMemberRemoved.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookOrganizationMemberRemoved` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookOrganizationMemberRemoved.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookOrganizationMemberRemoved.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookOrganizationMemberRemoved' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookOrganizationMemberRemoved> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookOrganizationMemberRemoved.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookOrganizationMemberRemoved>() {
           @Override
           public void write(JsonWriter out, WebhookOrganizationMemberRemoved value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookOrganizationMemberRemoved read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookOrganizationMemberRemoved given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookOrganizationMemberRemoved
  * @throws IOException if the JSON string is invalid with respect to WebhookOrganizationMemberRemoved
  */
  public static WebhookOrganizationMemberRemoved fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookOrganizationMemberRemoved.class);
  }

 /**
  * Convert an instance of WebhookOrganizationMemberRemoved to an JSON string
  *
  * @return JSON string
  */
