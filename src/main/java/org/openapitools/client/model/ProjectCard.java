...
public class ProjectCard {
  ...
  public ProjectCard afterId(Integer afterId) {
  ...
  **/
  ...
  public ProjectCard columnId(Integer columnId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProjectCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
