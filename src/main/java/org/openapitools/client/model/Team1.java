...
public class Team1 {
  ...
  **/
  ...
  public Team1 parent(Team1Parent parent) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Team1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Team1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
