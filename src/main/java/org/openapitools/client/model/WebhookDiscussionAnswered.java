...
public class WebhookDiscussionAnswered {
  ...
  private WebhookDiscussionAnsweredAnswer answer;
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookDiscussionAnswered
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookDiscussionAnswered.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDiscussionAnswered is not found in the empty JSON string", WebhookDiscussionAnswered.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookDiscussionAnswered.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookDiscussionAnswered` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookDiscussionAnswered.openapiRequiredFields) {
      ...
      WebhookDiscussionAnsweredAnswer.validateJsonObject(jsonObj.getAsJsonObject("answer"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookDiscussionAnswered.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookDiscussionAnswered' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookDiscussionAnswered> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookDiscussionAnswered.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookDiscussionAnswered>() {
           @Override
           public void write(JsonWriter out, WebhookDiscussionAnswered value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookDiscussionAnswered read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookDiscussionAnswered given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookDiscussionAnswered
  * @throws IOException if the JSON string is invalid with respect to WebhookDiscussionAnswered
  */
  public static WebhookDiscussionAnswered fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookDiscussionAnswered.class);
  }

 /**
  * Convert an instance of WebhookDiscussionAnswered to an JSON string
  *
  * @return JSON string
  */
