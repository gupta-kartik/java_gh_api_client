...
public class GitCreateCommitRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GitCreateCommitRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GitCreateCommitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GitCreateCommitRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GitCreateCommitRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("parents") != null && !jsonObj.get("parents").isJsonArray()) {
      ...
      if (jsonObj.get("author") != null && !jsonObj.get("author").isJsonNull()) {
        GitCreateCommitRequestAuthor.validateJsonObject(jsonObj.getAsJsonObject("author"));
      }
      // validate the optional field `committer`
      if (jsonObj.get("committer") != null && !jsonObj.get("committer").isJsonNull()) {
        GitCreateCommitRequestCommitter.validateJsonObject(jsonObj.getAsJsonObject("committer"));
      }
