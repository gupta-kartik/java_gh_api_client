...
public class WebhookMemberRemoved {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookMemberRemoved
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookMemberRemoved.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookMemberRemoved is not found in the empty JSON string", WebhookMemberRemoved.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookMemberRemoved.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookMemberRemoved` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookMemberRemoved.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookMemberRemoved.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookMemberRemoved' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookMemberRemoved> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookMemberRemoved.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookMemberRemoved>() {
           @Override
           public void write(JsonWriter out, WebhookMemberRemoved value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookMemberRemoved read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookMemberRemoved given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookMemberRemoved
  * @throws IOException if the JSON string is invalid with respect to WebhookMemberRemoved
  */
  public static WebhookMemberRemoved fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookMemberRemoved.class);
  }

 /**
  * Convert an instance of WebhookMemberRemoved to an JSON string
  *
  * @return JSON string
  */
