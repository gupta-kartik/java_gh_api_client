...
import org.openapitools.client.model.PullRequest3;
...
public class WebhookPullRequestDemilestoned {
  ...
  **/
  ...
  public WebhookPullRequestDemilestoned number(Integer number) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestDemilestoned
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestDemilestoned.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestDemilestoned is not found in the empty JSON string", WebhookPullRequestDemilestoned.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestDemilestoned.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestDemilestoned` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestDemilestoned.openapiRequiredFields) {
      ...
      PullRequest3.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestDemilestoned.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestDemilestoned' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestDemilestoned> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestDemilestoned.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestDemilestoned>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestDemilestoned value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestDemilestoned read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestDemilestoned given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestDemilestoned
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestDemilestoned
  */
  public static WebhookPullRequestDemilestoned fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestDemilestoned.class);
  }

 /**
  * Convert an instance of WebhookPullRequestDemilestoned to an JSON string
  *
  * @return JSON string
  */
