...
public class WebhookIssuesUnlabeled {
  ...
  **/
  ...
  public WebhookIssuesUnlabeled issue(Issue2 issue) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookIssuesUnlabeled
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookIssuesUnlabeled.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookIssuesUnlabeled is not found in the empty JSON string", WebhookIssuesUnlabeled.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookIssuesUnlabeled.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookIssuesUnlabeled` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookIssuesUnlabeled.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookIssuesUnlabeled.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookIssuesUnlabeled' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookIssuesUnlabeled> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookIssuesUnlabeled.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookIssuesUnlabeled>() {
           @Override
           public void write(JsonWriter out, WebhookIssuesUnlabeled value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookIssuesUnlabeled read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookIssuesUnlabeled given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookIssuesUnlabeled
  * @throws IOException if the JSON string is invalid with respect to WebhookIssuesUnlabeled
  */
  public static WebhookIssuesUnlabeled fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookIssuesUnlabeled.class);
  }

 /**
  * Convert an instance of WebhookIssuesUnlabeled to an JSON string
  *
  * @return JSON string
  */
