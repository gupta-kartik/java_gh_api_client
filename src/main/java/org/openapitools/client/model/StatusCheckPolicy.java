...
public class StatusCheckPolicy {
  ...
  private List<StatusCheckPolicyChecksInner> checks = new ArrayList<>();
  ...
  **/
  ...
  public StatusCheckPolicy checks(List<StatusCheckPolicyChecksInner> checks) {
  ...
  **/
  ...
  public List<StatusCheckPolicyChecksInner> getChecks() {
    return checks;
  }


  public void setChecks(List<StatusCheckPolicyChecksInner> checks) {
    this.checks = checks;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatusCheckPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatusCheckPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!StatusCheckPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusCheckPolicy` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraychecks.size(); i++) {
        StatusCheckPolicyChecksInner.validateJsonObject(jsonArraychecks.get(i).getAsJsonObject());
      };
