...
public class WebhookPullRequestEditedPullRequestAllOf {
  ...
  public WebhookPullRequestEditedPullRequestAllOf() {
  }

  public WebhookPullRequestEditedPullRequestAllOf allowAutoMerge(Boolean allowAutoMerge) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf allowUpdateBranch(Boolean allowUpdateBranch) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf mergeCommitMessage(MergeCommitMessageEnum mergeCommitMessage) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf mergeCommitTitle(MergeCommitTitleEnum mergeCommitTitle) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf squashMergeCommitMessage(SquashMergeCommitMessageEnum squashMergeCommitMessage) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf squashMergeCommitTitle(SquashMergeCommitTitleEnum squashMergeCommitTitle) {
  ...
  **/
  ...
  public WebhookPullRequestEditedPullRequestAllOf useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPullRequestEditedPullRequestAllOf webhookPullRequestEditedPullRequestAllOf = (WebhookPullRequestEditedPullRequestAllOf) o;
    return Objects.equals(this.allowAutoMerge, webhookPullRequestEditedPullRequestAllOf.allowAutoMerge) &&
        Objects.equals(this.allowUpdateBranch, webhookPullRequestEditedPullRequestAllOf.allowUpdateBranch) &&
        Objects.equals(this.deleteBranchOnMerge, webhookPullRequestEditedPullRequestAllOf.deleteBranchOnMerge) &&
        Objects.equals(this.mergeCommitMessage, webhookPullRequestEditedPullRequestAllOf.mergeCommitMessage) &&
        Objects.equals(this.mergeCommitTitle, webhookPullRequestEditedPullRequestAllOf.mergeCommitTitle) &&
        Objects.equals(this.squashMergeCommitMessage, webhookPullRequestEditedPullRequestAllOf.squashMergeCommitMessage) &&
        Objects.equals(this.squashMergeCommitTitle, webhookPullRequestEditedPullRequestAllOf.squashMergeCommitTitle) &&
        Objects.equals(this.useSquashPrTitleAsDefault, webhookPullRequestEditedPullRequestAllOf.useSquashPrTitleAsDefault);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookPullRequestEditedPullRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestEditedPullRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestEditedPullRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestEditedPullRequestAllOf is not found in the empty JSON string", WebhookPullRequestEditedPullRequestAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestEditedPullRequestAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestEditedPullRequestAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestEditedPullRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestEditedPullRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestEditedPullRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestEditedPullRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestEditedPullRequestAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestEditedPullRequestAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestEditedPullRequestAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestEditedPullRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestEditedPullRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestEditedPullRequestAllOf
  */
  public static WebhookPullRequestEditedPullRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestEditedPullRequestAllOf.class);
  }

 /**
  * Convert an instance of WebhookPullRequestEditedPullRequestAllOf to an JSON string
  *
  * @return JSON string
  */
