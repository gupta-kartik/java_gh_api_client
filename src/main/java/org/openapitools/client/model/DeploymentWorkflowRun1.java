...
public class DeploymentWorkflowRun1 {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 checkSuiteId(Integer checkSuiteId) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 id(Integer id) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 pullRequests(List<CheckRunPullRequest> pullRequests) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 referencedWorkflows(List<DeploymentWorkflowRunReferencedWorkflowsInner> referencedWorkflows) {
    
    this.referencedWorkflows = referencedWorkflows;
    return this;
  }

  public DeploymentWorkflowRun1 addReferencedWorkflowsItem(DeploymentWorkflowRunReferencedWorkflowsInner referencedWorkflowsItem) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 runNumber(Integer runNumber) {
  ...
  **/
  ...
  public DeploymentWorkflowRun1 workflowId(Integer workflowId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeploymentWorkflowRun1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeploymentWorkflowRun1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeploymentWorkflowRun1 is not found in the empty JSON string", DeploymentWorkflowRun1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DeploymentWorkflowRun1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeploymentWorkflowRun1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeploymentWorkflowRun1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeploymentWorkflowRun1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeploymentWorkflowRun1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeploymentWorkflowRun1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeploymentWorkflowRun1.class));

       return (TypeAdapter<T>) new TypeAdapter<DeploymentWorkflowRun1>() {
           @Override
           public void write(JsonWriter out, DeploymentWorkflowRun1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeploymentWorkflowRun1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DeploymentWorkflowRun1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeploymentWorkflowRun1
  * @throws IOException if the JSON string is invalid with respect to DeploymentWorkflowRun1
  */
  public static DeploymentWorkflowRun1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeploymentWorkflowRun1.class);
  }

 /**
  * Convert an instance of DeploymentWorkflowRun1 to an JSON string
  *
  * @return JSON string
  */
