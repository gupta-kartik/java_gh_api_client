...
import org.openapitools.client.model.WebhookWorkflowJobQueuedWorkflowJob;
...
public class WebhookWorkflowJobQueued {
  ...
  **/
  ...
  public WebhookWorkflowJobQueued enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookWorkflowJobQueued organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookWorkflowJobQueued repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookWorkflowJobQueued
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookWorkflowJobQueued.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookWorkflowJobQueued is not found in the empty JSON string", WebhookWorkflowJobQueued.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookWorkflowJobQueued.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookWorkflowJobQueued` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookWorkflowJobQueued.openapiRequiredFields) {
      ...
      WebhookWorkflowJobQueuedWorkflowJob.validateJsonObject(jsonObj.getAsJsonObject("workflow_job"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookWorkflowJobQueued.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookWorkflowJobQueued' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookWorkflowJobQueued> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookWorkflowJobQueued.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookWorkflowJobQueued>() {
           @Override
           public void write(JsonWriter out, WebhookWorkflowJobQueued value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookWorkflowJobQueued read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookWorkflowJobQueued given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookWorkflowJobQueued
  * @throws IOException if the JSON string is invalid with respect to WebhookWorkflowJobQueued
  */
  public static WebhookWorkflowJobQueued fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookWorkflowJobQueued.class);
  }

 /**
  * Convert an instance of WebhookWorkflowJobQueued to an JSON string
  *
  * @return JSON string
  */
