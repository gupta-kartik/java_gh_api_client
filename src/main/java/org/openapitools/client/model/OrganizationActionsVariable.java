...
public class OrganizationActionsVariable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrganizationActionsVariable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrganizationActionsVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationActionsVariable is not found in the empty JSON string", OrganizationActionsVariable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OrganizationActionsVariable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationActionsVariable` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrganizationActionsVariable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationActionsVariable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationActionsVariable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationActionsVariable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationActionsVariable.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationActionsVariable>() {
           @Override
           public void write(JsonWriter out, OrganizationActionsVariable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationActionsVariable read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OrganizationActionsVariable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationActionsVariable
  * @throws IOException if the JSON string is invalid with respect to OrganizationActionsVariable
  */
  public static OrganizationActionsVariable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationActionsVariable.class);
  }

 /**
  * Convert an instance of OrganizationActionsVariable to an JSON string
  *
  * @return JSON string
  */
