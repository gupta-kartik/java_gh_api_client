...
public class ReposUpdateRepoRulesetRequest {
  ...
  **/
  ...
  public ReposUpdateRepoRulesetRequest bypassMode(BypassModeEnum bypassMode) {
  ...
  **/
  ...
  public ReposUpdateRepoRulesetRequest bypassActors(List<RepositoryRulesetBypassActor> bypassActors) {
  ...
  **/
  ...
  public ReposUpdateRepoRulesetRequest rules(List<RepositoryRule> rules) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, reposUpdateRepoRulesetRequest.name) &&
        ...
        Objects.equals(this.bypassMode, reposUpdateRepoRulesetRequest.bypassMode) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReposUpdateRepoRulesetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReposUpdateRepoRulesetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReposUpdateRepoRulesetRequest is not found in the empty JSON string", ReposUpdateRepoRulesetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReposUpdateRepoRulesetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposUpdateRepoRulesetRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReposUpdateRepoRulesetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReposUpdateRepoRulesetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReposUpdateRepoRulesetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReposUpdateRepoRulesetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReposUpdateRepoRulesetRequest>() {
           @Override
           public void write(JsonWriter out, ReposUpdateRepoRulesetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReposUpdateRepoRulesetRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReposUpdateRepoRulesetRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReposUpdateRepoRulesetRequest
  * @throws IOException if the JSON string is invalid with respect to ReposUpdateRepoRulesetRequest
  */
  public static ReposUpdateRepoRulesetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReposUpdateRepoRulesetRequest.class);
  }

 /**
  * Convert an instance of ReposUpdateRepoRulesetRequest to an JSON string
  *
  * @return JSON string
  */
