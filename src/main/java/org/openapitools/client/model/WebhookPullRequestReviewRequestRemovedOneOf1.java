...
public class WebhookPullRequestReviewRequestRemovedOneOf1 {
  /**
   * Gets or Sets action
   */
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf1 enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf1 number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf1 organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf1 pullRequest(PullRequest8 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestReviewRequestRemovedOneOf1 repository(Repository repository) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPullRequestReviewRequestRemovedOneOf1 webhookPullRequestReviewRequestRemovedOneOf1 = (WebhookPullRequestReviewRequestRemovedOneOf1) o;
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestReviewRequestRemovedOneOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestReviewRequestRemovedOneOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestReviewRequestRemovedOneOf1 is not found in the empty JSON string", WebhookPullRequestReviewRequestRemovedOneOf1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestReviewRequestRemovedOneOf1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestReviewRequestRemovedOneOf1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestReviewRequestRemovedOneOf1.openapiRequiredFields) {
      ...
      PullRequest8.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
      ...
      Team1.validateJsonObject(jsonObj.getAsJsonObject("requested_team"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestReviewRequestRemovedOneOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestReviewRequestRemovedOneOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestReviewRequestRemovedOneOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestReviewRequestRemovedOneOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestReviewRequestRemovedOneOf1>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestReviewRequestRemovedOneOf1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestReviewRequestRemovedOneOf1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestReviewRequestRemovedOneOf1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestReviewRequestRemovedOneOf1
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestReviewRequestRemovedOneOf1
  */
  public static WebhookPullRequestReviewRequestRemovedOneOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestReviewRequestRemovedOneOf1.class);
  }

 /**
  * Convert an instance of WebhookPullRequestReviewRequestRemovedOneOf1 to an JSON string
  *
  * @return JSON string
  */
