...
public class InstallationAccount extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<InstallationAccount>() {
                ...
                public InstallationAccount read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for InstallationAccount: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public InstallationAccount(Enterprise o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public InstallationAccount(SimpleUser o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstallationAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for InstallationAccount with anyOf schemas: Enterprise, SimpleUser. JSON: %s", jsonObj.toString()));
    }
  }
