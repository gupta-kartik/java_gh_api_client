...
import org.openapitools.client.model.App11;
...
public class Issue5 {
  ...
  private App11 performedViaGithubApp;
  ...
  **/
  ...
  public Issue5 assignee(User1 assignee) {
  ...
  **/
  ...
  public Issue5 assignees(List<User1> assignees) {
    
    this.assignees = assignees;
    return this;
  }

  public Issue5 addAssigneesItem(User1 assigneesItem) {
  ...
  **/
  ...
  public Issue5 comments(Integer comments) {
  ...
  **/
  ...
  public Issue5 labels(List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public Issue5 addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  **/
  ...
  public Issue5 number(Integer number) {
  ...
  **/
  ...
  public Issue5 performedViaGithubApp(App11 performedViaGithubApp) {
  ...
  **/
  ...
  public Issue5 pullRequest(IssuePullRequest pullRequest) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Issue5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Issue5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Issue5 is not found in the empty JSON string", Issue5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Issue5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Issue5` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Issue5.openapiRequiredFields) {
      ...
      if (jsonObj.get("performed_via_github_app") != null && !jsonObj.get("performed_via_github_app").isJsonNull()) {
        App11.validateJsonObject(jsonObj.getAsJsonObject("performed_via_github_app"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Issue5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Issue5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Issue5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Issue5.class));

       return (TypeAdapter<T>) new TypeAdapter<Issue5>() {
           @Override
           public void write(JsonWriter out, Issue5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Issue5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Issue5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Issue5
  * @throws IOException if the JSON string is invalid with respect to Issue5
  */
  public static Issue5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Issue5.class);
  }

 /**
  * Convert an instance of Issue5 to an JSON string
  *
  * @return JSON string
  */
