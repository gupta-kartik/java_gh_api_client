...
import org.openapitools.client.model.WebhookProjectsV2ItemConvertedChanges;
...
public class WebhookProjectsV2ItemConverted {
  ...
  **/
  ...
  public WebhookProjectsV2ItemConverted organization(OrganizationSimple organization) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookProjectsV2ItemConverted
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookProjectsV2ItemConverted.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookProjectsV2ItemConverted is not found in the empty JSON string", WebhookProjectsV2ItemConverted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookProjectsV2ItemConverted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookProjectsV2ItemConverted` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookProjectsV2ItemConverted.openapiRequiredFields) {
      ...
      WebhookProjectsV2ItemConvertedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookProjectsV2ItemConverted.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookProjectsV2ItemConverted' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookProjectsV2ItemConverted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookProjectsV2ItemConverted.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookProjectsV2ItemConverted>() {
           @Override
           public void write(JsonWriter out, WebhookProjectsV2ItemConverted value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookProjectsV2ItemConverted read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookProjectsV2ItemConverted given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookProjectsV2ItemConverted
  * @throws IOException if the JSON string is invalid with respect to WebhookProjectsV2ItemConverted
  */
  public static WebhookProjectsV2ItemConverted fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookProjectsV2ItemConverted.class);
  }

 /**
  * Convert an instance of WebhookProjectsV2ItemConverted to an JSON string
  *
  * @return JSON string
  */
