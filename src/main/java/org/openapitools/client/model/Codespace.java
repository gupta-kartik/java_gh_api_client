...
public class Codespace {
  ...
  public static final String SERIALIZED_NAME_LAST_KNOWN_STOP_NOTICE = "last_known_stop_notice";
  @SerializedName(SERIALIZED_NAME_LAST_KNOWN_STOP_NOTICE)
  private String lastKnownStopNotice;

  public Codespace() {
  }

  public Codespace id(Integer id) {
  ...
  **/
  ...
  public Codespace idleTimeoutMinutes(Integer idleTimeoutMinutes) {
  ...
  **/
  ...
  public Codespace retentionPeriodMinutes(Integer retentionPeriodMinutes) {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("last_known_stop_notice");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Codespace
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Codespace.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Codespace is not found in the empty JSON string", Codespace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Codespace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Codespace` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Codespace.openapiRequiredFields) {
      ...
      if ((jsonObj.get("last_known_stop_notice") != null && !jsonObj.get("last_known_stop_notice").isJsonNull()) && !jsonObj.get("last_known_stop_notice").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `last_known_stop_notice` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_known_stop_notice").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Codespace.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Codespace' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Codespace> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Codespace.class));

       return (TypeAdapter<T>) new TypeAdapter<Codespace>() {
           @Override
           public void write(JsonWriter out, Codespace value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Codespace read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Codespace given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Codespace
  * @throws IOException if the JSON string is invalid with respect to Codespace
  */
  public static Codespace fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Codespace.class);
  }

 /**
  * Convert an instance of Codespace to an JSON string
  *
  * @return JSON string
  */
