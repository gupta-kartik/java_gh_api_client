...
import org.openapitools.client.model.WebhookWorkflowJobInProgressWorkflowJob;
...
public class WebhookWorkflowJobInProgress {
  ...
  **/
  ...
  public WebhookWorkflowJobInProgress enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookWorkflowJobInProgress organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookWorkflowJobInProgress repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookWorkflowJobInProgress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookWorkflowJobInProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookWorkflowJobInProgress is not found in the empty JSON string", WebhookWorkflowJobInProgress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookWorkflowJobInProgress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookWorkflowJobInProgress` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookWorkflowJobInProgress.openapiRequiredFields) {
      ...
      WebhookWorkflowJobInProgressWorkflowJob.validateJsonObject(jsonObj.getAsJsonObject("workflow_job"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookWorkflowJobInProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookWorkflowJobInProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookWorkflowJobInProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookWorkflowJobInProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookWorkflowJobInProgress>() {
           @Override
           public void write(JsonWriter out, WebhookWorkflowJobInProgress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookWorkflowJobInProgress read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookWorkflowJobInProgress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookWorkflowJobInProgress
  * @throws IOException if the JSON string is invalid with respect to WebhookWorkflowJobInProgress
  */
  public static WebhookWorkflowJobInProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookWorkflowJobInProgress.class);
  }

 /**
  * Convert an instance of WebhookWorkflowJobInProgress to an JSON string
  *
  * @return JSON string
  */
