...
import org.openapitools.client.model.WorkflowRun2;
...
public class WebhookWorkflowRunRequested {
  ...
  **/
  ...
  public WebhookWorkflowRunRequested enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookWorkflowRunRequested organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookWorkflowRunRequested repository(Repository repository) {
  ...
  **/
  ...
  public WebhookWorkflowRunRequested workflow(Workflow workflow) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookWorkflowRunRequested
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookWorkflowRunRequested.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookWorkflowRunRequested is not found in the empty JSON string", WebhookWorkflowRunRequested.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookWorkflowRunRequested.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookWorkflowRunRequested` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookWorkflowRunRequested.openapiRequiredFields) {
      ...
      WorkflowRun2.validateJsonObject(jsonObj.getAsJsonObject("workflow_run"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookWorkflowRunRequested.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookWorkflowRunRequested' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookWorkflowRunRequested> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookWorkflowRunRequested.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookWorkflowRunRequested>() {
           @Override
           public void write(JsonWriter out, WebhookWorkflowRunRequested value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookWorkflowRunRequested read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookWorkflowRunRequested given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookWorkflowRunRequested
  * @throws IOException if the JSON string is invalid with respect to WebhookWorkflowRunRequested
  */
  public static WebhookWorkflowRunRequested fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookWorkflowRunRequested.class);
  }

 /**
  * Convert an instance of WebhookWorkflowRunRequested to an JSON string
  *
  * @return JSON string
  */
