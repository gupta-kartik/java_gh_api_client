...
import org.openapitools.client.model.WebhookRegistryPackageUpdatedRegistryPackage;
...
public class WebhookRegistryPackageUpdated {
  ...
  public WebhookRegistryPackageUpdated action(String action) {
  ...
  **/
  ...
  public WebhookRegistryPackageUpdated enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookRegistryPackageUpdated organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookRegistryPackageUpdated repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookRegistryPackageUpdated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookRegistryPackageUpdated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookRegistryPackageUpdated is not found in the empty JSON string", WebhookRegistryPackageUpdated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookRegistryPackageUpdated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookRegistryPackageUpdated` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookRegistryPackageUpdated.openapiRequiredFields) {
      ...
      WebhookRegistryPackageUpdatedRegistryPackage.validateJsonObject(jsonObj.getAsJsonObject("registry_package"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookRegistryPackageUpdated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookRegistryPackageUpdated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookRegistryPackageUpdated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookRegistryPackageUpdated.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookRegistryPackageUpdated>() {
           @Override
           public void write(JsonWriter out, WebhookRegistryPackageUpdated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookRegistryPackageUpdated read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookRegistryPackageUpdated given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookRegistryPackageUpdated
  * @throws IOException if the JSON string is invalid with respect to WebhookRegistryPackageUpdated
  */
  public static WebhookRegistryPackageUpdated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookRegistryPackageUpdated.class);
  }

 /**
  * Convert an instance of WebhookRegistryPackageUpdated to an JSON string
  *
  * @return JSON string
  */
