...
public class WebhookTeamRemovedFromRepository {
  ...
  **/
  ...
  public WebhookTeamRemovedFromRepository enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookTeamRemovedFromRepository organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookTeamRemovedFromRepository repository(Repository1 repository) {
  ...
  **/
  ...
  public WebhookTeamRemovedFromRepository team(Team3 team) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookTeamRemovedFromRepository
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookTeamRemovedFromRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookTeamRemovedFromRepository is not found in the empty JSON string", WebhookTeamRemovedFromRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookTeamRemovedFromRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookTeamRemovedFromRepository` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookTeamRemovedFromRepository.openapiRequiredFields) {
      ...
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        Repository1.validateJsonObject(jsonObj.getAsJsonObject("repository"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookTeamRemovedFromRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookTeamRemovedFromRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookTeamRemovedFromRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookTeamRemovedFromRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookTeamRemovedFromRepository>() {
           @Override
           public void write(JsonWriter out, WebhookTeamRemovedFromRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookTeamRemovedFromRepository read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookTeamRemovedFromRepository given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookTeamRemovedFromRepository
  * @throws IOException if the JSON string is invalid with respect to WebhookTeamRemovedFromRepository
  */
  public static WebhookTeamRemovedFromRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookTeamRemovedFromRepository.class);
  }

 /**
  * Convert an instance of WebhookTeamRemovedFromRepository to an JSON string
  *
  * @return JSON string
  */
