...
public class WorkflowRun2 {
  ...
  **/
  ...
  public WorkflowRun2 checkSuiteId(Integer checkSuiteId) {
  ...
  **/
  ...
  public WorkflowRun2 id(Integer id) {
  ...
  **/
  ...
  public WorkflowRun2 pullRequests(List<WorkflowRunPullRequestsInner> pullRequests) {
    
    this.pullRequests = pullRequests;
    return this;
  }

  public WorkflowRun2 addPullRequestsItem(WorkflowRunPullRequestsInner pullRequestsItem) {
  ...
  **/
  ...
  public WorkflowRun2 referencedWorkflows(List<DeploymentWorkflowRunReferencedWorkflowsInner> referencedWorkflows) {
    
    this.referencedWorkflows = referencedWorkflows;
    return this;
  }

  public WorkflowRun2 addReferencedWorkflowsItem(DeploymentWorkflowRunReferencedWorkflowsInner referencedWorkflowsItem) {
  ...
  **/
  ...
  public WorkflowRun2 runAttempt(Integer runAttempt) {
  ...
  **/
  ...
  public WorkflowRun2 runNumber(Integer runNumber) {
  ...
  **/
  ...
  public WorkflowRun2 workflowId(Integer workflowId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowRun2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowRun2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowRun2 is not found in the empty JSON string", WorkflowRun2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowRun2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowRun2` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WorkflowRun2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowRun2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowRun2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowRun2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowRun2.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowRun2>() {
           @Override
           public void write(JsonWriter out, WorkflowRun2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowRun2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowRun2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowRun2
  * @throws IOException if the JSON string is invalid with respect to WorkflowRun2
  */
  public static WorkflowRun2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowRun2.class);
  }

 /**
  * Convert an instance of WorkflowRun2 to an JSON string
  *
  * @return JSON string
  */
