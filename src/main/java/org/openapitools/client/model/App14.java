...
import org.openapitools.client.model.App3Permissions;
...
public class App14 {
  ...
  **/
  ...
  public App14 permissions(App3Permissions permissions) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to App14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!App14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in App14 is not found in the empty JSON string", App14.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!App14.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `App14` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : App14.openapiRequiredFields) {
      ...
      if (jsonObj.get("permissions") != null && !jsonObj.get("permissions").isJsonNull()) {
        App3Permissions.validateJsonObject(jsonObj.getAsJsonObject("permissions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!App14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'App14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<App14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(App14.class));

       return (TypeAdapter<T>) new TypeAdapter<App14>() {
           @Override
           public void write(JsonWriter out, App14 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public App14 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of App14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of App14
  * @throws IOException if the JSON string is invalid with respect to App14
  */
  public static App14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, App14.class);
  }

 /**
  * Convert an instance of App14 to an JSON string
  *
  * @return JSON string
  */
