...
import org.openapitools.client.model.SimplePullRequest1;
import org.openapitools.client.model.SimpleUser;
import org.openapitools.client.model.WebhookPullRequestReviewEditedChanges;
...
public class WebhookPullRequestReviewEdited {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestReviewEdited
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestReviewEdited.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestReviewEdited is not found in the empty JSON string", WebhookPullRequestReviewEdited.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestReviewEdited.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestReviewEdited` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestReviewEdited.openapiRequiredFields) {
      ...
      WebhookPullRequestReviewEditedChanges.validateJsonObject(jsonObj.getAsJsonObject("changes"));
      ...
      SimplePullRequest1.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestReviewEdited.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestReviewEdited' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestReviewEdited> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestReviewEdited.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestReviewEdited>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestReviewEdited value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestReviewEdited read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestReviewEdited given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestReviewEdited
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestReviewEdited
  */
  public static WebhookPullRequestReviewEdited fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestReviewEdited.class);
  }

 /**
  * Convert an instance of WebhookPullRequestReviewEdited to an JSON string
  *
  * @return JSON string
  */
