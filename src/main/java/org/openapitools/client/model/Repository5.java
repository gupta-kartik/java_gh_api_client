...
public class Repository5 {
  ...
  **/
  ...
  public Repository5 forks(Integer forks) {
  ...
  **/
  ...
  public Repository5 forksCount(Integer forksCount) {
  ...
  **/
  ...
  public Repository5 id(Integer id) {
  ...
  **/
  ...
  public Repository5 openIssues(Integer openIssues) {
  ...
  **/
  ...
  public Repository5 openIssuesCount(Integer openIssuesCount) {
  ...
  **/
  ...
  public Repository5 size(Integer size) {
  ...
  **/
  ...
  public Repository5 stargazers(Integer stargazers) {
  ...
  **/
  ...
  public Repository5 stargazersCount(Integer stargazersCount) {
  ...
  **/
  ...
  public Repository5 useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public Repository5 watchers(Integer watchers) {
  ...
  **/
  ...
  public Repository5 watchersCount(Integer watchersCount) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Repository5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Repository5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Repository5 is not found in the empty JSON string", Repository5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Repository5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repository5` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Repository5.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Repository5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Repository5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Repository5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Repository5.class));

       return (TypeAdapter<T>) new TypeAdapter<Repository5>() {
           @Override
           public void write(JsonWriter out, Repository5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Repository5 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Repository5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Repository5
  * @throws IOException if the JSON string is invalid with respect to Repository5
  */
  public static Repository5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Repository5.class);
  }

 /**
  * Convert an instance of Repository5 to an JSON string
  *
  * @return JSON string
  */
