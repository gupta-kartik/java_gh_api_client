...
public class WebhookPullRequestOpenedPullRequestAllOf {
  ...
  public WebhookPullRequestOpenedPullRequestAllOf() {
  }

  public WebhookPullRequestOpenedPullRequestAllOf allowAutoMerge(Boolean allowAutoMerge) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf allowUpdateBranch(Boolean allowUpdateBranch) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf deleteBranchOnMerge(Boolean deleteBranchOnMerge) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf mergeCommitMessage(MergeCommitMessageEnum mergeCommitMessage) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf mergeCommitTitle(MergeCommitTitleEnum mergeCommitTitle) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf squashMergeCommitMessage(SquashMergeCommitMessageEnum squashMergeCommitMessage) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf squashMergeCommitTitle(SquashMergeCommitTitleEnum squashMergeCommitTitle) {
  ...
  **/
  ...
  public WebhookPullRequestOpenedPullRequestAllOf useSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookPullRequestOpenedPullRequestAllOf webhookPullRequestOpenedPullRequestAllOf = (WebhookPullRequestOpenedPullRequestAllOf) o;
    return Objects.equals(this.allowAutoMerge, webhookPullRequestOpenedPullRequestAllOf.allowAutoMerge) &&
        Objects.equals(this.allowUpdateBranch, webhookPullRequestOpenedPullRequestAllOf.allowUpdateBranch) &&
        Objects.equals(this.deleteBranchOnMerge, webhookPullRequestOpenedPullRequestAllOf.deleteBranchOnMerge) &&
        Objects.equals(this.mergeCommitMessage, webhookPullRequestOpenedPullRequestAllOf.mergeCommitMessage) &&
        Objects.equals(this.mergeCommitTitle, webhookPullRequestOpenedPullRequestAllOf.mergeCommitTitle) &&
        Objects.equals(this.squashMergeCommitMessage, webhookPullRequestOpenedPullRequestAllOf.squashMergeCommitMessage) &&
        Objects.equals(this.squashMergeCommitTitle, webhookPullRequestOpenedPullRequestAllOf.squashMergeCommitTitle) &&
        Objects.equals(this.useSquashPrTitleAsDefault, webhookPullRequestOpenedPullRequestAllOf.useSquashPrTitleAsDefault);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookPullRequestOpenedPullRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestOpenedPullRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestOpenedPullRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestOpenedPullRequestAllOf is not found in the empty JSON string", WebhookPullRequestOpenedPullRequestAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestOpenedPullRequestAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestOpenedPullRequestAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestOpenedPullRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestOpenedPullRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestOpenedPullRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestOpenedPullRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestOpenedPullRequestAllOf>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestOpenedPullRequestAllOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestOpenedPullRequestAllOf read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestOpenedPullRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestOpenedPullRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestOpenedPullRequestAllOf
  */
  public static WebhookPullRequestOpenedPullRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestOpenedPullRequestAllOf.class);
  }

 /**
  * Convert an instance of WebhookPullRequestOpenedPullRequestAllOf to an JSON string
  *
  * @return JSON string
  */
