...
public class WebhookPullRequestDequeued {
  ...
  **/
  ...
  public WebhookPullRequestDequeued enterprise(Enterprise enterprise) {
  ...
  **/
  ...
  public WebhookPullRequestDequeued number(Integer number) {
  ...
  **/
  ...
  public WebhookPullRequestDequeued organization(OrganizationSimple organization) {
  ...
  **/
  ...
  public WebhookPullRequestDequeued pullRequest(PullRequest4 pullRequest) {
  ...
  **/
  ...
  public WebhookPullRequestDequeued reason(String reason) {
  ...
  **/
  ...
  public WebhookPullRequestDequeued repository(Repository repository) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookPullRequestDequeued
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookPullRequestDequeued.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPullRequestDequeued is not found in the empty JSON string", WebhookPullRequestDequeued.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookPullRequestDequeued.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookPullRequestDequeued` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookPullRequestDequeued.openapiRequiredFields) {
      ...
      PullRequest4.validateJsonObject(jsonObj.getAsJsonObject("pull_request"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookPullRequestDequeued.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookPullRequestDequeued' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookPullRequestDequeued> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookPullRequestDequeued.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookPullRequestDequeued>() {
           @Override
           public void write(JsonWriter out, WebhookPullRequestDequeued value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookPullRequestDequeued read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WebhookPullRequestDequeued given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookPullRequestDequeued
  * @throws IOException if the JSON string is invalid with respect to WebhookPullRequestDequeued
  */
  public static WebhookPullRequestDequeued fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookPullRequestDequeued.class);
  }

 /**
  * Convert an instance of WebhookPullRequestDequeued to an JSON string
  *
  * @return JSON string
  */
