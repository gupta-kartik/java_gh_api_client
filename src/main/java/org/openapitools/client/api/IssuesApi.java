...
public class IssuesApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/issues#add-assignees-to-an-issue">Add assignees to an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#add-labels-to-an-issue">Add labels to an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#check-if-a-user-can-be-assigned">Check if a user can be assigned Documentation</a>
     */
    ...
    /**
     * Build call for issuesCheckUserCanBeAssignedToIssue
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param issueNumber The number that identifies the issue. (required)
     * @param assignee  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Response if &#x60;assignee&#x60; can be assigned to &#x60;issue_number&#x60; </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Response if &#x60;assignee&#x60; can not be assigned to &#x60;issue_number&#x60; </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue">Check if a user can be assigned to a issue Documentation</a>
     */
    public okhttp3.Call issuesCheckUserCanBeAssignedToIssueCall(String owner, String repo, Integer issueNumber, String assignee, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/issues/{issue_number}/assignees/{assignee}"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()))
            .replace("{" + "issue_number" + "}", localVarApiClient.escapeString(issueNumber.toString()))
            .replace("{" + "assignee" + "}", localVarApiClient.escapeString(assignee.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call issuesCheckUserCanBeAssignedToIssueValidateBeforeCall(String owner, String repo, Integer issueNumber, String assignee, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling issuesCheckUserCanBeAssignedToIssue(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling issuesCheckUserCanBeAssignedToIssue(Async)");
        }

        // verify the required parameter 'issueNumber' is set
        if (issueNumber == null) {
            throw new ApiException("Missing the required parameter 'issueNumber' when calling issuesCheckUserCanBeAssignedToIssue(Async)");
        }

        // verify the required parameter 'assignee' is set
        if (assignee == null) {
            throw new ApiException("Missing the required parameter 'assignee' when calling issuesCheckUserCanBeAssignedToIssue(Async)");
        }

        return issuesCheckUserCanBeAssignedToIssueCall(owner, repo, issueNumber, assignee, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue">Check if a user can be assigned to a issue Documentation</a>
     */
    public void issuesCheckUserCanBeAssignedToIssue(String owner, String repo, Integer issueNumber, String assignee) throws ApiException {
        issuesCheckUserCanBeAssignedToIssueWithHttpInfo(owner, repo, issueNumber, assignee);
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue">Check if a user can be assigned to a issue Documentation</a>
     */
    public ApiResponse<Void> issuesCheckUserCanBeAssignedToIssueWithHttpInfo(String owner, String repo, Integer issueNumber, String assignee) throws ApiException {
        okhttp3.Call localVarCall = issuesCheckUserCanBeAssignedToIssueValidateBeforeCall(owner, repo, issueNumber, assignee, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Check if a user can be assigned to a issue (asynchronously)
     * Checks if a user has permission to be assigned to a specific issue.  If the &#x60;assignee&#x60; can be assigned to this issue, a &#x60;204&#x60; status code with no content is returned.  Otherwise a &#x60;404&#x60; status code is returned.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param issueNumber The number that identifies the issue. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue">Check if a user can be assigned to a issue Documentation</a>
     */
    public okhttp3.Call issuesCheckUserCanBeAssignedToIssueAsync(String owner, String repo, Integer issueNumber, String assignee, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = issuesCheckUserCanBeAssignedToIssueValidateBeforeCall(owner, repo, issueNumber, assignee, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#create-an-issue">Create an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#create-an-issue-comment">Create an issue comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#create-a-label">Create a label Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#create-a-milestone">Create a milestone Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#delete-an-issue-comment">Delete an issue comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#delete-a-label">Delete a label Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#delete-a-milestone">Delete a milestone Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#get-an-issue">Get an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#get-an-issue-comment">Get an issue comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#get-an-issue-event">Get an issue event Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#get-a-label">Get a label Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#get-a-milestone">Get a milestone Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-issues-assigned-to-the-authenticated-user">List issues assigned to the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-assignees">List assignees Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-issue-comments">List issue comments Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-issue-comments-for-a-repository">List issue comments for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-issue-events">List issue events Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-issue-events-for-a-repository">List issue events for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-timeline-events-for-an-issue">List timeline events for an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-user-account-issues-assigned-to-the-authenticated-user">List user account issues assigned to the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-organization-issues-assigned-to-the-authenticated-user">List organization issues assigned to the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-repository-issues">List repository issues Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-labels-for-issues-in-a-milestone">List labels for issues in a milestone Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-labels-for-a-repository">List labels for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-labels-for-an-issue">List labels for an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#list-milestones">List milestones Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#lock-an-issue">Lock an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#remove-all-labels-from-an-issue">Remove all labels from an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#remove-assignees-from-an-issue">Remove assignees from an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#remove-a-label-from-an-issue">Remove a label from an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#set-labels-for-an-issue">Set labels for an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#unlock-an-issue">Unlock an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#update-an-issue">Update an issue Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#update-an-issue-comment">Update an issue comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#update-a-label">Update a label Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/issues#update-a-milestone">Update a milestone Documentation</a>
     */
