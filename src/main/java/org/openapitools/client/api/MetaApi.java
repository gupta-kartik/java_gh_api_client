...
public class MetaApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/meta#get-github-meta-information">Get GitHub meta information Documentation</a>
     */
    ...
    /**
     * Get GitHub meta information (asynchronously)
     * Returns meta information about GitHub, including a list of GitHub&#39;s IP addresses. For more information, see \&quot;[About GitHub&#39;s IP addresses](https://docs.github.com/articles/about-github-s-ip-addresses/).\&quot;  The values shown in the documentation&#39;s response are example values. You must always query the API directly to get the latest values.  **Note:** This endpoint returns both IPv4 and IPv6 addresses. However, not all features support IPv6. You should refer to the specific documentation for each feature to determine if IPv6 is supported.
    ...
    /**
     * Build call for metaGetAllVersions
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/meta#get-all-api-versions">Get all API versions Documentation</a>
     */
    public okhttp3.Call metaGetAllVersionsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call metaGetAllVersionsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return metaGetAllVersionsCall(_callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/meta#get-all-api-versions">Get all API versions Documentation</a>
     */
    public List<LocalDate> metaGetAllVersions() throws ApiException {
        ApiResponse<List<LocalDate>> localVarResp = metaGetAllVersionsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Get all API versions
     * Get all supported GitHub API versions.
     * @return ApiResponse&lt;List&lt;LocalDate&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/meta#get-all-api-versions">Get all API versions Documentation</a>
     */
    public ApiResponse<List<LocalDate>> metaGetAllVersionsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = metaGetAllVersionsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<List<LocalDate>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/meta#get-all-api-versions">Get all API versions Documentation</a>
     */
    public okhttp3.Call metaGetAllVersionsAsync(final ApiCallback<List<LocalDate>> _callback) throws ApiException {

        okhttp3.Call localVarCall = metaGetAllVersionsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<List<LocalDate>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/meta#get-octocat">Get Octocat Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/meta#get-the-zen-of-github">Get the Zen of GitHub Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/overview/resources-in-the-rest-api#root-endpoint">GitHub API Root Documentation</a>
     */
