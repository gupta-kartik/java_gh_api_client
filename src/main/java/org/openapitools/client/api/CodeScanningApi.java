...
import org.openapitools.client.model.CodeScanningAlertSeverity;
...
import org.openapitools.client.model.CodeScanningCodeqlDatabase;
import org.openapitools.client.model.CodeScanningDefaultSetup;
import org.openapitools.client.model.CodeScanningDefaultSetupUpdate;
import org.openapitools.client.model.CodeScanningDefaultSetupUpdateResponse;
import org.openapitools.client.model.CodeScanningOrganizationAlertItems;
...
public class CodeScanningApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#delete-a-code-scanning-analysis-from-a-repository">Delete a code scanning analysis from a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-code-scanning-alert">Get a code scanning alert Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-code-scanning-analysis-for-a-repository">Get a code scanning analysis for a repository Documentation</a>
     */
    ...
    /**
     * Build call for codeScanningGetCodeqlDatabase
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-codeql-database-for-a-repository">Get a CodeQL database for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningGetCodeqlDatabaseCall(String owner, String repo, String language, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/code-scanning/codeql/databases/{language}"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningGetCodeqlDatabaseValidateBeforeCall(String owner, String repo, String language, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling codeScanningGetCodeqlDatabase(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling codeScanningGetCodeqlDatabase(Async)");
        }

        // verify the required parameter 'language' is set
        if (language == null) {
            throw new ApiException("Missing the required parameter 'language' when calling codeScanningGetCodeqlDatabase(Async)");
        }

        return codeScanningGetCodeqlDatabaseCall(owner, repo, language, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-codeql-database-for-a-repository">Get a CodeQL database for a repository Documentation</a>
     */
    public CodeScanningCodeqlDatabase codeScanningGetCodeqlDatabase(String owner, String repo, String language) throws ApiException {
        ApiResponse<CodeScanningCodeqlDatabase> localVarResp = codeScanningGetCodeqlDatabaseWithHttpInfo(owner, repo, language);
        return localVarResp.getData();
    }
     ...
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param language The language of the CodeQL database. (required)
     * @return ApiResponse&lt;CodeScanningCodeqlDatabase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-codeql-database-for-a-repository">Get a CodeQL database for a repository Documentation</a>
     */
    public ApiResponse<CodeScanningCodeqlDatabase> codeScanningGetCodeqlDatabaseWithHttpInfo(String owner, String repo, String language) throws ApiException {
        okhttp3.Call localVarCall = codeScanningGetCodeqlDatabaseValidateBeforeCall(owner, repo, language, null);
        Type localVarReturnType = new TypeToken<CodeScanningCodeqlDatabase>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a CodeQL database for a repository (asynchronously)
     * Gets a CodeQL database for a language in a repository.  By default this endpoint returns JSON metadata about the CodeQL database. To download the CodeQL database binary content, set the &#x60;Accept&#x60; header of the request to [&#x60;application/zip&#x60;](https://docs.github.com/rest/overview/media-types), and make sure your HTTP client is configured to follow redirects or use the &#x60;Location&#x60; header to make a second request to get the redirect URL.  For private repositories, you must use an access token with the &#x60;security_events&#x60; scope. For public repositories, you can use tokens with the &#x60;security_events&#x60; or &#x60;public_repo&#x60; scope. GitHub Apps must have the &#x60;contents&#x60; read permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param language The language of the CodeQL database. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-a-codeql-database-for-a-repository">Get a CodeQL database for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningGetCodeqlDatabaseAsync(String owner, String repo, String language, final ApiCallback<CodeScanningCodeqlDatabase> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningGetCodeqlDatabaseValidateBeforeCall(owner, repo, language, _callback);
        Type localVarReturnType = new TypeToken<CodeScanningCodeqlDatabase>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for codeScanningGetDefaultSetup
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/code-scanning#get-a-code-scanning-default-setup-configuration">Get a code scanning default setup configuration Documentation</a>
     */
    public okhttp3.Call codeScanningGetDefaultSetupCall(String owner, String repo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/code-scanning/default-setup"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningGetDefaultSetupValidateBeforeCall(String owner, String repo, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling codeScanningGetDefaultSetup(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling codeScanningGetDefaultSetup(Async)");
        }

        return codeScanningGetDefaultSetupCall(owner, repo, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#get-a-code-scanning-default-setup-configuration">Get a code scanning default setup configuration Documentation</a>
     */
    public CodeScanningDefaultSetup codeScanningGetDefaultSetup(String owner, String repo) throws ApiException {
        ApiResponse<CodeScanningDefaultSetup> localVarResp = codeScanningGetDefaultSetupWithHttpInfo(owner, repo);
        return localVarResp.getData();
    }
     ...
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @return ApiResponse&lt;CodeScanningDefaultSetup&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#get-a-code-scanning-default-setup-configuration">Get a code scanning default setup configuration Documentation</a>
     */
    public ApiResponse<CodeScanningDefaultSetup> codeScanningGetDefaultSetupWithHttpInfo(String owner, String repo) throws ApiException {
        okhttp3.Call localVarCall = codeScanningGetDefaultSetupValidateBeforeCall(owner, repo, null);
        Type localVarReturnType = new TypeToken<CodeScanningDefaultSetup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a code scanning default setup configuration (asynchronously)
     * Gets a code scanning default setup configuration. You must use an access token with the &#x60;repo&#x60; scope to use this endpoint with private repos or the &#x60;public_repo&#x60; scope for public repos. GitHub Apps must have the &#x60;repo&#x60; write permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#get-a-code-scanning-default-setup-configuration">Get a code scanning default setup configuration Documentation</a>
     */
    public okhttp3.Call codeScanningGetDefaultSetupAsync(String owner, String repo, final ApiCallback<CodeScanningDefaultSetup> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningGetDefaultSetupValidateBeforeCall(owner, repo, _callback);
        Type localVarReturnType = new TypeToken<CodeScanningDefaultSetup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#get-information-about-a-sarif-upload">Get information about a SARIF upload Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-instances-of-a-code-scanning-alert">List instances of a code scanning alert Documentation</a>
     */
    ...
    /**
     * Build call for codeScanningListAlertsForOrg
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-an-organization">List code scanning alerts for an organization Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForOrgCall(String org, String toolName, String toolGuid, String before, String after, Integer page, Integer perPage, String direction, CodeScanningAlertState state, String sort, CodeScanningAlertSeverity severity, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/orgs/{org}/code-scanning/alerts"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningListAlertsForOrgValidateBeforeCall(String org, String toolName, String toolGuid, String before, String after, Integer page, Integer perPage, String direction, CodeScanningAlertState state, String sort, CodeScanningAlertSeverity severity, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling codeScanningListAlertsForOrg(Async)");
        }

        return codeScanningListAlertsForOrgCall(org, toolName, toolGuid, before, after, page, perPage, direction, state, sort, severity, _callback);
     ...
     * @param sort The property by which to sort the results. (optional, default to created)
     * @param severity If specified, only code scanning alerts with this severity will be returned. (optional)
     * @return List&lt;CodeScanningOrganizationAlertItems&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-an-organization">List code scanning alerts for an organization Documentation</a>
     */
    public List<CodeScanningOrganizationAlertItems> codeScanningListAlertsForOrg(String org, String toolName, String toolGuid, String before, String after, Integer page, Integer perPage, String direction, CodeScanningAlertState state, String sort, CodeScanningAlertSeverity severity) throws ApiException {
        ApiResponse<List<CodeScanningOrganizationAlertItems>> localVarResp = codeScanningListAlertsForOrgWithHttpInfo(org, toolName, toolGuid, before, after, page, perPage, direction, state, sort, severity);
        return localVarResp.getData();
    }
     ...
     * @param sort The property by which to sort the results. (optional, default to created)
     * @param severity If specified, only code scanning alerts with this severity will be returned. (optional)
     * @return ApiResponse&lt;List&lt;CodeScanningOrganizationAlertItems&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-an-organization">List code scanning alerts for an organization Documentation</a>
     */
    public ApiResponse<List<CodeScanningOrganizationAlertItems>> codeScanningListAlertsForOrgWithHttpInfo(String org, String toolName, String toolGuid, String before, String after, Integer page, Integer perPage, String direction, CodeScanningAlertState state, String sort, CodeScanningAlertSeverity severity) throws ApiException {
        okhttp3.Call localVarCall = codeScanningListAlertsForOrgValidateBeforeCall(org, toolName, toolGuid, before, after, page, perPage, direction, state, sort, severity, null);
        Type localVarReturnType = new TypeToken<List<CodeScanningOrganizationAlertItems>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List code scanning alerts for an organization (asynchronously)
     * Lists code scanning alerts for the default branch for all eligible repositories in an organization. Eligible repositories are repositories that are owned by organizations that you own or for which you are a security manager. For more information, see \&quot;[Managing security managers in your organization](https://docs.github.com/organizations/managing-peoples-access-to-your-organization-with-roles/managing-security-managers-in-your-organization).\&quot;  To use this endpoint, you must be an owner or security manager for the organization, and you must use an access token with the &#x60;repo&#x60; scope or &#x60;security_events&#x60; scope.  For public repositories, you may instead use the &#x60;public_repo&#x60; scope.  GitHub Apps must have the &#x60;security_events&#x60; read permission to use this endpoint.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param toolName The name of a code scanning tool. Only results by this tool will be listed. You can specify the tool by using either &#x60;tool_name&#x60; or &#x60;tool_guid&#x60;, but not both. (optional)
     * @param toolGuid The GUID of a code scanning tool. Only results by this tool will be listed. Note that some code scanning tools may not include a GUID in their analysis data. You can specify the tool by using either &#x60;tool_guid&#x60; or &#x60;tool_name&#x60;, but not both. (optional)
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-an-organization">List code scanning alerts for an organization Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForOrgAsync(String org, String toolName, String toolGuid, String before, String after, Integer page, Integer perPage, String direction, CodeScanningAlertState state, String sort, CodeScanningAlertSeverity severity, final ApiCallback<List<CodeScanningOrganizationAlertItems>> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningListAlertsForOrgValidateBeforeCall(org, toolName, toolGuid, before, after, page, perPage, direction, state, sort, severity, _callback);
        Type localVarReturnType = new TypeToken<List<CodeScanningOrganizationAlertItems>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForRepoCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, CodeScanningAlertSeverity severity, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningListAlertsForRepoValidateBeforeCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, CodeScanningAlertSeverity severity, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
        ...
        return codeScanningListAlertsForRepoCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, severity, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public List<CodeScanningAlertItems> codeScanningListAlertsForRepo(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, CodeScanningAlertSeverity severity) throws ApiException {
        ApiResponse<List<CodeScanningAlertItems>> localVarResp = codeScanningListAlertsForRepoWithHttpInfo(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, severity);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public ApiResponse<List<CodeScanningAlertItems>> codeScanningListAlertsForRepoWithHttpInfo(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, CodeScanningAlertSeverity severity) throws ApiException {
        okhttp3.Call localVarCall = codeScanningListAlertsForRepoValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, severity, null);
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForRepoAsync(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, CodeScanningAlertSeverity severity, final ApiCallback<List<CodeScanningAlertItems>> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningListAlertsForRepoValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, severity, _callback);
        Type localVarReturnType = new TypeToken<List<CodeScanningAlertItems>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for codeScanningListCodeqlDatabases
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-codeql-databases-for-a-repository">List CodeQL databases for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListCodeqlDatabasesCall(String owner, String repo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/code-scanning/codeql/databases"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningListCodeqlDatabasesValidateBeforeCall(String owner, String repo, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling codeScanningListCodeqlDatabases(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling codeScanningListCodeqlDatabases(Async)");
        }

        return codeScanningListCodeqlDatabasesCall(owner, repo, _callback);
     ...
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @return List&lt;CodeScanningCodeqlDatabase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-codeql-databases-for-a-repository">List CodeQL databases for a repository Documentation</a>
     */
    public List<CodeScanningCodeqlDatabase> codeScanningListCodeqlDatabases(String owner, String repo) throws ApiException {
        ApiResponse<List<CodeScanningCodeqlDatabase>> localVarResp = codeScanningListCodeqlDatabasesWithHttpInfo(owner, repo);
        return localVarResp.getData();
    }
     ...
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @return ApiResponse&lt;List&lt;CodeScanningCodeqlDatabase&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-codeql-databases-for-a-repository">List CodeQL databases for a repository Documentation</a>
     */
    public ApiResponse<List<CodeScanningCodeqlDatabase>> codeScanningListCodeqlDatabasesWithHttpInfo(String owner, String repo) throws ApiException {
        okhttp3.Call localVarCall = codeScanningListCodeqlDatabasesValidateBeforeCall(owner, repo, null);
        Type localVarReturnType = new TypeToken<List<CodeScanningCodeqlDatabase>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List CodeQL databases for a repository (asynchronously)
     * Lists the CodeQL databases that are available in a repository.  For private repositories, you must use an access token with the &#x60;security_events&#x60; scope. For public repositories, you can use tokens with the &#x60;security_events&#x60; or &#x60;public_repo&#x60; scope. GitHub Apps must have the &#x60;contents&#x60; read permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-codeql-databases-for-a-repository">List CodeQL databases for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListCodeqlDatabasesAsync(String owner, String repo, final ApiCallback<List<CodeScanningCodeqlDatabase>> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningListCodeqlDatabasesValidateBeforeCall(owner, repo, _callback);
        Type localVarReturnType = new TypeToken<List<CodeScanningCodeqlDatabase>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository">List code scanning analyses for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListRecentAnalysesCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String sarifId, String direction, String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningListRecentAnalysesValidateBeforeCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String sarifId, String direction, String sort, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
        ...
        return codeScanningListRecentAnalysesCall(owner, repo, toolName, toolGuid, page, perPage, ref, sarifId, direction, sort, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository">List code scanning analyses for a repository Documentation</a>
     */
    public List<CodeScanningAnalysis> codeScanningListRecentAnalyses(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String sarifId, String direction, String sort) throws ApiException {
        ApiResponse<List<CodeScanningAnalysis>> localVarResp = codeScanningListRecentAnalysesWithHttpInfo(owner, repo, toolName, toolGuid, page, perPage, ref, sarifId, direction, sort);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository">List code scanning analyses for a repository Documentation</a>
     */
    public ApiResponse<List<CodeScanningAnalysis>> codeScanningListRecentAnalysesWithHttpInfo(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String sarifId, String direction, String sort) throws ApiException {
        okhttp3.Call localVarCall = codeScanningListRecentAnalysesValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, sarifId, direction, sort, null);
     ...
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository">List code scanning analyses for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListRecentAnalysesAsync(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String sarifId, String direction, String sort, final ApiCallback<List<CodeScanningAnalysis>> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningListRecentAnalysesValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, sarifId, direction, sort, _callback);
        Type localVarReturnType = new TypeToken<List<CodeScanningAnalysis>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#update-a-code-scanning-alert">Update a code scanning alert Documentation</a>
     */
    ...
    /**
     * Build call for codeScanningUpdateDefaultSetup
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param codeScanningDefaultSetupUpdate  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 403 </td><td> Response if GitHub Advanced Security is not enabled for this repository </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource not found </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> Response if there is already a validation run in progress with a different default setup configuration </td><td>  -  </td></tr>
        <tr><td> 503 </td><td> Service unavailable </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/code-scanning#update-a-code-scanning-default-setup-configuration">Update a code scanning default setup configuration Documentation</a>
     */
    public okhttp3.Call codeScanningUpdateDefaultSetupCall(String owner, String repo, CodeScanningDefaultSetupUpdate codeScanningDefaultSetupUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = codeScanningDefaultSetupUpdate;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningUpdateDefaultSetupValidateBeforeCall(String owner, String repo, CodeScanningDefaultSetupUpdate codeScanningDefaultSetupUpdate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling codeScanningUpdateDefaultSetup(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling codeScanningUpdateDefaultSetup(Async)");
        }

        // verify the required parameter 'codeScanningDefaultSetupUpdate' is set
        if (codeScanningDefaultSetupUpdate == null) {
            throw new ApiException("Missing the required parameter 'codeScanningDefaultSetupUpdate' when calling codeScanningUpdateDefaultSetup(Async)");
        }

        return codeScanningUpdateDefaultSetupCall(owner, repo, codeScanningDefaultSetupUpdate, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#update-a-code-scanning-default-setup-configuration">Update a code scanning default setup configuration Documentation</a>
     */
    public Object codeScanningUpdateDefaultSetup(String owner, String repo, CodeScanningDefaultSetupUpdate codeScanningDefaultSetupUpdate) throws ApiException {
        ApiResponse<Object> localVarResp = codeScanningUpdateDefaultSetupWithHttpInfo(owner, repo, codeScanningDefaultSetupUpdate);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#update-a-code-scanning-default-setup-configuration">Update a code scanning default setup configuration Documentation</a>
     */
    public ApiResponse<Object> codeScanningUpdateDefaultSetupWithHttpInfo(String owner, String repo, CodeScanningDefaultSetupUpdate codeScanningDefaultSetupUpdate) throws ApiException {
        okhttp3.Call localVarCall = codeScanningUpdateDefaultSetupValidateBeforeCall(owner, repo, codeScanningDefaultSetupUpdate, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update a code scanning default setup configuration (asynchronously)
     * Updates a code scanning default setup configuration. You must use an access token with the &#x60;repo&#x60; scope to use this endpoint with private repos or the &#x60;public_repo&#x60; scope for public repos. GitHub Apps must have the &#x60;repo&#x60; write permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param codeScanningDefaultSetupUpdate  (required)
     ...
     * @see <a href="https://docs.github.com/rest/code-scanning#update-a-code-scanning-default-setup-configuration">Update a code scanning default setup configuration Documentation</a>
     */
    public okhttp3.Call codeScanningUpdateDefaultSetupAsync(String owner, String repo, CodeScanningDefaultSetupUpdate codeScanningDefaultSetupUpdate, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningUpdateDefaultSetupValidateBeforeCall(owner, repo, codeScanningDefaultSetupUpdate, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/code-scanning#upload-an-analysis-as-sarif-data">Upload an analysis as SARIF data Documentation</a>
     */
