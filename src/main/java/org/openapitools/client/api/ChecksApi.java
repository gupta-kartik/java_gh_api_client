...
public class ChecksApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/checks#create-a-check-run">Create a check run Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#create-a-check-suite">Create a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#get-a-check-run">Get a check run Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#get-a-check-suite">Get a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#list-check-run-annotations">List check run annotations Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#list-check-runs-for-a-git-reference">List check runs for a Git reference Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#list-check-runs-in-a-check-suite">List check runs in a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#list-check-suites-for-a-git-reference">List check suites for a Git reference Documentation</a>
     */
    ...
    /**
     * Build call for checksRerequestRun
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param checkRunId The unique identifier of the check run. (required)
     * @param _callback Callback for upload/download progress
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden if the check run is not rerequestable or doesn&#39;t belong to the authenticated GitHub App </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> Validation error if the check run is not rerequestable </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource not found </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#rerequest-a-check-run">Rerequest a check run Documentation</a>
     */
    public okhttp3.Call checksRerequestRunCall(String owner, String repo, Integer checkRunId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/check-runs/{check_run_id}/rerequest"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()))
            .replace("{" + "check_run_id" + "}", localVarApiClient.escapeString(checkRunId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call checksRerequestRunValidateBeforeCall(String owner, String repo, Integer checkRunId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling checksRerequestRun(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling checksRerequestRun(Async)");
        }

        // verify the required parameter 'checkRunId' is set
        if (checkRunId == null) {
            throw new ApiException("Missing the required parameter 'checkRunId' when calling checksRerequestRun(Async)");
        }

        return checksRerequestRunCall(owner, repo, checkRunId, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/checks#rerequest-a-check-run">Rerequest a check run Documentation</a>
     */
    public Object checksRerequestRun(String owner, String repo, Integer checkRunId) throws ApiException {
        ApiResponse<Object> localVarResp = checksRerequestRunWithHttpInfo(owner, repo, checkRunId);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/checks#rerequest-a-check-run">Rerequest a check run Documentation</a>
     */
    public ApiResponse<Object> checksRerequestRunWithHttpInfo(String owner, String repo, Integer checkRunId) throws ApiException {
        okhttp3.Call localVarCall = checksRerequestRunValidateBeforeCall(owner, repo, checkRunId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Rerequest a check run (asynchronously)
     * Triggers GitHub to rerequest an existing check run, without pushing new code to a repository. This endpoint will trigger the [&#x60;check_run&#x60; webhook](https://docs.github.com/webhooks/event-payloads/#check_run) event with the action &#x60;rerequested&#x60;. When a check run is &#x60;rerequested&#x60;, its &#x60;status&#x60; is reset to &#x60;queued&#x60; and the &#x60;conclusion&#x60; is cleared.  To rerequest a check run, your GitHub App must have the &#x60;checks:read&#x60; permission on a private repository or pull access to a public repository.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param checkRunId The unique identifier of the check run. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/checks#rerequest-a-check-run">Rerequest a check run Documentation</a>
     */
    public okhttp3.Call checksRerequestRunAsync(String owner, String repo, Integer checkRunId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = checksRerequestRunValidateBeforeCall(owner, repo, checkRunId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#rerequest-a-check-suite">Rerequest a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#update-repository-preferences-for-check-suites">Update repository preferences for check suites Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/checks#update-a-check-run">Update a check run Documentation</a>
     */
