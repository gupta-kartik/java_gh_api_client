...
import org.openapitools.client.model.ActivityMarkRepoNotificationsAsRead202Response;
...
public class PullsApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#check-if-a-pull-request-has-been-merged">Check if a pull request has been merged Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#create-a-pull-request">Create a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#create-a-reply-for-a-review-comment">Create a reply for a review comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#create-a-review-for-a-pull-request">Create a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request Documentation</a>
     */
     ...
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param pullNumber The number that identifies the pull request. (required)
     * @param reviewId The unique identifier of the review. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#delete-a-pending-review-for-a-pull-request">Delete a pending review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#delete-a-review-comment-for-a-pull-request">Delete a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#dismiss-a-review-for-a-pull-request">Dismiss a review for a pull request Documentation</a>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Pass the appropriate [media type](https://docs.github.com/rest/overview/media-types/#commits-commit-comparison-and-pull-requests) to fetch diff and patch formats. </td><td>  -  </td></tr>
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-a-pull-request">Get a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-a-review-for-a-pull-request">Get a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-a-review-comment-for-a-pull-request">Get a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-pull-requests">List pull requests Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-comments-for-a-pull-request-review">List comments for a pull request review Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-commits-on-a-pull-request">List commits on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-pull-requests-files">List pull requests files Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-all-requested-reviewers-for-a-pull-request">Get all requested reviewers for a pull request Documentation</a>
     */
    public okhttp3.Call pullsListRequestedReviewersCall(String owner, String repo, Integer pullNumber, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pullsListRequestedReviewersValidateBeforeCall(String owner, String repo, Integer pullNumber, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
        ...
        return pullsListRequestedReviewersCall(owner, repo, pullNumber, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-all-requested-reviewers-for-a-pull-request">Get all requested reviewers for a pull request Documentation</a>
     */
    public PullRequestReviewRequest pullsListRequestedReviewers(String owner, String repo, Integer pullNumber) throws ApiException {
        ApiResponse<PullRequestReviewRequest> localVarResp = pullsListRequestedReviewersWithHttpInfo(owner, repo, pullNumber);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-all-requested-reviewers-for-a-pull-request">Get all requested reviewers for a pull request Documentation</a>
     */
    public ApiResponse<PullRequestReviewRequest> pullsListRequestedReviewersWithHttpInfo(String owner, String repo, Integer pullNumber) throws ApiException {
        okhttp3.Call localVarCall = pullsListRequestedReviewersValidateBeforeCall(owner, repo, pullNumber, null);
        Type localVarReturnType = new TypeToken<PullRequestReviewRequest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all requested reviewers for a pull request (asynchronously)
     * Gets the users or teams whose review is requested for a pull request. Once a requested reviewer submits a review, they are no longer considered a requested reviewer. Their review will instead be returned by the [List reviews for a pull request](https://docs.github.com/rest/pulls/reviews#list-reviews-for-a-pull-request) operation.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param pullNumber The number that identifies the pull request. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#get-all-requested-reviewers-for-a-pull-request">Get all requested reviewers for a pull request Documentation</a>
     */
    public okhttp3.Call pullsListRequestedReviewersAsync(String owner, String repo, Integer pullNumber, final ApiCallback<PullRequestReviewRequest> _callback) throws ApiException {

        okhttp3.Call localVarCall = pullsListRequestedReviewersValidateBeforeCall(owner, repo, pullNumber, _callback);
        Type localVarReturnType = new TypeToken<PullRequestReviewRequest>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-review-comments-on-a-pull-request">List review comments on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-review-comments-in-a-repository">List review comments in a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#list-reviews-for-a-pull-request">List reviews for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#merge-a-pull-request">Merge a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#remove-requested-reviewers-from-a-pull-request">Remove requested reviewers from a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#request-reviewers-for-a-pull-request">Request reviewers for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#submit-a-review-for-a-pull-request">Submit a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls/#update-a-pull-request">Update a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
    public ActivityMarkRepoNotificationsAsRead202Response pullsUpdateBranch(String owner, String repo, Integer pullNumber, PullsUpdateBranchRequest pullsUpdateBranchRequest) throws ApiException {
        ApiResponse<ActivityMarkRepoNotificationsAsRead202Response> localVarResp = pullsUpdateBranchWithHttpInfo(owner, repo, pullNumber, pullsUpdateBranchRequest);
        return localVarResp.getData();
    }
     ...
     * @param pullNumber The number that identifies the pull request. (required)
     * @param pullsUpdateBranchRequest  (optional)
     * @return ApiResponse&lt;ActivityMarkRepoNotificationsAsRead202Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
    public ApiResponse<ActivityMarkRepoNotificationsAsRead202Response> pullsUpdateBranchWithHttpInfo(String owner, String repo, Integer pullNumber, PullsUpdateBranchRequest pullsUpdateBranchRequest) throws ApiException {
        okhttp3.Call localVarCall = pullsUpdateBranchValidateBeforeCall(owner, repo, pullNumber, pullsUpdateBranchRequest, null);
        Type localVarReturnType = new TypeToken<ActivityMarkRepoNotificationsAsRead202Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
    public okhttp3.Call pullsUpdateBranchAsync(String owner, String repo, Integer pullNumber, PullsUpdateBranchRequest pullsUpdateBranchRequest, final ApiCallback<ActivityMarkRepoNotificationsAsRead202Response> _callback) throws ApiException {
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-review-for-a-pull-request">Update a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/pulls#update-a-review-comment-for-a-pull-request">Update a review comment for a pull request Documentation</a>
     */
