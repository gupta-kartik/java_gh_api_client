...
import org.openapitools.client.model.DependabotAlertWithRepository;
...
import org.openapitools.client.model.DependabotUpdateAlertRequest;
...
public class DependabotApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#add-selected-repository-to-an-organization-secret">Add selected repository to an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#create-or-update-an-organization-secret">Create or update an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#create-or-update-a-repository-secret">Create or update a repository secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#delete-an-organization-secret">Delete an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#delete-a-repository-secret">Delete a repository secret Documentation</a>
     */
    ...
    /**
     * Build call for dependabotGetAlert
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param alertNumber The number that identifies a Dependabot alert in its repository. You can find this at the end of the URL for a Dependabot alert within GitHub, or in &#x60;number&#x60; fields in the response from the &#x60;GET /repos/{owner}/{repo}/dependabot/alerts&#x60; operation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-dependabot-alert">Get a Dependabot alert Documentation</a>
     */
    public okhttp3.Call dependabotGetAlertCall(String owner, String repo, Integer alertNumber, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/dependabot/alerts/{alert_number}"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dependabotGetAlertValidateBeforeCall(String owner, String repo, Integer alertNumber, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling dependabotGetAlert(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling dependabotGetAlert(Async)");
        }

        // verify the required parameter 'alertNumber' is set
        if (alertNumber == null) {
            throw new ApiException("Missing the required parameter 'alertNumber' when calling dependabotGetAlert(Async)");
        }

        return dependabotGetAlertCall(owner, repo, alertNumber, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-dependabot-alert">Get a Dependabot alert Documentation</a>
     */
    public DependabotAlert dependabotGetAlert(String owner, String repo, Integer alertNumber) throws ApiException {
        ApiResponse<DependabotAlert> localVarResp = dependabotGetAlertWithHttpInfo(owner, repo, alertNumber);
        return localVarResp.getData();
    }
     ...
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param alertNumber The number that identifies a Dependabot alert in its repository. You can find this at the end of the URL for a Dependabot alert within GitHub, or in &#x60;number&#x60; fields in the response from the &#x60;GET /repos/{owner}/{repo}/dependabot/alerts&#x60; operation. (required)
     * @return ApiResponse&lt;DependabotAlert&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-dependabot-alert">Get a Dependabot alert Documentation</a>
     */
    public ApiResponse<DependabotAlert> dependabotGetAlertWithHttpInfo(String owner, String repo, Integer alertNumber) throws ApiException {
        okhttp3.Call localVarCall = dependabotGetAlertValidateBeforeCall(owner, repo, alertNumber, null);
        Type localVarReturnType = new TypeToken<DependabotAlert>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a Dependabot alert (asynchronously)
     * You must use an access token with the &#x60;security_events&#x60; scope to use this endpoint with private repositories. You can also use tokens with the &#x60;public_repo&#x60; scope for public repositories only. GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param alertNumber The number that identifies a Dependabot alert in its repository. You can find this at the end of the URL for a Dependabot alert within GitHub, or in &#x60;number&#x60; fields in the response from the &#x60;GET /repos/{owner}/{repo}/dependabot/alerts&#x60; operation. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-dependabot-alert">Get a Dependabot alert Documentation</a>
     */
    public okhttp3.Call dependabotGetAlertAsync(String owner, String repo, Integer alertNumber, final ApiCallback<DependabotAlert> _callback) throws ApiException {

        okhttp3.Call localVarCall = dependabotGetAlertValidateBeforeCall(owner, repo, alertNumber, _callback);
        Type localVarReturnType = new TypeToken<DependabotAlert>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-an-organization-public-key">Get an organization public key Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-an-organization-secret">Get an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-repository-public-key">Get a repository public key Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#get-a-repository-secret">Get a repository secret Documentation</a>
     */
    ...
    /**
     * Build call for dependabotListAlertsForEnterprise
     ...
     * @param _package A comma-separated list of package names. If specified, only alerts for these packages will be returned. (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise">List Dependabot alerts for an enterprise Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForEnterpriseCall(String enterprise, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/enterprises/{enterprise}/dependabot/alerts"
        ...
        if (ecosystem != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("ecosystem", ecosystem));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dependabotListAlertsForEnterpriseValidateBeforeCall(String enterprise, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'enterprise' is set
        if (enterprise == null) {
            throw new ApiException("Missing the required parameter 'enterprise' when calling dependabotListAlertsForEnterprise(Async)");
        }

        return dependabotListAlertsForEnterpriseCall(enterprise, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, _callback);
     ...
     * @param last **Deprecated**. The number of results per page (max 100), starting from the last matching result. This parameter must not be used in combination with &#x60;first&#x60;. Instead, use &#x60;per_page&#x60; in combination with &#x60;before&#x60; to fetch the last page of results. (optional)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @return List&lt;DependabotAlertWithRepository&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise">List Dependabot alerts for an enterprise Documentation</a>
     */
    public List<DependabotAlertWithRepository> dependabotListAlertsForEnterprise(String enterprise, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage) throws ApiException {
        ApiResponse<List<DependabotAlertWithRepository>> localVarResp = dependabotListAlertsForEnterpriseWithHttpInfo(enterprise, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage);
        return localVarResp.getData();
    }
     ...
     * @param last **Deprecated**. The number of results per page (max 100), starting from the last matching result. This parameter must not be used in combination with &#x60;first&#x60;. Instead, use &#x60;per_page&#x60; in combination with &#x60;before&#x60; to fetch the last page of results. (optional)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @return ApiResponse&lt;List&lt;DependabotAlertWithRepository&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise">List Dependabot alerts for an enterprise Documentation</a>
     */
    public ApiResponse<List<DependabotAlertWithRepository>> dependabotListAlertsForEnterpriseWithHttpInfo(String enterprise, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = dependabotListAlertsForEnterpriseValidateBeforeCall(enterprise, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, null);
        Type localVarReturnType = new TypeToken<List<DependabotAlertWithRepository>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Dependabot alerts for an enterprise (asynchronously)
     * Lists Dependabot alerts for repositories that are owned by the specified enterprise. To use this endpoint, you must be a member of the enterprise, and you must use an access token with the &#x60;repo&#x60; scope or &#x60;security_events&#x60; scope. Alerts are only returned for organizations in the enterprise for which you are an organization owner or a security manager. For more information about security managers, see \&quot;[Managing security managers in your organization](https://docs.github.com/organizations/managing-peoples-access-to-your-organization-with-roles/managing-security-managers-in-your-organization).\&quot;
     * @param enterprise The slug version of the enterprise name. You can also substitute this value with the enterprise id. (required)
     * @param state A comma-separated list of states. If specified, only alerts with these states will be returned.  Can be: &#x60;auto_dismissed&#x60;, &#x60;dismissed&#x60;, &#x60;fixed&#x60;, &#x60;open&#x60; (optional)
     * @param severity A comma-separated list of severities. If specified, only alerts with these severities will be returned.  Can be: &#x60;low&#x60;, &#x60;medium&#x60;, &#x60;high&#x60;, &#x60;critical&#x60; (optional)
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise">List Dependabot alerts for an enterprise Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForEnterpriseAsync(String enterprise, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback<List<DependabotAlertWithRepository>> _callback) throws ApiException {

        okhttp3.Call localVarCall = dependabotListAlertsForEnterpriseValidateBeforeCall(enterprise, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, _callback);
        Type localVarReturnType = new TypeToken<List<DependabotAlertWithRepository>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for dependabotListAlertsForOrg
     * @param org The organization name. The name is not case sensitive. (required)
     * @param state A comma-separated list of states. If specified, only alerts with these states will be returned.  Can be: &#x60;auto_dismissed&#x60;, &#x60;dismissed&#x60;, &#x60;fixed&#x60;, &#x60;open&#x60; (optional)
     * @param severity A comma-separated list of severities. If specified, only alerts with these severities will be returned.  Can be: &#x60;low&#x60;, &#x60;medium&#x60;, &#x60;high&#x60;, &#x60;critical&#x60; (optional)
     * @param ecosystem A comma-separated list of ecosystems. If specified, only alerts for these ecosystems will be returned.  Can be: &#x60;composer&#x60;, &#x60;go&#x60;, &#x60;maven&#x60;, &#x60;npm&#x60;, &#x60;nuget&#x60;, &#x60;pip&#x60;, &#x60;pub&#x60;, &#x60;rubygems&#x60;, &#x60;rust&#x60; (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-organization">List Dependabot alerts for an organization Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForOrgCall(String org, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/orgs/{org}/dependabot/alerts"
            .replace("{" + "org" + "}", localVarApiClient.escapeString(org.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dependabotListAlertsForOrgValidateBeforeCall(String org, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling dependabotListAlertsForOrg(Async)");
        }

        return dependabotListAlertsForOrgCall(org, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-organization">List Dependabot alerts for an organization Documentation</a>
     */
    public List<DependabotAlertWithRepository> dependabotListAlertsForOrg(String org, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage) throws ApiException {
        ApiResponse<List<DependabotAlertWithRepository>> localVarResp = dependabotListAlertsForOrgWithHttpInfo(org, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-organization">List Dependabot alerts for an organization Documentation</a>
     */
    public ApiResponse<List<DependabotAlertWithRepository>> dependabotListAlertsForOrgWithHttpInfo(String org, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = dependabotListAlertsForOrgValidateBeforeCall(org, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, null);
        Type localVarReturnType = new TypeToken<List<DependabotAlertWithRepository>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Dependabot alerts for an organization (asynchronously)
     * Lists Dependabot alerts for an organization.  To use this endpoint, you must be an owner or security manager for the organization, and you must use an access token with the &#x60;repo&#x60; scope or &#x60;security_events&#x60; scope.  For public repositories, you may instead use the &#x60;public_repo&#x60; scope.  GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param state A comma-separated list of states. If specified, only alerts with these states will be returned.  Can be: &#x60;auto_dismissed&#x60;, &#x60;dismissed&#x60;, &#x60;fixed&#x60;, &#x60;open&#x60; (optional)
     * @param severity A comma-separated list of severities. If specified, only alerts with these severities will be returned.  Can be: &#x60;low&#x60;, &#x60;medium&#x60;, &#x60;high&#x60;, &#x60;critical&#x60; (optional)
     ...
     * @see <a href="https://docs.github.com/rest/dependabot/alerts#list-dependabot-alerts-for-an-organization">List Dependabot alerts for an organization Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForOrgAsync(String org, String state, String severity, String ecosystem, String _package, String scope, String sort, String direction, String before, String after, Integer first, Integer last, Integer perPage, final ApiCallback<List<DependabotAlertWithRepository>> _callback) throws ApiException {

        okhttp3.Call localVarCall = dependabotListAlertsForOrgValidateBeforeCall(org, state, severity, ecosystem, _package, scope, sort, direction, before, after, first, last, perPage, _callback);
        Type localVarReturnType = new TypeToken<List<DependabotAlertWithRepository>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for dependabotListAlertsForRepo
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param state A comma-separated list of states. If specified, only alerts with these states will be returned.  Can be: &#x60;auto_dismissed&#x60;, &#x60;dismissed&#x60;, &#x60;fixed&#x60;, &#x60;open&#x60; (optional)
     * @param severity A comma-separated list of severities. If specified, only alerts with these severities will be returned.  Can be: &#x60;low&#x60;, &#x60;medium&#x60;, &#x60;high&#x60;, &#x60;critical&#x60; (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-dependabot-alerts-for-a-repository">List Dependabot alerts for a repository Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForRepoCall(String owner, String repo, String state, String severity, String ecosystem, String _package, String manifest, String scope, String sort, String direction, Integer page, Integer perPage, String before, String after, Integer first, Integer last, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/dependabot/alerts"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dependabotListAlertsForRepoValidateBeforeCall(String owner, String repo, String state, String severity, String ecosystem, String _package, String manifest, String scope, String sort, String direction, Integer page, Integer perPage, String before, String after, Integer first, Integer last, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling dependabotListAlertsForRepo(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling dependabotListAlertsForRepo(Async)");
        }

        return dependabotListAlertsForRepoCall(owner, repo, state, severity, ecosystem, _package, manifest, scope, sort, direction, page, perPage, before, after, first, last, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-dependabot-alerts-for-a-repository">List Dependabot alerts for a repository Documentation</a>
     */
    public List<DependabotAlert> dependabotListAlertsForRepo(String owner, String repo, String state, String severity, String ecosystem, String _package, String manifest, String scope, String sort, String direction, Integer page, Integer perPage, String before, String after, Integer first, Integer last) throws ApiException {
        ApiResponse<List<DependabotAlert>> localVarResp = dependabotListAlertsForRepoWithHttpInfo(owner, repo, state, severity, ecosystem, _package, manifest, scope, sort, direction, page, perPage, before, after, first, last);
        return localVarResp.getData();
    }
     ...
     * @param first **Deprecated**. The number of results per page (max 100), starting from the first matching result. This parameter must not be used in combination with &#x60;last&#x60;. Instead, use &#x60;per_page&#x60; in combination with &#x60;after&#x60; to fetch the first page of results. (optional, default to 30)
     * @param last **Deprecated**. The number of results per page (max 100), starting from the last matching result. This parameter must not be used in combination with &#x60;first&#x60;. Instead, use &#x60;per_page&#x60; in combination with &#x60;before&#x60; to fetch the last page of results. (optional)
     * @return ApiResponse&lt;List&lt;DependabotAlert&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-dependabot-alerts-for-a-repository">List Dependabot alerts for a repository Documentation</a>
     */
    public ApiResponse<List<DependabotAlert>> dependabotListAlertsForRepoWithHttpInfo(String owner, String repo, String state, String severity, String ecosystem, String _package, String manifest, String scope, String sort, String direction, Integer page, Integer perPage, String before, String after, Integer first, Integer last) throws ApiException {
        okhttp3.Call localVarCall = dependabotListAlertsForRepoValidateBeforeCall(owner, repo, state, severity, ecosystem, _package, manifest, scope, sort, direction, page, perPage, before, after, first, last, null);
        Type localVarReturnType = new TypeToken<List<DependabotAlert>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Dependabot alerts for a repository (asynchronously)
     * You must use an access token with the &#x60;security_events&#x60; scope to use this endpoint with private repositories. You can also use tokens with the &#x60;public_repo&#x60; scope for public repositories only. GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param state A comma-separated list of states. If specified, only alerts with these states will be returned.  Can be: &#x60;auto_dismissed&#x60;, &#x60;dismissed&#x60;, &#x60;fixed&#x60;, &#x60;open&#x60; (optional)
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-dependabot-alerts-for-a-repository">List Dependabot alerts for a repository Documentation</a>
     */
    public okhttp3.Call dependabotListAlertsForRepoAsync(String owner, String repo, String state, String severity, String ecosystem, String _package, String manifest, String scope, String sort, String direction, Integer page, Integer perPage, String before, String after, Integer first, Integer last, final ApiCallback<List<DependabotAlert>> _callback) throws ApiException {

        okhttp3.Call localVarCall = dependabotListAlertsForRepoValidateBeforeCall(owner, repo, state, severity, ecosystem, _package, manifest, scope, sort, direction, page, perPage, before, after, first, last, _callback);
        Type localVarReturnType = new TypeToken<List<DependabotAlert>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-organization-secrets">List organization secrets Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-repository-secrets">List repository secrets Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#list-selected-repositories-for-an-organization-secret">List selected repositories for an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#remove-selected-repository-from-an-organization-secret">Remove selected repository from an organization secret Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#set-selected-repositories-for-an-organization-secret">Set selected repositories for an organization secret Documentation</a>
     */
    ...
    /**
     * Build call for dependabotUpdateAlert
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param alertNumber The number that identifies a Dependabot alert in its repository. You can find this at the end of the URL for a Dependabot alert within GitHub, or in &#x60;number&#x60; fields in the response from the &#x60;GET /repos/{owner}/{repo}/dependabot/alerts&#x60; operation. (required)
     * @param dependabotUpdateAlertRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/dependabot#update-a-dependabot-alert">Update a Dependabot alert Documentation</a>
     */
    public okhttp3.Call dependabotUpdateAlertCall(String owner, String repo, Integer alertNumber, DependabotUpdateAlertRequest dependabotUpdateAlertRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = dependabotUpdateAlertRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dependabotUpdateAlertValidateBeforeCall(String owner, String repo, Integer alertNumber, DependabotUpdateAlertRequest dependabotUpdateAlertRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling dependabotUpdateAlert(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling dependabotUpdateAlert(Async)");
        }

        // verify the required parameter 'alertNumber' is set
        if (alertNumber == null) {
            throw new ApiException("Missing the required parameter 'alertNumber' when calling dependabotUpdateAlert(Async)");
        }

        // verify the required parameter 'dependabotUpdateAlertRequest' is set
        if (dependabotUpdateAlertRequest == null) {
            throw new ApiException("Missing the required parameter 'dependabotUpdateAlertRequest' when calling dependabotUpdateAlert(Async)");
        }

        return dependabotUpdateAlertCall(owner, repo, alertNumber, dependabotUpdateAlertRequest, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#update-a-dependabot-alert">Update a Dependabot alert Documentation</a>
     */
    public DependabotAlert dependabotUpdateAlert(String owner, String repo, Integer alertNumber, DependabotUpdateAlertRequest dependabotUpdateAlertRequest) throws ApiException {
        ApiResponse<DependabotAlert> localVarResp = dependabotUpdateAlertWithHttpInfo(owner, repo, alertNumber, dependabotUpdateAlertRequest);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#update-a-dependabot-alert">Update a Dependabot alert Documentation</a>
     */
    public ApiResponse<DependabotAlert> dependabotUpdateAlertWithHttpInfo(String owner, String repo, Integer alertNumber, DependabotUpdateAlertRequest dependabotUpdateAlertRequest) throws ApiException {
        okhttp3.Call localVarCall = dependabotUpdateAlertValidateBeforeCall(owner, repo, alertNumber, dependabotUpdateAlertRequest, null);
        Type localVarReturnType = new TypeToken<DependabotAlert>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update a Dependabot alert (asynchronously)
     * You must use an access token with the &#x60;security_events&#x60; scope to use this endpoint with private repositories. You can also use tokens with the &#x60;public_repo&#x60; scope for public repositories only. GitHub Apps must have **Dependabot alerts** write permission to use this endpoint.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param alertNumber The number that identifies a Dependabot alert in its repository. You can find this at the end of the URL for a Dependabot alert within GitHub, or in &#x60;number&#x60; fields in the response from the &#x60;GET /repos/{owner}/{repo}/dependabot/alerts&#x60; operation. (required)
     ...
     * @see <a href="https://docs.github.com/rest/reference/dependabot#update-a-dependabot-alert">Update a Dependabot alert Documentation</a>
     */
    public okhttp3.Call dependabotUpdateAlertAsync(String owner, String repo, Integer alertNumber, DependabotUpdateAlertRequest dependabotUpdateAlertRequest, final ApiCallback<DependabotAlert> _callback) throws ApiException {

        okhttp3.Call localVarCall = dependabotUpdateAlertValidateBeforeCall(owner, repo, alertNumber, dependabotUpdateAlertRequest, _callback);
        Type localVarReturnType = new TypeToken<DependabotAlert>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
