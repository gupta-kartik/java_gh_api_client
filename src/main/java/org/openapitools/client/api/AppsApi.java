...
public class AppsApi {
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#add-a-repository-to-an-app-installation">Add a repository to an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#check-a-token">Check a token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#create-a-github-app-from-a-manifest">Create a GitHub App from a manifest Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps/#create-an-installation-access-token-for-an-app">Create an installation access token for an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#delete-an-app-authorization">Delete an app authorization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#delete-an-installation-for-the-authenticated-app">Delete an installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#delete-an-app-token">Delete an app token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-the-authenticated-app">Get the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps/#get-an-app">Get an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-an-installation-for-the-authenticated-app">Get an installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-an-organization-installation-for-the-authenticated-app">Get an organization installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-repository-installation-for-the-authenticated-app">Get a repository installation for the authenticated app Documentation</a>
     */
    ...
    /**
     * Build call for appsGetSubscriptionPlanForAccount
     * @param accountId account_id parameter (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Response </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found when the account has not purchased the listing </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Requires authentication </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account">Get a subscription plan for an account Documentation</a>
     */
    public okhttp3.Call appsGetSubscriptionPlanForAccountCall(Integer accountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/accounts/{account_id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsGetSubscriptionPlanForAccountValidateBeforeCall(Integer accountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling appsGetSubscriptionPlanForAccount(Async)");
        }

        return appsGetSubscriptionPlanForAccountCall(accountId, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account">Get a subscription plan for an account Documentation</a>
     */
    public MarketplacePurchase appsGetSubscriptionPlanForAccount(Integer accountId) throws ApiException {
        ApiResponse<MarketplacePurchase> localVarResp = appsGetSubscriptionPlanForAccountWithHttpInfo(accountId);
        return localVarResp.getData();
    }
     ...
     * Shows whether the user or organization account actively subscribes to a plan listed by the authenticated GitHub App. When someone submits a plan change that won&#39;t be processed until the end of their billing cycle, you will also see the upcoming pending change.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param accountId account_id parameter (required)
     * @return ApiResponse&lt;MarketplacePurchase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account">Get a subscription plan for an account Documentation</a>
     */
    public ApiResponse<MarketplacePurchase> appsGetSubscriptionPlanForAccountWithHttpInfo(Integer accountId) throws ApiException {
        okhttp3.Call localVarCall = appsGetSubscriptionPlanForAccountValidateBeforeCall(accountId, null);
        Type localVarReturnType = new TypeToken<MarketplacePurchase>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a subscription plan for an account (asynchronously)
     * Shows whether the user or organization account actively subscribes to a plan listed by the authenticated GitHub App. When someone submits a plan change that won&#39;t be processed until the end of their billing cycle, you will also see the upcoming pending change.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param accountId account_id parameter (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account">Get a subscription plan for an account Documentation</a>
     */
    public okhttp3.Call appsGetSubscriptionPlanForAccountAsync(Integer accountId, final ApiCallback<MarketplacePurchase> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsGetSubscriptionPlanForAccountValidateBeforeCall(accountId, _callback);
        Type localVarReturnType = new TypeToken<MarketplacePurchase>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appsGetSubscriptionPlanForAccountStubbed
     * @param accountId account_id parameter (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account-stubbed">Get a subscription plan for an account (stubbed) Documentation</a>
     */
    public okhttp3.Call appsGetSubscriptionPlanForAccountStubbedCall(Integer accountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/stubbed/accounts/{account_id}"
            .replace("{" + "account_id" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsGetSubscriptionPlanForAccountStubbedValidateBeforeCall(Integer accountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling appsGetSubscriptionPlanForAccountStubbed(Async)");
        }

        return appsGetSubscriptionPlanForAccountStubbedCall(accountId, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account-stubbed">Get a subscription plan for an account (stubbed) Documentation</a>
     */
    public MarketplacePurchase appsGetSubscriptionPlanForAccountStubbed(Integer accountId) throws ApiException {
        ApiResponse<MarketplacePurchase> localVarResp = appsGetSubscriptionPlanForAccountStubbedWithHttpInfo(accountId);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account-stubbed">Get a subscription plan for an account (stubbed) Documentation</a>
     */
    public ApiResponse<MarketplacePurchase> appsGetSubscriptionPlanForAccountStubbedWithHttpInfo(Integer accountId) throws ApiException {
        okhttp3.Call localVarCall = appsGetSubscriptionPlanForAccountStubbedValidateBeforeCall(accountId, null);
        Type localVarReturnType = new TypeToken<MarketplacePurchase>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a subscription plan for an account (stubbed) (asynchronously)
     * Shows whether the user or organization account actively subscribes to a plan listed by the authenticated GitHub App. When someone submits a plan change that won&#39;t be processed until the end of their billing cycle, you will also see the upcoming pending change.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param accountId account_id parameter (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-subscription-plan-for-an-account-stubbed">Get a subscription plan for an account (stubbed) Documentation</a>
     */
    public okhttp3.Call appsGetSubscriptionPlanForAccountStubbedAsync(Integer accountId, final ApiCallback<MarketplacePurchase> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsGetSubscriptionPlanForAccountStubbedValidateBeforeCall(accountId, _callback);
        Type localVarReturnType = new TypeToken<MarketplacePurchase>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-user-installation-for-the-authenticated-app">Get a user installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-webhook-configuration-for-an-app">Get a webhook configuration for an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#get-a-delivery-for-an-app-webhook">Get a delivery for an app webhook Documentation</a>
     */
    ...
    /**
     * Build call for appsListAccountsForPlan
     * @param planId The unique identifier of the plan. (required)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan">List accounts for a plan Documentation</a>
     */
    public okhttp3.Call appsListAccountsForPlanCall(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/plans/{plan_id}/accounts"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListAccountsForPlanValidateBeforeCall(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'planId' is set
        if (planId == null) {
            throw new ApiException("Missing the required parameter 'planId' when calling appsListAccountsForPlan(Async)");
        }

        return appsListAccountsForPlanCall(planId, sort, direction, perPage, page, _callback);
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return List&lt;MarketplacePurchase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan">List accounts for a plan Documentation</a>
     */
    public List<MarketplacePurchase> appsListAccountsForPlan(Integer planId, String sort, String direction, Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<MarketplacePurchase>> localVarResp = appsListAccountsForPlanWithHttpInfo(planId, sort, direction, perPage, page);
        return localVarResp.getData();
    }
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return ApiResponse&lt;List&lt;MarketplacePurchase&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan">List accounts for a plan Documentation</a>
     */
    public ApiResponse<List<MarketplacePurchase>> appsListAccountsForPlanWithHttpInfo(Integer planId, String sort, String direction, Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListAccountsForPlanValidateBeforeCall(planId, sort, direction, perPage, page, null);
        Type localVarReturnType = new TypeToken<List<MarketplacePurchase>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List accounts for a plan (asynchronously)
     * Returns user and organization accounts associated with the specified plan, including free plans. For per-seat pricing, you see the list of accounts that have purchased the plan, including the number of seats purchased. When someone submits a plan change that won&#39;t be processed until the end of their billing cycle, you will also see the upcoming pending change.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param planId The unique identifier of the plan. (required)
     * @param sort The property to sort the results by. (optional, default to created)
     * @param direction To return the oldest accounts first, set to &#x60;asc&#x60;. Ignored without the &#x60;sort&#x60; parameter. (optional)
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan">List accounts for a plan Documentation</a>
     */
    public okhttp3.Call appsListAccountsForPlanAsync(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback<List<MarketplacePurchase>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListAccountsForPlanValidateBeforeCall(planId, sort, direction, perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<MarketplacePurchase>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appsListAccountsForPlanStubbed
     * @param planId The unique identifier of the plan. (required)
     * @param sort The property to sort the results by. (optional, default to created)
     * @param direction To return the oldest accounts first, set to &#x60;asc&#x60;. Ignored without the &#x60;sort&#x60; parameter. (optional)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan-stubbed">List accounts for a plan (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListAccountsForPlanStubbedCall(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/stubbed/plans/{plan_id}/accounts"
            .replace("{" + "plan_id" + "}", localVarApiClient.escapeString(planId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListAccountsForPlanStubbedValidateBeforeCall(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'planId' is set
        if (planId == null) {
            throw new ApiException("Missing the required parameter 'planId' when calling appsListAccountsForPlanStubbed(Async)");
        }

        return appsListAccountsForPlanStubbedCall(planId, sort, direction, perPage, page, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan-stubbed">List accounts for a plan (stubbed) Documentation</a>
     */
    public List<MarketplacePurchase> appsListAccountsForPlanStubbed(Integer planId, String sort, String direction, Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<MarketplacePurchase>> localVarResp = appsListAccountsForPlanStubbedWithHttpInfo(planId, sort, direction, perPage, page);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan-stubbed">List accounts for a plan (stubbed) Documentation</a>
     */
    public ApiResponse<List<MarketplacePurchase>> appsListAccountsForPlanStubbedWithHttpInfo(Integer planId, String sort, String direction, Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListAccountsForPlanStubbedValidateBeforeCall(planId, sort, direction, perPage, page, null);
        Type localVarReturnType = new TypeToken<List<MarketplacePurchase>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List accounts for a plan (stubbed) (asynchronously)
     * Returns repository and organization accounts associated with the specified plan, including free plans. For per-seat pricing, you see the list of accounts that have purchased the plan, including the number of seats purchased. When someone submits a plan change that won&#39;t be processed until the end of their billing cycle, you will also see the upcoming pending change.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param planId The unique identifier of the plan. (required)
     * @param sort The property to sort the results by. (optional, default to created)
     * @param direction To return the oldest accounts first, set to &#x60;asc&#x60;. Ignored without the &#x60;sort&#x60; parameter. (optional)
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-accounts-for-a-plan-stubbed">List accounts for a plan (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListAccountsForPlanStubbedAsync(Integer planId, String sort, String direction, Integer perPage, Integer page, final ApiCallback<List<MarketplacePurchase>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListAccountsForPlanStubbedValidateBeforeCall(planId, sort, direction, perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<MarketplacePurchase>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-repositories-accessible-to-the-user-access-token">List repositories accessible to the user access token Documentation</a>
     */
    ...
    /**
     * Build call for appsListInstallationRequestsForAuthenticatedApp
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List of integration installation requests </td><td>  -  </td></tr>
        <tr><td> 304 </td><td> Not modified </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Requires authentication </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-installation-requests-for-the-authenticated-app">List installation requests for the authenticated app Documentation</a>
     */
    public okhttp3.Call appsListInstallationRequestsForAuthenticatedAppCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/app/installation-requests";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListInstallationRequestsForAuthenticatedAppValidateBeforeCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        return appsListInstallationRequestsForAuthenticatedAppCall(perPage, page, _callback);
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return List&lt;IntegrationInstallationRequest&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-installation-requests-for-the-authenticated-app">List installation requests for the authenticated app Documentation</a>
     */
    public List<IntegrationInstallationRequest> appsListInstallationRequestsForAuthenticatedApp(Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<IntegrationInstallationRequest>> localVarResp = appsListInstallationRequestsForAuthenticatedAppWithHttpInfo(perPage, page);
        return localVarResp.getData();
    }
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return ApiResponse&lt;List&lt;IntegrationInstallationRequest&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-installation-requests-for-the-authenticated-app">List installation requests for the authenticated app Documentation</a>
     */
    public ApiResponse<List<IntegrationInstallationRequest>> appsListInstallationRequestsForAuthenticatedAppWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListInstallationRequestsForAuthenticatedAppValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<List<IntegrationInstallationRequest>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List installation requests for the authenticated app (asynchronously)
     * Lists all the pending installation requests for the authenticated GitHub App.
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-installation-requests-for-the-authenticated-app">List installation requests for the authenticated app Documentation</a>
     */
    public okhttp3.Call appsListInstallationRequestsForAuthenticatedAppAsync(Integer perPage, Integer page, final ApiCallback<List<IntegrationInstallationRequest>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListInstallationRequestsForAuthenticatedAppValidateBeforeCall(perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<IntegrationInstallationRequest>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-installations-for-the-authenticated-app">List installations for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-app-installations-accessible-to-the-user-access-token">List app installations accessible to the user access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans">List plans Documentation</a>
     */
    public okhttp3.Call appsListPlansCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/plans";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListPlansValidateBeforeCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        return appsListPlansCall(perPage, page, _callback);
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return List&lt;MarketplaceListingPlan&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans">List plans Documentation</a>
     */
    public List<MarketplaceListingPlan> appsListPlans(Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<MarketplaceListingPlan>> localVarResp = appsListPlansWithHttpInfo(perPage, page);
        return localVarResp.getData();
    }
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return ApiResponse&lt;List&lt;MarketplaceListingPlan&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans">List plans Documentation</a>
     */
    public ApiResponse<List<MarketplaceListingPlan>> appsListPlansWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListPlansValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<List<MarketplaceListingPlan>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans">List plans Documentation</a>
     */
    public okhttp3.Call appsListPlansAsync(Integer perPage, Integer page, final ApiCallback<List<MarketplaceListingPlan>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListPlansValidateBeforeCall(perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<MarketplaceListingPlan>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appsListPlansStubbed
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans-stubbed">List plans (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListPlansStubbedCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/marketplace_listing/stubbed/plans";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListPlansStubbedValidateBeforeCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        return appsListPlansStubbedCall(perPage, page, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans-stubbed">List plans (stubbed) Documentation</a>
     */
    public List<MarketplaceListingPlan> appsListPlansStubbed(Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<MarketplaceListingPlan>> localVarResp = appsListPlansStubbedWithHttpInfo(perPage, page);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans-stubbed">List plans (stubbed) Documentation</a>
     */
    public ApiResponse<List<MarketplaceListingPlan>> appsListPlansStubbedWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListPlansStubbedValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<List<MarketplaceListingPlan>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List plans (stubbed) (asynchronously)
     * Lists all plans that are part of your GitHub Marketplace listing.  GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth Apps must use [basic authentication](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) with their client ID and client secret to access this endpoint.
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-plans-stubbed">List plans (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListPlansStubbedAsync(Integer perPage, Integer page, final ApiCallback<List<MarketplaceListingPlan>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListPlansStubbedValidateBeforeCall(perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<MarketplaceListingPlan>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-repositories-accessible-to-the-app-installation">List repositories accessible to the app installation Documentation</a>
     */
    ...
    /**
     * Build call for appsListSubscriptionsForAuthenticatedUser
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user">List subscriptions for the authenticated user Documentation</a>
     */
    public okhttp3.Call appsListSubscriptionsForAuthenticatedUserCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/user/marketplace_purchases";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListSubscriptionsForAuthenticatedUserValidateBeforeCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        return appsListSubscriptionsForAuthenticatedUserCall(perPage, page, _callback);
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return List&lt;UserMarketplacePurchase&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user">List subscriptions for the authenticated user Documentation</a>
     */
    public List<UserMarketplacePurchase> appsListSubscriptionsForAuthenticatedUser(Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<UserMarketplacePurchase>> localVarResp = appsListSubscriptionsForAuthenticatedUserWithHttpInfo(perPage, page);
        return localVarResp.getData();
    }
     ...
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @return ApiResponse&lt;List&lt;UserMarketplacePurchase&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user">List subscriptions for the authenticated user Documentation</a>
     */
    public ApiResponse<List<UserMarketplacePurchase>> appsListSubscriptionsForAuthenticatedUserWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListSubscriptionsForAuthenticatedUserValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<List<UserMarketplacePurchase>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List subscriptions for the authenticated user (asynchronously)
     * Lists the active subscriptions for the authenticated user. You must use a [user-to-server OAuth access token](https://docs.github.com/apps/building-github-apps/identifying-and-authorizing-users-for-github-apps/#identifying-users-on-your-site), created for a user who has authorized your GitHub App, to access this endpoint. . OAuth Apps must authenticate using an [OAuth token](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/).
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user">List subscriptions for the authenticated user Documentation</a>
     */
    public okhttp3.Call appsListSubscriptionsForAuthenticatedUserAsync(Integer perPage, Integer page, final ApiCallback<List<UserMarketplacePurchase>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListSubscriptionsForAuthenticatedUserValidateBeforeCall(perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<UserMarketplacePurchase>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for appsListSubscriptionsForAuthenticatedUserStubbed
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user-stubbed">List subscriptions for the authenticated user (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListSubscriptionsForAuthenticatedUserStubbedCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/user/marketplace_purchases/stubbed";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListSubscriptionsForAuthenticatedUserStubbedValidateBeforeCall(Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        return appsListSubscriptionsForAuthenticatedUserStubbedCall(perPage, page, _callback);
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user-stubbed">List subscriptions for the authenticated user (stubbed) Documentation</a>
     */
    public List<UserMarketplacePurchase> appsListSubscriptionsForAuthenticatedUserStubbed(Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<UserMarketplacePurchase>> localVarResp = appsListSubscriptionsForAuthenticatedUserStubbedWithHttpInfo(perPage, page);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user-stubbed">List subscriptions for the authenticated user (stubbed) Documentation</a>
     */
    public ApiResponse<List<UserMarketplacePurchase>> appsListSubscriptionsForAuthenticatedUserStubbedWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = appsListSubscriptionsForAuthenticatedUserStubbedValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<List<UserMarketplacePurchase>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List subscriptions for the authenticated user (stubbed) (asynchronously)
     * Lists the active subscriptions for the authenticated user. You must use a [user-to-server OAuth access token](https://docs.github.com/apps/building-github-apps/identifying-and-authorizing-users-for-github-apps/#identifying-users-on-your-site), created for a user who has authorized your GitHub App, to access this endpoint. . OAuth Apps must authenticate using an [OAuth token](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/).
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://docs.github.com/rest/reference/apps#list-subscriptions-for-the-authenticated-user-stubbed">List subscriptions for the authenticated user (stubbed) Documentation</a>
     */
    public okhttp3.Call appsListSubscriptionsForAuthenticatedUserStubbedAsync(Integer perPage, Integer page, final ApiCallback<List<UserMarketplacePurchase>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListSubscriptionsForAuthenticatedUserStubbedValidateBeforeCall(perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<UserMarketplacePurchase>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#list-deliveries-for-an-app-webhook">List deliveries for an app webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#redeliver-a-delivery-for-an-app-webhook">Redeliver a delivery for an app webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#remove-a-repository-from-an-app-installation">Remove a repository from an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#reset-a-token">Reset a token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#revoke-an-installation-access-token">Revoke an installation access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/apps/apps#create-a-scoped-access-token">Create a scoped access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#suspend-an-app-installation">Suspend an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#unsuspend-an-app-installation">Unsuspend an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/apps#update-a-webhook-configuration-for-an-app">Update a webhook configuration for an app Documentation</a>
     */
