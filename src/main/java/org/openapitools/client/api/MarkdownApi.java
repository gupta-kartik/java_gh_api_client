...
public class MarkdownApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Response </td><td>  * Content-Type -  <br>  * Content-Length -  <br>  * X-CommonMarker-Version -  <br>  </td></tr>
        <tr><td> 304 </td><td> Not modified </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/markdown#render-a-markdown-document">Render a Markdown document Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/rest/reference/markdown#render-a-markdown-document-in-raw-mode">Render a Markdown document in raw mode Documentation</a>
     */
